...
var co = (e, t, n) => t in e ? uo(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var qe = (e, t, n) => co(e, typeof t != "symbol" ? t + "" : t, n);
class ho {
  constructor() {
...
const Hn = "Canceled";
function fo(e) {
  return e instanceof za ? !0 : e instanceof Error && e.name === Hn && e.message === Hn;
}
...
function po(e, t = "Unreachable") {
  throw new Error(t);
}
function go(e, t = "unexpected state") {
  if (!e)
...
(function(e) {
  ...
  function* L(b, g, _ = b.length) {
    for (g < -b.length && (g = 0), g < 0 && (g += b.length), _ < 0 ? _ += b.length : _ > b.length && (_ = b.length); g < _; g++)
      yield b[g];
  }
  e.slice = L;
...
let te = (We = class {
  constructor(t) {
    this.element = t, this.next = We.Undefined, this.prev = We.Undefined;
  }
}, We.Undefined = new We(void 0), We);
class yo {
  constructor() {
...
const To = globalThis.performance.now.bind(globalThis.performance);
class Sn {
  static create(t) {
    return new Sn(t);
  }
  constructor(t) {
    this._now = t === !1 ? Date.now : To, this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(v) {
    return (S, D = null, k) => {
      ...
      return M = v((W) => {
        if (!E)
          return M ? M.dispose() : E = !0, S.call(D, W);
      }, null, k), E && M.dispose(), M;
    };
  }
  e.once = n;
  function i(v, S) {
    return e.once(e.filter(v, S));
  }
  e.onceIf = i;
  function r(v, S, D) {
    return c((k, E = null, M) => v((W) => k.call(E, S(W)), null, M), D);
  }
  e.map = r;
  function s(v, S, D) {
    return c((k, E = null, M) => v((W) => {
      S(W), k.call(E, W);
    }, null, M), D);
  }
  e.forEach = s;
  function a(v, S, D) {
    return c((k, E = null, M) => v((W) => S(W) && k.call(E, W), null, M), D);
  }
  e.filter = a;
  function l(v) {
    return v;
  ...
  function o(...v) {
    return (S, D = null, k) => {
      const E = _o(...v.map((M) => M((W) => S.call(D, W))));
      return d(E, k);
    };
  }
  e.any = o;
  ...
  function c(v, S) {
    ...
    return S == null || S.add(E), E.event;
  }
  function d(v, S) {
    return S instanceof Array ? S.push(v) : S && S.add(v), v;
  }
  function m(v, S, D = 100, k = !1, E = !1, M, W) {
    let F, U, O, Z = 0, Y;
    const ve = {
      leakWarningThreshold: M,
      onWillAddFirstListener() {
        F = v((oo) => {
          Z++, U = S(U, oo), k && !O && (ke.fire(U), U = void 0), Y = () => {
            const lo = U;
            U = void 0, O = void 0, (!k || Z > 1) && ke.fire(lo), Z = 0;
    ...
    return W == null || W.add(ke), ke.event;
  }
  e.debounce = m;
  function f(v, S = 0, D) {
    return e.debounce(v, (k, E) => k ? (k.push(E), k) : [E], S, void 0, !0, void 0, D);
  }
  e.accumulate = f;
  function w(v, S = (k, E) => k === E, D) {
    let k = !0, E;
    return a(v, (M) => {
      const W = k || !S(M, E);
      return k = !1, E = M, W;
  ...
  class L {
    ...
    forEach(S) {
      return this.steps.push((D) => (S(D), D)), this;
    }
    filter(S) {
      return this.steps.push((D) => S(D) ? D : y), this;
    }
    reduce(S, D) {
      let k = D;
      return this.steps.push((E) => (k = S(k, E), k)), this;
    }
    latch(S = (D, k) => D === k) {
      let D = !0, k;
  ...
  function I(v, S, D = (k) => k) {
    const k = (...F) => W.fire(D(...F)), E = () => v.on(S, k), M = () => v.removeListener(S, k), W = new Me({ onWillAddFirstListener: E, onDidRemoveLastListener: M });
    return W.event;
  }
  e.fromNodeEventEmitter = I;
  function H(v, S, D = (k) => k) {
    const k = (...F) => W.fire(D(...F)), E = () => v.addEventListener(S, k), M = () => v.removeEventListener(S, k), W = new Me({ onWillAddFirstListener: E, onDidRemoveLastListener: M });
    return W.event;
  }
  ...
  class _ {
    constructor(S, D) {
      ...
      this.emitter = new Me(k), D && D.add(this.emitter);
    }
    beginUpdate(S) {
      this._counter++;
    }
  ...
  function N(v, S) {
    return new _(v, S).emitter.event;
  }
  e.fromObservable = N;
  function A(v) {
    return (S, D, k) => {
      ...
      const W = {
        ...
        endUpdate() {
          E--, E === 0 && (v.reportChanges(), M && (M = !1, S.call(D)));
        },
      ...
      return k instanceof Ht ? k.add(F) : Array.isArray(k) && k.push(F), F;
    };
  }
  e.fromObservableLight = A;
})(Un || (Un = {}));
const dt = class dt {
  constructor(t) {
...
class Me {
  constructor(t) {
    var n, i, r, s;
    this._size = 0, this._options = t, this._leakageMon = (n = this._options) != null && n.leakWarningThreshold ? new Wn((t == null ? void 0 : t.onListenerError) ?? Gt, ((i = this._options) == null ? void 0 : i.leakWarningThreshold) ?? xo) : void 0, this._perfMon = (r = this._options) != null && r._profName ? new Pn(this._options._profName) : void 0, this._deliveryQueue = (s = this._options) == null ? void 0 : s.deliveryQueue;
  }
  dispose() {
    var t, n, i, r;
  ...
  get event() {
    return this._event ?? (this._event = (t, n, i) => {
      ...
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(w);
        const p = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], x = new So(`${w}. HINT: Stack shows most frequent listener (${p[1]}-times)`, p[0]);
        return (((l = this._options) == null ? void 0 : l.onListenerError) || Gt)(x), nt.None;
      }
      if (this._disposed)
        return nt.None;
      n && (t = t.bind(n));
      const r = new An(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = Li.create(), s = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof An ? (this._deliveryQueue ?? (this._deliveryQueue = new Lo()), this._listeners = [this._listeners, r]) : this._listeners.push(r) : ((u = (o = this._options) == null ? void 0 : o.onWillAddFirstListener) == null || u.call(o, this), this._listeners = r, (d = (c = this._options) == null ? void 0 : c.onDidAddFirstListener) == null || d.call(c, this)), (f = (m = this._options) == null ? void 0 : m.onDidAddListener) == null || f.call(m, this), this._size++;
      const a = en(() => {
        s == null || s(), this._removeListener(r);
      });
      return i instanceof Ht ? i.add(a) : Array.isArray(i) && i.push(a), a;
    }), this._event;
  }
  _removeListener(t) {
    var s, a, l, o;
  ...
  _deliver(t, n) {
    ...
    if (!t)
      return;
    const i = ((r = this._options) == null ? void 0 : r.onListenerError) || Gt;
    if (!i) {
      t.value(n);
      return;
    }
  ...
  fire(t) {
    var n, i, r, s;
    if ((n = this._deliveryQueue) != null && n.current && (this._deliverQueue(this._deliveryQueue), (i = this._perfMon) == null || i.stop()), (r = this._perfMon) == null || r.start(this._size), this._listeners) if (this._listeners instanceof An)
...
const Eo = Pa() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function zi(e, t) {
  let n;
  ...
  }), Eo && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function q(e, t, ...n) {
  return zi(typeof e == "number" ? Ro(e, t) : t, n);
}
function Ro(e, t) {
  var i;
  const n = (i = Co()) == null ? void 0 : i[e];
  if (typeof n != "string") {
    if (typeof t == "string")
      return t;
...
const ct = "en";
let Fn = !1, Bn = !1, Ln = !1, Ot, Cn = ct, Hi = ct, Do, Se;
const et = globalThis;
let oe;
var Da;
typeof et.vscode < "u" && typeof et.vscode.process < "u" ? oe = et.vscode.process : typeof process < "u" && typeof ((Da = process == null ? void 0 : process.versions) == null ? void 0 : Da.node) == "string" && (oe = process);
var Ma;
const Mo = typeof ((Ma = oe == null ? void 0 : oe.versions) == null ? void 0 : Ma.electron) == "string", No = Mo && (oe == null ? void 0 : oe.type) === "renderer";
var Na;
if (typeof oe == "object") {
  Fn = oe.platform === "win32", Bn = oe.platform === "darwin", Ln = oe.platform === "linux", Ln && oe.env.SNAP && oe.env.SNAP_REVISION, oe.env.CI || oe.env.BUILD_ARTIFACTSTAGINGDIRECTORY || oe.env.GITHUB_WORKSPACE, Ot = ct, Cn = ct;
  const e = oe.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      Ot = t.userLocale, Hi = t.osLocale, Cn = t.resolvedLanguage || ct, Do = (Na = t.languagePack) == null ? void 0 : Na.translationsConfigFile;
    } catch {
    }
} else typeof navigator == "object" && !No ? (Se = navigator.userAgent, Fn = Se.indexOf("Windows") >= 0, Bn = Se.indexOf("Macintosh") >= 0, (Se.indexOf("Macintosh") >= 0 || Se.indexOf("iPad") >= 0 || Se.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Ln = Se.indexOf("Linux") >= 0, (Se == null ? void 0 : Se.indexOf("Mobi")) >= 0, Cn = Pa() || ct, Ot = navigator.language.toLowerCase(), Hi = Ot) : console.error("Unable to resolve platform.");
const Ut = Fn, Io = Bn, Ie = Se, zo = typeof et.postMessage == "function" && !et.importScripts;
(() => {
  if (zo) {
    const e = [];
    et.addEventListener("message", (n) => {
    ...
    return (n) => {
      ...
      e.push({
        id: i,
        callback: n
      }), et.postMessage({ vscodeScheduleAsyncWork: i }, "*");
    };
  }
  return (e) => setTimeout(e);
})();
const Ho = !!(Ie && Ie.indexOf("Chrome") >= 0);
Ie && Ie.indexOf("Firefox") >= 0;
!Ho && Ie && Ie.indexOf("Safari") >= 0;
Ie && Ie.indexOf("Edg/") >= 0;
...
class Po {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = Uo) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
class qn {
  constructor(t) {
    this.executor = t, this._state = Qe.Uninitialized;
  }
  /**
...
De.ambiguousCharacterData = new qn(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,1523,96,8242,96,1370,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,118002,50,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,118003,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,118004,52,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,118005,53,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,118006,54,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,118007,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,118008,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,118009,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,117974,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,117975,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71913,67,71922,67,65315,67,8557,67,8450,67,8493,67,117976,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,117977,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,117978,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,117979,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,117980,71,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,117981,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,117983,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,117984,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,118001,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,117982,108,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,117985,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,117986,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,117987,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,118000,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,117988,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,117989,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,117990,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,117991,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,117992,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,117993,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,117994,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,117995,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71910,87,71919,87,117996,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,117997,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,117998,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,71909,90,66293,90,65338,90,8484,90,8488,90,117999,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65283,35,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"cs":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"es":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"fr":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"it":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ja":[8211,45,8218,44,65281,33,8216,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65292,44,65297,49,65307,59],"ko":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pt-BR":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ru":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"zh-hans":[160,32,65374,126,8218,44,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65297,49],"zh-hant":[8211,45,65374,126,8218,44,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89]}')), De.cache = new Po({ getCacheKey: JSON.stringify }, (t) => {
  ...
  return new De(u);
}), De._locales = new qn(() => Object.keys(De.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
let Pt = De;
const mt = class mt {
  static getRawData() {
  ...
  static getData() {
    return this._data || (this._data = new Set([...Object.values(mt.getRawData())].flat())), this._data;
  }
  static isInvisibleCharacter(t) {
    return mt.getData().has(t);
  }
...
mt._data = void 0;
let Ct = mt;
const En = "default", Yo = "$initialize";
class Zo {
...
class nl {
  ...
  async sendMessage(t, n, i) {
    ...
    return new Promise((s, a) => {
      this._pendingReplies[r] = {
        resolve: s,
        reject: a
      }, this._send(new Zo(this._workerId, r, t, n, i));
    });
  }
  listen(t, n, i) {
    let r = null;
    const s = new Me({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, s), this._send(new Ko(this._workerId, r, t, n, i));
      },
      onDidRemoveLastListener: () => {
  ...
  createProxyToRemoteChannel(t, n) {
    const i = {
      get: (r, s) => (typeof s == "string" && !r[s] && (Ba(s) ? r[s] = (a) => this.listen(t, s, a) : Fa(s) ? r[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === 36 && (r[s] = async (...a) => (await (n == null ? void 0 : n()), this.sendMessage(t, s, a)))), r[s])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((r) => {
      ...
      r.detail instanceof Error && (r.detail = zn(r.detail)), this._send(new Ui(this._workerId, n, void 0, zn(r)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, i = this._handler.handleEvent(t.channel, t.eventName, t.arg)((r) => {
      this._send(new el(this._workerId, n, r));
    });
...
function Fa(e) {
  return e[0] === "o" && e[1] === "n" && Wa(e.charCodeAt(2));
}
function Ba(e) {
  return /^onDynamic/.test(e) && Wa(e.charCodeAt(9));
}
class il {
  constructor(t, n) {
  ...
  _handleMessage(t, n, i) {
    ...
    const r = t === En ? this.requestHandler : this._localChannels.get(t);
    if (!r)
...
function rl(e) {
  ...
  Pi = !0;
  const t = new il((n) => globalThis.postMessage(n), (n) => e(n));
...
class je {
  ...
  constructor(t, n, i = null) {
    ...
    const [r, s, a] = je._getElements(t), [l, o, u] = je._getElements(n);
  ...
  WALKTRACE(t, n, i, r, s, a, l, o, u, c, d, m, f, w, p, x, T, y) {
    let L = null, I = null, H = new Bi(), P = n, b = i, g = f[0] - x[0] - r, _ = -1073741824, N = this.m_forwardHistory.length - 1;
    do {
      const A = g + t;
      A === P || A < b && u[A - 1] < u[A + 1] ? (d = u[A + 1], w = d - g - r, d < _ && H.MarkNextChange(), _ = d, H.AddModifiedElement(d + 1, w), g = A + 1 - t) : (d = u[A - 1] + 1, w = d - g - r, d < _ && H.MarkNextChange(), _ = d - 1, H.AddOriginalElement(d, w + 1), g = A - 1 - t), N >= 0 && (u = this.m_forwardHistory[N], t = u[0], P = 1, b = u.length - 1);
    } while (--N >= -1);
    if (L = H.getReverseChanges(), y[0]) {
      let A = f[0] + 1, v = x[0] + 1;
      if (L !== null && L.length > 0) {
        const S = L[L.length - 1];
        A = Math.max(A, S.getOriginalEnd()), v = Math.max(v, S.getModifiedEnd());
      }
      I = [
        new Oe(A, m - A + 1, v, p - v + 1)
      ];
    } else {
      H = new Bi(), P = a, b = l, g = f[0] - x[0] - o, _ = 1073741824, N = T ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const A = g + s;
        A === P || A < b && c[A - 1] >= c[A + 1] ? (d = c[A + 1] - 1, w = d - g - o, d > _ && H.MarkNextChange(), _ = d + 1, H.AddOriginalElement(d + 1, w + 1), g = A + 1 - s) : (d = c[A - 1], w = d - g - o, d > _ && H.MarkNextChange(), _ = d, H.AddModifiedElement(d + 1, w + 1), g = A - 1 - s), N >= 0 && (c = this.m_reverseHistory[N], s = c[0], P = 1, b = c.length - 1);
      } while (--N >= -1);
      I = H.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, i, r, s, a, l) {
    ...
    const w = n - t + (r - i), p = w + 1, x = new Int32Array(p), T = new Int32Array(p), y = r - i, L = n - t, I = t - i, H = n - r, b = (L - y) % 2 === 0;
    x[y] = t, T[L] = n, l[0] = !1;
    for (let g = 1; g <= w / 2 + 1; g++) {
      ...
      for (let v = c; v <= d; v += 2) {
        ...
        if (x[v] = o, o + u > _ + N && (_ = o, N = u), !b && Math.abs(v - L) <= g - 1 && o >= T[v])
          return s[0] = o, a[0] = u, S <= T[v] && g <= 1448 ? this.WALKTRACE(y, c, d, I, L, m, f, H, x, T, o, n, s, u, r, a, b, l) : null;
      }
      const A = (_ - t + (N - i) - g) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(_, A))
        return l[0] = !0, s[0] = _, a[0] = N, A > 0 && g <= 1448 ? this.WALKTRACE(y, c, d, I, L, m, f, H, x, T, o, n, s, u, r, a, b, l) : (t++, i++, [
          new Oe(t, n - t + 1, i, r - i + 1)
        ]);
      ...
      for (let v = m; v <= f; v += 2) {
        ...
        if (T[v] = o, b && Math.abs(v - y) <= g && o <= x[v])
          return s[0] = o, a[0] = u, S >= x[v] && g <= 1448 ? this.WALKTRACE(y, c, d, I, L, m, f, H, x, T, o, n, s, u, r, a, b, l) : null;
      }
      if (g <= 1447) {
        let v = new Int32Array(d - c + 2);
        v[0] = y - c + 1, rt.Copy2(x, c, v, 1, d - c + 1), this.m_forwardHistory.push(v), v = new Int32Array(f - m + 2), v[0] = L - m + 1, rt.Copy2(T, m, v, 1, f - m + 1), this.m_reverseHistory.push(v);
      }
    }
    ...
    if (this._hasStrings)
      for (let n = 1, i = t.length; n < i; n++) {
        ...
        if (a < 5 && u < 20 && m < 20) {
          ...
          if (f) {
            const [w, p] = f;
            (w !== r.originalStart + r.originalLength || p !== r.modifiedStart + r.modifiedLength) && (r.originalLength = w - r.originalStart, r.modifiedLength = p - r.modifiedStart, s.originalStart = w + a, s.modifiedStart = p + a, s.originalLength = o - s.originalStart, s.modifiedLength = d - s.modifiedStart);
          }
        }
      }
    return t;
  ...
  ChangesOverlap(t, n, i) {
    if (it.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), it.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart), i[0] = new Oe(r, s, a, l), !0;
    } else
      return i[0] = null, !1;
  }
  /**
...
let K = class Je {
  ...
  static intersectRanges(t, n) {
    ...
    return i < l ? (i = l, r = o) : i === l && (r = Math.max(r, o)), s > u ? (s = u, a = c) : s === u && (a = Math.min(a, c)), i > s || i === s && r > a ? null : new re(i, r, s, a);
  }
  /**
...
class tn {
  ...
  static computeLinks(t, n = ul()) {
    ...
    for (let s = 1, a = t.getLineCount(); s <= a; s++) {
      ...
      let u = 0, c = 0, d = 0, m = 1, f = !1, w = !1, p = !1, x = !1;
      for (; u < o; ) {
        let T = !1;
        ...
        if (m === 13) {
          ...
          L === 1 && (r.push(tn._createLink(i, l, s, c, u)), T = !0);
        } else if (m === 12) {
          let L;
          y === 91 ? (w = !0, L = 0) : L = i.get(y), L === 1 ? T = !0 : m = 13;
        } else
          m = n.nextState(m, y), m === 0 && (T = !0);
        T && (m = 1, f = !1, w = !1, x = !1, c = u + 1, d = y), u++;
      }
      m === 13 && r.push(tn._createLink(i, l, s, c, o));
    }
    return r;
  }
}
...
Tn.INSTANCE = new Tn();
let Vn = Tn;
const qa = Object.freeze(function(e, t) {
...
class Xt {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? qa : (this._emitter || (this._emitter = new Me()), this._emitter.event);
  }
  dispose() {
...
class dl {
  ...
  cancel() {
    this._token ? this._token instanceof Xt && this._token.cancel() : this._token = nn.Cancelled;
  }
  dispose(t = !1) {
    var n;
    t && this.cancel(), (n = this._parentListener) == null || n.dispose(), this._token ? this._token instanceof Xt && this._token.dispose() : this._token = nn.None;
  }
}
class Ei {
  constructor() {
...
const Jt = new Ei(), jn = new Ei(), $n = new Ei(), ml = new Array(230), fl = /* @__PURE__ */ Object.create(null), pl = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const r of t) {
    ...
    if (i[a] || (i[a] = !0, fl[l] = a, pl[l.toLowerCase()] = a), !n[o]) {
      if (n[o] = !0, !u)
        throw new Error(`String representation missing for key code ${o} around scan code ${l}`);
      Jt.define(o, u), jn.define(o, m || u), $n.define(o, f || m || u);
    }
    c && (ml[c] = o);
  }
})();
...
if (typeof Dn < "u" && typeof Dn.process < "u") {
...
} else typeof process < "u" && typeof ((Ia = process == null ? void 0 : process.versions) == null ? void 0 : Ia.node) == "string" ? gt = {
  get platform() {
  ...
  // Supported
  get platform() {
    return Ut ? "win32" : Io ? "darwin" : "linux";
  },
  get arch() {
  },
  // Unsupported
...
const rn = gt.cwd, bl = gt.env, wl = gt.platform, _l = 65, vl = 97, yl = 90, Tl = 122, tt = 46, ae = 47, de = 92, ze = 58, xl = 63;
...
const he = {
  ...
  resolve(...e) {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      let s;
      if (r >= 0) {
        if (s = e[r], ie(s, `paths[${r}]`), s.length === 0)
          continue;
      } else t.length === 0 ? s = rn() : (s = bl[`=${t}`] || rn(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === de) && (s = `${t}\\`));
      const a = s.length;
      let l = 0, o = "", u = !1;
      ...
      if (a === 1)
        ...
        if (u = !0, j(s.charCodeAt(1))) {
          let d = 2, m = d;
          for (; d < a && !j(s.charCodeAt(d)); )
            d++;
          if (d < a && d !== m) {
            const f = s.slice(m, d);
            for (m = d; d < a && j(s.charCodeAt(d)); )
              d++;
            if (d < a && d !== m) {
              for (m = d; d < a && !j(s.charCodeAt(d)); )
                d++;
          ...
          l = 1;
      else He(c) && s.charCodeAt(1) === ze && (o = s.slice(0, 2), l = 2, a > 2 && j(s.charCodeAt(2)) && (u = !0, l = 3));
      if (o.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (j(s))
      if (r = !0, j(e.charCodeAt(1))) {
        ...
        n = 1;
    else He(s) && e.charCodeAt(1) === ze && (i = e.slice(0, 2), n = 2, t > 2 && j(e.charCodeAt(2)) && (r = !0, n = 3));
    let a = n < t ? sn(e.slice(n), !r, "\\", j) : "";
    if (a.length === 0 && !r && (a = "."), a.length > 0 && j(e.charCodeAt(t - 1)) && (a += "\\"), !r && i === void 0 && e.includes(":")) {
      if (a.length >= 2 && He(a.charCodeAt(0)) && a.charCodeAt(1) === ze)
        return `.\\${a}`;
      let l = e.indexOf(":");
      do
        if (l === t - 1 || j(e.charCodeAt(l + 1)))
          return `.\\${a}`;
  ...
  isAbsolute(e) {
    ...
    t > 2 && He(n) && e.charCodeAt(1) === ze && j(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
  ...
  relative(e, t) {
    ...
    let f = "";
    for (m = r + d + 1; m <= s; ++m)
      (m === s || e.charCodeAt(m) === de) && (f += f.length === 0 ? ".." : "\\..");
  ...
  toNamespacedPath(e) {
    ...
    } else if (He(t.charCodeAt(0)) && t.charCodeAt(1) === ze && t.charCodeAt(2) === de)
      return `\\\\?\\${t}`;
    return t;
  },
  dirname(e) {
    ...
    } else He(r) && e.charCodeAt(1) === ze && (n = t > 2 && j(e.charCodeAt(2)) ? 3 : 2, i = n);
    let s = -1, a = !0;
    for (let l = t - 1; l >= i; --l)
      if (j(e.charCodeAt(l))) {
        if (!a) {
  ...
  basename(e, t) {
    ...
    let n = 0, i = -1, r = !0, s;
    if (e.length >= 2 && He(e.charCodeAt(0)) && e.charCodeAt(1) === ze && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === ze && He(e.charCodeAt(0)) && (t = i = 2);
  ...
  parse(e) {
    ...
    } else if (He(r) && e.charCodeAt(1) === ze) {
      if (n <= 2)
  ...
  resolve(...e) {
    ...
    for (let i = e.length - 1; i >= 0 && !n; i--) {
      const r = e[i];
      ie(r, `paths[${i}]`), r.length !== 0 && (t = `${r}/${t}`, n = r.charCodeAt(0) === ae);
    }
    if (!n) {
      const i = Al();
      t = `${i}/${t}`, n = i.charCodeAt(0) === ae;
    }
    return t = sn(t, !n, "/", Gn), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (ie(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === ae, n = e.charCodeAt(e.length - 1) === ae;
    return e = sn(e, !t, "/", Gn), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
    return ie(e, "path"), e.length > 0 && e.charCodeAt(0) === ae;
  },
  join(...e) {
    if (e.length === 0)
      return ".";
  ...
  relative(e, t) {
    if (ie(e, "from"), ie(t, "to"), e === t || (e = pe.resolve(e), t = pe.resolve(t), e === t))
      return "";
...
pe.win32 = he.win32 = he;
pe.posix = he.posix = pe;
Xe ? he.normalize : pe.normalize;
Xe ? he.resolve : pe.resolve;
Xe ? he.relative : pe.relative;
Xe ? he.dirname : pe.dirname;
Xe ? he.basename : pe.basename;
Xe ? he.extname : pe.extname;
Xe ? he.sep : pe.sep;
const Ll = /^\w[\w\d+.-]*$/, Cl = /^\//, El = /^\/\//;
function Rl(e, t) {
  if (!e.scheme && t)
    throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`);
  if (e.scheme && !Ll.test(e.scheme))
    throw new Error("[UriError]: Scheme contains illegal characters.");
  if (e.path) {
    if (e.authority) {
      if (!Cl.test(e.path))
        throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
    } else if (El.test(e.path))
...
let Ri = class Qt {
  ...
  constructor(t, n, i, r, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || ee, this.authority = t.authority || ee, this.path = t.path || ee, this.query = t.query || ee, this.fragment = t.fragment || ee) : (this.scheme = Dl(t, a), this.authority = n || ee, this.path = Ml(this.scheme, i || ee), this.query = r || ee, this.fragment = s || ee, Rl(this, a));
  }
  // ---- filesystem path -----------------------
  /**
  ...
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = ee), i === void 0 ? i = this.authority : i === null && (i = ee), r === void 0 ? r = this.path : r === null && (r = ee), s === void 0 ? s = this.query : s === null && (s = ee), a === void 0 ? a = this.fragment : a === null && (a = ee), n === this.scheme && i === this.authority && r === this.path && s === this.query && a === this.fragment ? this : new at(n, i, r, s, a);
  }
  // ---- parse & validate ------------------------
  /**
  ...
  static parse(t, n = !1) {
    const i = Nl.exec(t);
    return i ? new at(i[2] || ee, Vt(i[4] || ee), Vt(i[5] || ee), Vt(i[7] || ee), Vt(i[9] || ee), n) : new at(ee, ee, ee, ee, ee);
  }
  /**
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return Ut && t.scheme === "file" ? i = Qt.file(he.join(Xn(t, !0), ...n)).path : i = pe.join(t.path, ...n), t.with({ path: i });
  }
...
function Il(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const i = e.charCodeAt(n);
    i === 35 || i === 63 ? (t === void 0 && (t = e.substr(0, n)), t += $a[i]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function Xn(e, t) {
...
function Jn(e, t) {
  ...
  if (r && (i += r, i += ":"), (s || r === "file") && (i += Ee, i += Ee), s) {
    let u = s.indexOf("@");
    if (u !== -1) {
...
function Vt(e) {
  return e.match(ji) ? e.replace(ji, (t) => Ga(t)) : e;
}
class ge extends $ {
  constructor(t, n, i, r) {
...
class Ul {
  ...
  register(t, n) {
    return this._tokenizationSupports.set(t, n), this.handleChange([t]), en(() => {
  ...
  registerFactory(t, n) {
    ...
    const i = new Pl(this, t, n);
    return this._factories.set(t, i), en(() => {
...
class Bl {
  constructor() {
    this[Qr] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
  }
  clear() {
...
function Xl(e, t, n, i, r) {
  return $l(e, t, n, i, r) && Gl(e, t, n, i, r);
}
class Jl {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          Xo(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
...
function Di(e, t, n, i, r) {
  if (t = Ja(t), r || (r = Kt.first(Qa)), n.length > r.maxLen) {
    let u = e - r.maxLen / 2;
    return u < 0 ? u = 0 : i += u, n = n.substring(u, e + r.maxLen / 2), Di(e, t, n, i, r);
  }
...
class Kl {
  static computeUnicodeHighlights(t, n, i) {
    const r = i ? i.startLineNumber : 1, s = i ? i.endLineNumber : t.getLineCount(), a = new ts(n), l = a.getCandidateCodePoints();
    let o;
    l === "allNonBasicAscii" ? o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${eu(Array.from(l))}`, "g");
    const u = new Jl(null, o), c = [];
    let d = !1, m, f = 0, w = 0, p = 0;
    e: for (let x = r, T = s; x <= T; x++) {
      const y = t.getLineContent(x), L = y.length;
      u.reset(0);
      do
        if (m = u.next(y), m) {
          let I = m.index, H = m.index + m[0].length;
          if (I > 0) {
          ...
          if (g !== 0) {
            if (g === 3 ? f++ : g === 2 ? w++ : g === 1 ? p++ : po(), c.length >= 1e3) {
              d = !0;
              break e;
            }
            c.push(new $(x, I + 1, x, H + 1));
          }
        }
      while (m);
    }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (i.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 3: {
        const s = t.codePointAt(0), a = i.ambiguousCharacters.getPrimaryConfusable(s), l = Pt.getLocales().filter((o) => !Pt.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, o])).isAmbiguous(s));
...
function eu(e, t) {
  return `[${Wo(e.map((i) => String.fromCodePoint(i)).join(""))}]`;
}
class ts {
  constructor(t) {
    this.options = t, this.allowedCodePoints = new Set(t.allowedCodePoints), this.ambiguousCharacters = Pt.getInstance(new Set(t.allowedLocales));
  }
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of Ct.codePoints)
        ns(String.fromCodePoint(n)) || t.add(n);
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const a of n) {
        ...
        r = r || o, !o && !this.ambiguousCharacters.isAmbiguous(l) && !Ct.isInvisibleCharacter(l) && (s = !0);
      }
    return (
      /* Don't allow mixing weird looking characters with ASCII */
      !r && /* Is there an obviously weird looking character? */
      s ? 0 : this.options.invisibleCharacters && !ns(t) && Ct.isInvisibleCharacter(i) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i) ? 3 : 0
    );
  }
}
function ns(e) {
...
const pt = class pt {
  ...
  findLastMaxBy(t) {
    let n, i = !0;
    return this.iterate((r) => ((i || ti.isGreaterThan(t(r, n))) && (i = !1, n = r), !0)), n;
  }
};
pt.empty = new pt((t) => {
});
...
const we = class we {
  ...
  static fromRange(t) {
    return new we(t.startLineNumber, t.endLineNumber);
  }
  static fromRangeInclusive(t) {
    return new we(t.startLineNumber, t.endLineNumber + 1);
  }
  /**
   ...
   */
  delta(t) {
    return new we(this.startLineNumber + t, this.endLineNumberExclusive + t);
  }
  deltaLength(t) {
    return new we(this.startLineNumber, this.endLineNumberExclusive + t);
  }
  /**
   ...
   */
  join(t) {
    return new we(Math.min(this.startLineNumber, t.startLineNumber), Math.max(this.endLineNumberExclusive, t.endLineNumberExclusive));
  }
  toString() {
    return `[${this.startLineNumber},${this.endLineNumberExclusive})`;
  }
  ...
  toInclusiveRange() {
    return this.isEmpty ? null : new $(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER);
  }
  /**
  ...
  */
  ...
  addMargin(t, n) {
    return new we(this.startLineNumber - t, this.endLineNumberExclusive + n);
  }
};
we.compareByStart = Et((t) => t.startLineNumber, Rt);
let X = we;
class Ne {
  constructor(t = []) {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = ni(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), i = yt(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
   ...
   */
  subtractFrom(t) {
    const n = ni(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), i = yt(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
      return new Ne([t]);
    const r = [];
    ...
    return s < t.endLineNumberExclusive && r.push(new X(s, t.endLineNumberExclusive)), new Ne(r);
  }
  toString() {
...
` ? (n++, i = 0) : i++;
  ...
  createRange(t) {
    return this.lineCount === 0 ? new $(t.lineNumber, t.column, t.lineNumber, t.column + this.columnCount) : new $(t.lineNumber, t.column, t.lineNumber + this.lineCount, this.columnCount + 1);
  }
  toRange() {
    return new $(1, 1, this.lineCount + 1, this.columnCount + 1);
  }
  toLineRange() {
...
class uu {
  ...
  getRange(t) {
    return $.fromPositions(this.getPosition(t.start), this.getPosition(t.endExclusive));
  }
  getStringReplacement(t) {
    return new bt.deps.StringReplacement(this.getOffsetRange(t.range), t.text);
  }
  getTextReplacement(t) {
    return new bt.deps.TextReplacement(this.getRange(t.replaceRange), t.newText);
  }
  getTextEdit(t) {
    const n = t.replacements.map((i) => this.getTextReplacement(i));
    return new bt.deps.TextEdit(n);
  }
}
const Ii = class Ii {
  static get deps() {
...
` && (this.lineStartOffsetByLineIdx.push(n + 1), n > 0 && t.charAt(n - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(n - 1) : this.lineEndOffsetByLineIdx.push(n));
  ...
  _validatePosition(t) {
    ...
    if (t.column < 1)
      return new K(t.lineNumber, 1);
    const i = this.getLineLength(t.lineNumber);
    return t.column - 1 > i ? new K(t.lineNumber, i + 1) : t;
  }
  getPosition(t) {
    const n = yt(this.lineStartOffsetByLineIdx, (s) => s <= t), i = n + 1, r = t - this.lineStartOffsetByLineIdx[n] + 1;
    return new K(i, r);
  }
  get textLength() {
    const t = this.lineStartOffsetByLineIdx.length - 1;
    return new bt.deps.TextLength(t, this.text.length - this.lineStartOffsetByLineIdx[t]);
  }
  getLineLength(t) {
...
class hu {
  ...
  getLineLength(t) {
    return this.getValueOfRange(new $(t, 1, t, Number.MAX_SAFE_INTEGER)).length;
  }
  getTransformer() {
    return this._transformer || (this._transformer = new cu(this.getValue())), this._transformer;
  }
  getLineAt(t) {
    return this.getValueOfRange(new $(t, 1, t, Number.MAX_SAFE_INTEGER));
  }
}
class du extends hu {
  constructor(t, n) {
    go(n >= 1), super(), this._getLineContent = t, this._lineCount = n;
  }
  getValueOfRange(t) {
...
` + this._getLineContent(t.endLineNumber).substring(0, t.endColumn - 1), n;
  ...
  get length() {
    ...
    return new Wt(this._lineCount - 1, t.length);
  }
}
class jt extends du {
  constructor(t) {
  ...
  static joinReplacements(t, n) {
    ...
    for (let a = 0; a < t.length; a++) {
      ...
      if (s += l.text, a < t.length - 1) {
        const o = t[a + 1], u = $.fromPositions(l.range.getEndPosition(), o.range.getStartPosition()), c = n.getValueOfRange(u);
        s += c;
      }
    }
    return new Ve($.fromPositions(i, r), s);
  }
  static fromStringReplacement(t, n) {
    return new Ve(n.getTransformer().getRange(t.replaceRange), t.newText);
  }
  static delete(t) {
    return new Ve(t, "");
  }
...
`, `
`), r = Vo(n, i), s = Wt.ofText(n.substring(0, r)).addToPosition(this.range.getStartPosition()), a = i.substring(r), l = $.fromPositions(s, this.range.getEndPosition());
    return new Ve(l, a);
  }
...
`), i = this.text.replaceAll(`\r
`, `
`), r = jo(n, i), s = Wt.ofText(n.substring(0, n.length - r)).addToPosition(this.range.getStartPosition()), a = i.substring(0, i.length - r), l = $.fromPositions(this.range.getStartPosition(), s);
    return new Ve(l, a);
  }
  toString() {
...
class xe {
  static inverse(t, n, i) {
    ...
    let s = 1, a = 1;
    for (const o of t) {
      const u = new xe(new X(s, o.original.startLineNumber), new X(a, o.modified.startLineNumber));
      u.modified.isEmpty || r.push(u), s = o.original.endLineNumberExclusive, a = o.modified.endLineNumberExclusive;
    }
    const l = new xe(new X(s, n + 1), new X(a, i + 1));
  ...
  */
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new ye(new $(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new $(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new ye(new $(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new $(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
  }
  /**
   * This method assumes that the LineRangeMapping describes a valid diff!
   * I.e. if one range is empty, the other range cannot be the entire document.
  ...
  */
  toRangeMapping2(t, n) {
    ...
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new ye($.fromPositions(new K(this.original.startLineNumber, 1), ot(new K(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), $.fromPositions(new K(this.modified.startLineNumber, 1), ot(new K(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new ye($.fromPositions(ot(new K(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), ot(new K(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), $.fromPositions(ot(new K(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), ot(new K(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new ue();
  }
}
function ot(e, t) {
...
function ss(e, t, n, i = !1) {
  const r = [];
  for (const s of iu(e.map((a) => mu(a, t, n)), (a, l) => a.original.intersectsOrTouches(l.original) || a.modified.intersectsOrTouches(l.modified))) {
    const a = s[0], l = s[s.length - 1];
    r.push(new Fe(a.original.join(l.original), a.modified.join(l.modified), s.map((o) => o.innerChanges[0])));
  }
  return Zt(() => !i && r.length > 0 && (r[0].modified.startLineNumber !== r[0].original.startLineNumber || n.length.lineCount - r[r.length - 1].modified.endLineNumberExclusive !== t.length.lineCount - r[r.length - 1].original.endLineNumberExclusive) ? !1 : Ha(r, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
...
function mu(e, t, n) {
  ...
  const s = new X(e.originalRange.startLineNumber + i, e.originalRange.endLineNumber + 1 + r), a = new X(e.modifiedRange.startLineNumber + i, e.modifiedRange.endLineNumber + 1 + r);
  return new Fe(s, a, [e]);
}
const fu = 3;
class pu {
  computeDiff(t, n, i) {
    ...
    for (const u of s.changes) {
      let c;
      u.originalEndLineNumber === 0 ? c = new X(u.originalStartLineNumber + 1, u.originalStartLineNumber + 1) : c = new X(u.originalStartLineNumber, u.originalEndLineNumber + 1);
      let d;
      u.modifiedEndLineNumber === 0 ? d = new X(u.modifiedStartLineNumber + 1, u.modifiedStartLineNumber + 1) : d = new X(u.modifiedStartLineNumber, u.modifiedEndLineNumber + 1);
      let m = new Fe(c, d, (o = u.charChanges) == null ? void 0 : o.map((f) => new ye(new $(f.originalStartLineNumber, f.originalStartColumn, f.originalEndLineNumber, f.originalEndColumn), new $(f.modifiedStartLineNumber, f.modifiedStartColumn, f.modifiedEndLineNumber, f.modifiedEndColumn))));
      l && (l.modified.endLineNumberExclusive === m.modified.startLineNumber || l.original.endLineNumberExclusive === m.original.startLineNumber) && (m = new Fe(l.original.join(m.original), l.modified.join(m.modified), l.innerChanges && m.innerChanges ? l.innerChanges.concat(m.innerChanges) : void 0), a.pop()), a.push(m), l = m;
    }
    return Zt(() => Ha(a, (u, c) => c.original.startLineNumber - u.original.endLineNumberExclusive === c.modified.startLineNumber - u.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    u.original.endLineNumberExclusive < c.original.startLineNumber && u.modified.endLineNumberExclusive < c.modified.startLineNumber)), new Yt(a, [], s.quitEarly);
  }
}
function Ya(e, t, n, i) {
...
function bu(e) {
  ...
  for (let i = 1, r = e.length; i < r; i++) {
    ...
    Math.min(a, l) < fu ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
  }
  return t;
}
class Dt {
  ...
  static createFromDiffResult(t, n, i, r, s, a, l) {
    ...
    if (n.originalLength === 0 ? (o = i.getStartLineNumber(n.originalStart) - 1, u = 0) : (o = i.getStartLineNumber(n.originalStart), u = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (c = r.getStartLineNumber(n.modifiedStart) - 1, d = 0) : (c = r.getStartLineNumber(n.modifiedStart), d = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
      const f = i.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1), w = r.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1);
      if (f.getElements().length > 0 && w.getElements().length > 0) {
        let p = Ya(f, w, s, !0).changes;
        l && (p = bu(p)), m = [];
        for (let x = 0, T = p.length; x < T; x++)
          m.push(wt.createFromDiffChange(p[x], f, w));
      }
    }
...
class wu {
  ...
  computeDiff() {
    ...
    const t = Ya(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
    ...
    for (let l = -1, o = n.length; l < o; l++) {
      ...
      for (; s < c && a < d; ) {
        ...
        if (m !== f) {
          {
            let w = ii(m, 1), p = ii(f, 1);
            for (; w > 1 && p > 1; ) {
              const x = m.charCodeAt(w - 2), T = f.charCodeAt(p - 2);
              if (x !== T)
                break;
              w--, p--;
            }
          ...
          {
            let w = ri(m, 1), p = ri(f, 1);
            const x = m.length + 1, T = f.length + 1;
            for (; w < x && p < T; ) {
              const y = m.charCodeAt(w - 1), L = m.charCodeAt(p - 1);
              if (y !== L)
                break;
              w++, p++;
            }
      ...
      u && (r.push(Dt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, u, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += u.originalLength, a += u.modifiedLength);
    }
    return {
      quitEarly: i,
      changes: r
  ...
  _pushTrimWhitespaceCharChange(t, n, i, r, s, a, l) {
    if (this._mergeTrimWhitespaceCharChange(t, n, i, r, s, a, l))
      return;
    let o;
    this.shouldComputeCharChanges && (o = [new wt(n, i, n, r, s, a, s, l)]), t.push(new Dt(n, n, s, s, o));
  }
  _mergeTrimWhitespaceCharChange(t, n, i, r, s, a, l) {
    ...
    if (o === 0)
      return !1;
    const u = t[o - 1];
    return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0 ? !1 : u.originalEndLineNumber === n && u.modifiedEndLineNumber === s ? (this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new wt(n, i, n, r, s, a, s, l)), !0) : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === s ? (u.originalEndLineNumber = n, u.modifiedEndLineNumber = s, this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new wt(n, i, n, r, s, a, s, l)), !0) : !1;
  }
}
function ii(e, t) {
  const n = qo(e);
...
class Be {
  static trivial(t, n) {
    return new Be([new ne(G.ofLength(t.length), G.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new Be([new ne(G.ofLength(t.length), G.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class ne {
  static invert(t, n) {
    const i = [];
    return ru(t, (r, s) => {
      i.push(ne.fromOffsetPairs(r ? r.getEndExclusives() : Ue.zero, s ? s.getStarts() : new Ue(n, (r ? r.seq2Range.endExclusive - r.seq1Range.endExclusive : 0) + n)));
    }), i;
  }
...
const Ye = class Ye {
  ...
  delta(t) {
    return t === 0 ? this : new Ye(this.offset1 + t, this.offset2 + t);
  }
  equals(t) {
    return this.offset1 === t.offset1 && this.offset2 === t.offset2;
  }
};
Ye.zero = new Ye(0, 0), Ye.max = new Ye(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
let Ue = Ye;
const kn = class kn {
  isValid() {
    return !0;
...
It.chrKeys = /* @__PURE__ */ new Map();
let on = It;
class vu {
  compute(t, n, i = Ft.instance, r) {
    if (t.length === 0 || n.length === 0)
      return Be.trivial(t, n);
    const s = new Mn(t.length, n.length), a = new Mn(t.length, n.length), l = new Mn(t.length, n.length);
    for (let w = 0; w < t.length; w++)
      for (let p = 0; p < n.length; p++) {
        if (!i.isValid())
          return Be.trivialTimedOut(t, n);
        const x = w === 0 ? 0 : s.get(w - 1, p), T = p === 0 ? 0 : s.get(w, p - 1);
        let y;
        t.getElement(w) === n.getElement(p) ? (w === 0 || p === 0 ? y = 0 : y = s.get(w - 1, p - 1), w > 0 && p > 0 && a.get(w - 1, p - 1) === 3 && (y += l.get(w - 1, p - 1)), y += r ? r(w, p) : 1) : y = -1;
    ...
    return d(-1, -1), o.reverse(), new Be(o, !1);
  }
}
class Za {
  compute(t, n, i = Ft.instance) {
    ...
    e: for (; ; ) {
      if (l++, !i.isValid())
        return Be.trivialTimedOut(r, s);
      const p = -Math.min(l, s.length + l % 2), x = Math.min(l, r.length + l % 2);
      for (c = p; c <= x; c += 2) {
        const T = c === x ? -1 : o.get(c + 1), y = c === p ? -1 : o.get(c - 1) + 1, L = Math.min(Math.max(T, y), r.length), I = L - c;
        if (L > r.length || I > s.length)
          continue;
        const H = a(L, I);
        o.set(c, H);
        const P = L === T ? u.get(c + 1) : u.get(c - 1);
        if (u.set(c, H !== L ? new ls(P, L, I, H - L) : P), o.get(c) === r.length && o.get(c) - c === s.length)
          break e;
      }
    }
    let d = u.get(c);
    ...
    for (; ; ) {
      const p = d ? d.x + d.length : 0, x = d ? d.y + d.length : 0;
      if ((p !== f || x !== w) && m.push(new ne(new G(p, f), new G(x, w))), !d)
        break;
...
class ln {
  ...
  getBoundaryScore(t) {
    const n = hs(t > 0 ? this.elements[t - 1] : -1), i = hs(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && i === 8)
      return 0;
    if (n === 8)
      return 150;
    let r = 0;
    return n !== i && (r += 10, n === 0 && i === 1 && (r += 1)), r += cs(n), r += cs(i), r;
  }
  translateOffset(t, n = "right") {
    const i = yt(this.firstElementOffsetByLineIdx, (s) => s <= t), r = t - this.firstElementOffsetByLineIdx[i];
    return new K(this.range.startLineNumber + i, 1 + this.lineStartOffsets[i] + r + (r === 0 && n === "left" ? 0 : this.trimmedWsLengthsByLineIdx[i]));
  }
  translateRange(t) {
    const n = this.translateOffset(t.start, "right"), i = this.translateOffset(t.endExclusive, "left");
    return i.isBefore(n) ? $.fromPositions(i, i) : $.fromPositions(n, i);
  }
  /**
  ...
  findWordContaining(t) {
    ...
    for (; n > 0 && lt(this.elements[n - 1]); )
      n--;
    let i = t;
    for (; i < this.elements.length && lt(this.elements[i]); )
      i++;
    return new G(n, i);
  }
  ...
  findSubWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !lt(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && lt(this.elements[n - 1]) && !us(this.elements[n]); )
      n--;
    let i = t;
    for (; i < this.elements.length && lt(this.elements[i]) && !us(this.elements[i]); )
      i++;
    return new G(n, i);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = vt(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0, i = lu(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new G(n, i);
  }
}
function lt(e) {
...
function hs(e) {
  return e === 10 ? 8 : e === 13 ? 7 : si(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : e === -1 ? 3 : e === 44 || e === 59 ? 5 : 4;
}
function ku(e, t, n, i, r, s) {
  let { moves: a, excludedChanges: l } = Au(e, t, n, s);
  if (!s.isValid())
    return [];
  const o = e.filter((c) => !l.has(c)), u = Lu(o, i, r, t, n, s);
  return au(a, u), a = Cu(a), a = a.filter((c) => {
...
function Lu(e, t, n, i, r, s) {
  ...
  const o = [];
  e.sort(Et((m) => m.modified.startLineNumber, Rt));
  for (const m of e) {
    let f = [];
    for (let w = m.modified.startLineNumber; w < m.modified.endLineNumberExclusive - 2; w++) {
      const p = `${n[w - 1]}:${n[w + 1 - 1]}:${n[w + 2 - 1]}`, x = new X(w, w + 3), T = [];
      l.forEach(p, ({ range: y }) => {
        for (const I of f)
          if (I.originalLineRange.endLineNumberExclusive + 1 === y.endLineNumberExclusive && I.modifiedLineRange.endLineNumberExclusive + 1 === x.endLineNumberExclusive) {
            I.originalLineRange = new X(I.originalLineRange.startLineNumber, y.endLineNumberExclusive), I.modifiedLineRange = new X(I.modifiedLineRange.startLineNumber, x.endLineNumberExclusive), T.push(I);
            return;
          }
        const L = {
          modifiedLineRange: x,
  ...
  o.sort(ou(Et((m) => m.modifiedLineRange.length, Rt)));
  const u = new Ne(), c = new Ne();
  for (const m of o) {
    const f = m.modifiedLineRange.startLineNumber - m.originalLineRange.startLineNumber, w = u.subtractFrom(m.modifiedLineRange), p = c.subtractFrom(m.originalLineRange).getWithDelta(f), x = w.getIntersection(p);
    for (const T of x.ranges) {
      if (T.length < 3)
        continue;
      const y = T, L = T.delta(-f);
      a.push(new xe(L, y)), u.addRange(y), c.addRange(L);
    }
  }
  a.sort(Et((m) => m.original.startLineNumber, Rt));
  const d = new an(e);
  for (let m = 0; m < a.length; m++) {
    const f = a[m], w = d.findLastMonotonous((P) => P.original.startLineNumber <= f.original.startLineNumber), p = vt(e, (P) => P.modified.startLineNumber <= f.modified.startLineNumber), x = Math.max(f.original.startLineNumber - w.original.startLineNumber, f.modified.startLineNumber - p.modified.startLineNumber), T = d.findLastMonotonous((P) => P.original.startLineNumber < f.original.endLineNumberExclusive), y = vt(e, (P) => P.modified.startLineNumber < f.modified.endLineNumberExclusive), L = Math.max(T.original.endLineNumberExclusive - f.original.endLineNumberExclusive, y.modified.endLineNumberExclusive - f.modified.endLineNumberExclusive);
    let I;
    for (I = 0; I < x; I++) {
      const P = f.original.startLineNumber - I - 1, b = f.modified.startLineNumber - I - 1;
      if (P > i.length || b > r.length || u.contains(b) || c.contains(P) || !ds(i[P - 1], r[b - 1], s))
        break;
    }
    I > 0 && (c.addRange(new X(f.original.startLineNumber - I, f.original.startLineNumber)), u.addRange(new X(f.modified.startLineNumber - I, f.modified.startLineNumber)));
    let H;
    for (H = 0; H < L; H++) {
      const P = f.original.endLineNumberExclusive + H, b = f.modified.endLineNumberExclusive + H;
      if (P > i.length || b > r.length || u.contains(b) || c.contains(P) || !ds(i[P - 1], r[b - 1], s))
        break;
    }
    H > 0 && (c.addRange(new X(f.original.endLineNumberExclusive, f.original.endLineNumberExclusive + H)), u.addRange(new X(f.modified.endLineNumberExclusive, f.modified.endLineNumberExclusive + H))), (I > 0 || H > 0) && (a[m] = new xe(new X(f.original.startLineNumber - I, f.original.endLineNumberExclusive + H), new X(f.modified.startLineNumber - I, f.modified.endLineNumberExclusive + H)));
  }
  return a;
}
function ds(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new Za().compute(new ln([e], new $(1, 1, 1, e.length), !1), new ln([t], new $(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function Cu(e) {
  if (e.length === 0)
    return e;
  e.sort(Et((n) => n.original.startLineNumber, Rt));
  const t = [e[0]];
...
function Eu(e, t) {
  const n = new an(e);
  return t = t.filter((i) => {
    const r = n.findLastMonotonous((l) => l.original.startLineNumber < i.original.endLineNumberExclusive) || new xe(new X(1, 1), new X(1, 1)), s = vt(e, (l) => l.modified.startLineNumber < i.modified.endLineNumberExclusive);
    return r !== s;
  }), t;
}
function ms(e, t, n) {
  let i = n;
  return i = fs(e, t, i), i = fs(e, t, i), i = Ru(e, t, i), i;
}
function fs(e, t, n) {
  if (n.length === 0)
    return n;
...
function Ru(e, t, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    const r = i > 0 ? n[i - 1] : void 0, s = n[i], a = i + 1 < n.length ? n[i + 1] : void 0, l = new G(r ? r.seq1Range.endExclusive + 1 : 0, a ? a.seq1Range.start - 1 : e.length), o = new G(r ? r.seq2Range.endExclusive + 1 : 0, a ? a.seq2Range.start - 1 : t.length);
    s.seq1Range.isEmpty ? n[i] = ps(s, e, t, l, o) : s.seq2Range.isEmpty && (n[i] = ps(s.swap(), t, e, o, l).swap());
  }
  return n;
}
function ps(e, t, n, i, r) {
  ...
  let o = 0, u = -1;
  for (let c = -a; c <= l; c++) {
    const d = e.seq2Range.start + c, m = e.seq2Range.endExclusive + c, f = e.seq1Range.start + c, w = t.getBoundaryScore(f) + n.getBoundaryScore(d) + n.getBoundaryScore(m);
    w > u && (u = w, o = c);
  }
  return e.delta(o);
}
function Du(e, t, n) {
  ...
  for (const r of n) {
    ...
    r.seq1Range.start - s.seq1Range.endExclusive <= 2 || r.seq2Range.start - s.seq2Range.endExclusive <= 2 ? i[i.length - 1] = new ne(s.seq1Range.join(r.seq1Range), s.seq2Range.join(r.seq2Range)) : i.push(r);
  }
  return i;
}
function gs(e, t, n, i, r = !1) {
  const s = ne.invert(n, e.length), a = [];
  let l = new Ue(0, 0);
  function o(c, d) {
    if (c.offset1 < l.offset1 || c.offset2 < l.offset2)
      return;
    const m = i(e, c.offset1), f = i(t, c.offset2);
    if (!m || !f)
      return;
    let w = new ne(m, f);
    const p = w.intersect(d);
    let x = p.seq1Range.length, T = p.seq2Range.length;
    for (; s.length > 0; ) {
      const y = s[0];
      if (!(y.seq1Range.intersects(w.seq1Range) || y.seq2Range.intersects(w.seq2Range)))
        break;
      const I = i(e, y.seq1Range.start), H = i(t, y.seq2Range.start), P = new ne(I, H), b = P.intersect(y);
      if (x += b.seq1Range.length, T += b.seq2Range.length, w = w.join(P), w.seq1Range.endExclusive >= y.seq1Range.endExclusive)
        s.shift();
      else
        break;
    }
    (r && x + T < w.seq1Range.length + w.seq2Range.length || x + T < (w.seq1Range.length + w.seq2Range.length) * 2 / 3) && a.push(w), l = w.getEndExclusives();
  }
  for (; s.length > 0; ) {
    const c = s.shift();
  ...
  do {
    ...
    for (let o = 1; o < i.length; o++) {
      let d = function(f, w) {
        ...
        return e.getText(p).replace(/\s/g, "").length <= 4 && (f.seq1Range.length + f.seq2Range.length > 5 || w.seq1Range.length + w.seq2Range.length > 5);
      };
      var a = d;
...
function Iu(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < i.length; u++) {
      let m = function(w, p) {
        const x = new G(d.seq1Range.endExclusive, c.seq1Range.start);
        if (e.countLinesIn(x) > 5 || x.length > 500)
          return !1;
        const y = e.getText(x).trim();
        if (y.length > 20 || y.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const L = e.countLinesIn(w.seq1Range), I = w.seq1Range.length, H = t.countLinesIn(w.seq2Range), P = w.seq2Range.length, b = e.countLinesIn(p.seq1Range), g = p.seq1Range.length, _ = t.countLinesIn(p.seq2Range), N = p.seq2Range.length, A = 2 * 40 + 50;
        function v(S) {
          return Math.min(S, A);
        }
        return Math.pow(Math.pow(v(L * 40 + I), 1.5) + Math.pow(v(H * 40 + P), 1.5), 1.5) + Math.pow(Math.pow(v(b * 40 + g), 1.5) + Math.pow(v(_ * 40 + N), 1.5), 1.5) > (A ** 1.5) ** 1.5 * 1.3;
      };
      var l = m;
  ...
  return su(i, (o, u, c) => {
    ...
    const f = e.extendToFullLines(u.seq1Range), w = e.getText(new G(f.start, u.seq1Range.start));
    m(w) && (d = d.deltaStart(-w.length));
    const p = e.getText(new G(u.seq1Range.endExclusive, f.endExclusive));
    m(p) && (d = d.deltaEnd(p.length));
    const x = ne.fromOffsetPairs(o ? o.getEndExclusives() : Ue.zero, c ? c.getStarts() : Ue.max), T = d.intersect(x);
...
class bs {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : ws(this.lines[t - 1]), i = t === this.lines.length ? 0 : ws(this.lines[t]);
    return 1e3 - (n + i);
  }
  getText(t) {
...
class zu {
  constructor() {
    this.dynamicProgrammingDiffing = new vu(), this.myersDiffingAlgorithm = new Za();
  }
  computeDiff(t, n, i) {
    if (t.length <= 1 && nu(t, n, (b, g) => b === g))
      return new Yt([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new Yt([
        new Fe(new X(1, t.length + 1), new X(1, n.length + 1), [
          new ye(new $(1, 1, t.length, t[t.length - 1].length + 1), new $(1, 1, n.length, n[n.length - 1].length + 1))
        ])
      ], [], !1);
    const r = i.maxComputationTimeMs === 0 ? Ft.instance : new _u(i.maxComputationTimeMs), s = !i.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function l(b) {
      let g = a.get(b);
      return g === void 0 && (g = a.size, a.set(b, g)), g;
    }
    const o = t.map((b) => l(b.trim())), u = n.map((b) => l(b.trim())), c = new bs(o, t), d = new bs(u, n), m = c.length + d.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, d, r, (b, g) => t[b] === n[g] ? n[g].length === 0 ? 0.1 : 1 + Math.log(1 + n[g].length) : 0.99) : this.myersDiffingAlgorithm.compute(c, d, r);
    let f = m.diffs, w = m.hitTimeout;
    f = ms(c, d, f), f = Nu(c, d, f);
    const p = [], x = (b) => {
      if (s)
        for (let g = 0; g < b; g++) {
          const _ = T + g, N = y + g;
          if (t[_] !== n[N]) {
            const A = this.refineDiff(t, n, new ne(new G(_, _ + 1), new G(N, N + 1)), r, s, i);
            for (const v of A.mappings)
              p.push(v);
            A.hitTimeout && (w = !0);
          }
        }
    ...
    let T = 0, y = 0;
    for (const b of f) {
      Zt(() => b.seq1Range.start - T === b.seq2Range.start - y);
      const g = b.seq1Range.start - T;
      x(g), T = b.seq1Range.endExclusive, y = b.seq2Range.endExclusive;
      const _ = this.refineDiff(t, n, b, r, s, i);
      _.hitTimeout && (w = !0);
      for (const N of _.mappings)
        p.push(N);
    }
    x(t.length - T);
    const L = new jt(t), I = new jt(n), H = ss(p, L, I);
    let P = [];
    return i.computeMoves && (P = this.computeMoves(H, t, n, o, u, r, s, i)), Zt(() => {
      function b(_, N) {
        if (_.lineNumber < 1 || _.lineNumber > N.length)
          return !1;
        const A = N[_.lineNumber - 1];
      ...
      for (const _ of H) {
        ...
        for (const N of _.innerChanges)
          if (!(b(N.modifiedRange.getStartPosition(), n) && b(N.modifiedRange.getEndPosition(), n) && b(N.originalRange.getStartPosition(), t) && b(N.originalRange.getEndPosition(), t)))
            return !1;
        if (!g(_.modified, n) || !g(_.original, t))
          return !1;
      }
      return !0;
    }), new Yt(H, P, w);
  ...
  computeMoves(t, n, i, r, s, a, l, o) {
    return ku(t, n, i, r, s, a).map((d) => {
      const m = this.refineDiff(n, i, new ne(d.original.toOffsetRange(), d.modified.toOffsetRange()), a, l, o), f = ss(m.mappings, new jt(n), new jt(i), !0);
      return new tu(d, f);
    });
  }
  refineDiff(t, n, i, r, s, a) {
    const o = Hu(i).toRangeMapping2(t, n), u = new ln(t, o.originalRange, s), c = new ln(n, o.modifiedRange, s), d = u.length + c.length < 500 ? this.dynamicProgrammingDiffing.compute(u, c, r) : this.myersDiffingAlgorithm.compute(u, c, r);
    let m = d.diffs;
    return m = ms(u, c, m), m = gs(u, c, m, (w, p) => w.findWordContaining(p)), a.extendToSubwords && (m = gs(u, c, m, (w, p) => w.findSubWordContaining(p), !0)), m = Du(u, c, m), m = Iu(u, c, m), {
...
function Hu(e) {
  return new xe(new X(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new X(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
}
const _s = {
  getLegacy: () => new pu(),
  getDefault: () => new zu()
...
class C {
  constructor(t, n, i, r = 1) {
    this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, t)) | 0, this.g = Math.min(255, Math.max(0, n)) | 0, this.b = Math.min(255, Math.max(0, i)) | 0, this.a = $e(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
...
class Te {
  constructor(t, n, i, r) {
    this._hslaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = $e(Math.max(Math.min(1, n), 0), 3), this.l = $e(Math.max(Math.min(1, i), 0), 3), this.a = $e(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
...
class ht {
  constructor(t, n, i, r) {
    this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = $e(Math.max(Math.min(1, n), 0), 3), this.v = $e(Math.max(Math.min(1, i), 0), 3), this.a = $e(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
  ...
  static fromRGBA(t) {
    ...
    let u;
    return l === 0 ? u = 0 : s === n ? u = ((i - r) / l % 6 + 6) % 6 : s === i ? u = (r - n) / l + 2 : u = (n - i) / l + 4, new ht(Math.round(u * 60), o, s, t.a);
  }
  // from http://www.rapidtables.com/convert/color/hsv-to-rgb.htm
  static toRGBA(t) {
    const { h: n, s: i, v: r, a: s } = t, a = r * i, l = a * (1 - Math.abs(n / 60 % 2 - 1)), o = r - a;
    let [u, c, d] = [0, 0, 0];
    return n < 60 ? (u = a, c = l) : n < 120 ? (u = l, c = a) : n < 180 ? (c = a, d = l) : n < 240 ? (c = l, d = a) : n < 300 ? (u = l, d = a) : n <= 360 && (u = a, d = l), u = Math.round((u + o) * 255), c = Math.round((c + o) * 255), d = Math.round((d + o) * 255), new C(u, c, d, s);
  }
}
var Q;
let un = (Q = class {
  ...
  equals(t) {
    return !!t && C.equals(this.rgba, t.rgba) && Te.equals(this.hsla, t.hsla) && ht.equals(this.hsva, t.hsva);
  }
  /**
...
}, Q.white = new Q(new C(255, 255, 255, 1)), Q.black = new Q(new C(0, 0, 0, 1)), Q.red = new Q(new C(255, 0, 0, 1)), Q.blue = new Q(new C(0, 0, 255, 1)), Q.green = new Q(new C(0, 255, 0, 1)), Q.cyan = new Q(new C(0, 255, 255, 1)), Q.lightgrey = new Q(new C(211, 211, 211, 1)), Q.transparent = new Q(new C(0, 0, 0, 0)), Q);
(function(e) {
  (function(t) {
    (function(n) {
      function i(p) {
      ...
      function d(p) {
        ...
        if (p.startsWith("rgba(")) {
          ...
          const g = parseInt(((x = b.groups) == null ? void 0 : x.r) ?? "0"), _ = parseInt(((T = b.groups) == null ? void 0 : T.g) ?? "0"), N = parseInt(((y = b.groups) == null ? void 0 : y.b) ?? "0"), A = parseFloat(((L = b.groups) == null ? void 0 : L.a) ?? "0");
          return new e(new C(g, _, N, A));
        }
        if (p.startsWith("rgb(")) {
          const b = p.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
          if (!b)
            throw new Error("Invalid color format " + p);
          const g = parseInt(((I = b.groups) == null ? void 0 : I.r) ?? "0"), _ = parseInt(((H = b.groups) == null ? void 0 : H.g) ?? "0"), N = parseInt(((P = b.groups) == null ? void 0 : P.b) ?? "0");
      ...
      function f(p) {
        const x = p.length;
        if (x === 0 || p.charCodeAt(0) !== 35)
          return null;
        if (x === 7) {
          const T = 16 * w(p.charCodeAt(1)) + w(p.charCodeAt(2)), y = 16 * w(p.charCodeAt(3)) + w(p.charCodeAt(4)), L = 16 * w(p.charCodeAt(5)) + w(p.charCodeAt(6));
          return new e(new C(T, y, L, 1));
        }
        if (x === 9) {
          const T = 16 * w(p.charCodeAt(1)) + w(p.charCodeAt(2)), y = 16 * w(p.charCodeAt(3)) + w(p.charCodeAt(4)), L = 16 * w(p.charCodeAt(5)) + w(p.charCodeAt(6)), I = 16 * w(p.charCodeAt(7)) + w(p.charCodeAt(8));
          return new e(new C(T, y, L, I / 255));
        }
        if (x === 4) {
          const T = w(p.charCodeAt(1)), y = w(p.charCodeAt(2)), L = w(p.charCodeAt(3));
          return new e(new C(16 * T + T, 16 * y + y, 16 * L + L));
        }
        if (x === 5) {
          const T = w(p.charCodeAt(1)), y = w(p.charCodeAt(2)), L = w(p.charCodeAt(3)), I = w(p.charCodeAt(4));
...
function Uu(e, t) {
  ...
  if (n)
    return {
      range: e,
      color: Mi(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
    };
}
function vs(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = Ka(r);
  return {
    range: e,
    color: Mi(s[0], s[1], s[2], n ? s[3] : 1)
  };
}
function ys(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = Ka(r), a = new un(new Te(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1));
  return {
    range: e,
    color: Mi(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a)
  };
}
function At(e, t) {
...
function Pu(e) {
  const t = [], n = new RegExp(`\\b(rgb|rgba|hsl|hsla)(\\([0-9\\s,.\\%]*\\))|^(#)([A-Fa-f0-9]{3})\\b|^(#)([A-Fa-f0-9]{4})\\b|^(#)([A-Fa-f0-9]{6})\\b|^(#)([A-Fa-f0-9]{8})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{3})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{4})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{6})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{8})\\b`, "gm"), i = At(e, n);
  if (i.length > 0)
    for (const r of i) {
      ...
      if (a === "rgb") {
        ...
        o = ys(St(e, r), At(l, u), !0);
      } else a === "#" && (o = Uu(St(e, r), a + l));
      o && t.push(o);
    }
  return t;
}
...
function Vu(e, t) {
  ...
  if (!t.markSectionHeaderRegex || t.markSectionHeaderRegex.trim() === "")
    return n;
  const r = jl(t.markSectionHeaderRegex), s = new RegExp(t.markSectionHeaderRegex, `gdm${r ? "s" : ""}`);
  if (Fo(s))
    return n;
  for (let a = 1; a <= i; a += Ts - Bu) {
    const l = Math.min(a + Ts - 1, i), o = [];
    for (let d = a; d <= l; d++)
...
`) + 1, y = c.index - T + 1, L = w[w.length - 1], I = p === 1 ? y + c[0].length : L.length + 1, H = {
        startLineNumber: f,
        startColumn: y,
        endLineNumber: x,
        endColumn: I
      }, P = (c.groups ?? {}).label ?? "", b = ((c.groups ?? {}).separator ?? "") !== "", g = {
        range: H,
        text: P,
        hasSeparatorLine: b,
...
function ju(e) {
  ...
  return e = e.replace(Fu, ""), { text: e, hasSeparatorLine: t };
}
class $u {
  get isRejected() {
    var t;
...
const me = class me {
  constructor(t, n) {
    this._onReturn = n, this._producerConsumer = new Gu(), this._iterator = {
...
class Qu {
  ...
  onEvents(t) {
    ...
    const n = t.changes;
    for (const i of n)
      this._acceptDeleteRange(i.range), this._acceptInsertText(new K(i.range.startLineNumber, i.range.startColumn), i.text);
...
class Yu {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new Zu(Ri.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class Zu extends Qu {
  ...
  findMatches(t) {
    ...
    for (let i = 0; i < this._lines.length; i++) {
      const r = this._lines[i], s = this.offsetAt(new K(i + 1, 1)), a = r.matchAll(t);
      for (const l of a)
  ...
  getWordAtPosition(t, n) {
    const i = Di(t.column, Ja(n), this._lines[t.lineNumber - 1], 0);
    return i ? new $(t.lineNumber, i.startColumn, t.lineNumber, i.endColumn) : null;
  }
  words(t) {
...
const Ze = class Ze {
  constructor(t = null) {
    this._foreignModule = t, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new Yu();
  }
  dispose() {
  }
  async $ping() {
  ...
  async $computeUnicodeHighlights(t, n, i) {
    ...
    return r ? Kl.computeUnicodeHighlights(r, n, i) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  async $computeDiff(t, n, i, r) {
    ...
    return !s || !a ? null : Ze.computeDiff(s, a, i, r);
  }
  static computeDiff(t, n, i, r) {
    const s = r === "advanced" ? _s.getDefault() : _s.getLegacy(), a = t.getLinesContent(), l = n.getLinesContent(), o = s.computeDiff(a, l, i), u = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function c(d) {
      return d.map((m) => {
        var f;
        return [m.original.startLineNumber, m.original.endLineNumberExclusive, m.modified.startLineNumber, m.modified.endLineNumberExclusive, (f = m.innerChanges) == null ? void 0 : f.map((w) => [
  ...
  async $computeMoreMinimalEdits(t, n, i) {
    ...
    n = n.slice(0).sort((o, u) => {
      if (o.range && u.range)
        return $.compareRangesUsingStarts(o.range, u.range);
      const c = o.range ? 0 : 1, d = u.range ? 0 : 1;
      return c - d;
    });
    let l = 0;
    for (let o = 1; o < n.length; o++)
      $.getEndPosition(n[l].range).equals($.getStartPosition(n[o].range)) ? (n[l].range = $.fromPositions($.getStartPosition(n[l].range), $.getEndPosition(n[o].range)), n[l].text += n[o].text) : (l++, n[l] = n[o]);
    n.length = l + 1;
    for (let { range: o, text: u, eol: c } of n) {
      if (typeof c == "number" && (a = c), $.isEmpty(o) && !u)
        continue;
      const d = r.getValueInRange(o);
      if (u = u.replace(/\r\n|\n|\r/g, r.eol), d === u)
        continue;
      if (Math.max(u.length, d.length) > Ze._diffLimit) {
        s.push({ range: o, text: u });
        continue;
      }
      const m = al(d, u, i), f = r.offsetAt($.lift(o).getStartPosition());
      for (const w of m) {
        const p = r.positionAt(f + w.originalStart), x = r.positionAt(f + w.originalStart + w.originalLength), T = {
  ...
  async $textualSuggest(t, n, i, r) {
    const s = new Sn(), a = new RegExp(i, r), l = /* @__PURE__ */ new Set();
    e: for (const o of t) {
      const u = this._getModel(o);
      if (u) {
        for (const c of u.words(a))
          if (!(c === n || !isNaN(Number(c))) && (l.add(c), l.size > Ze._suggestionsLimit))
            break e;
      }
    }
...
Ze._diffLimit = 1e5, Ze._suggestionsLimit = 1e4;
let ai = Ze;
typeof importScripts == "function" && (globalThis.monaco = Fl());
const zt = class zt {
  static getChannel(t) {
    return t.getChannel(zt.CHANNEL_NAME);
  }
  static setChannel(t, n) {
    t.setChannel(zt.CHANNEL_NAME, n);
  }
};
zt.CHANNEL_NAME = "editorWorkerHost";
let oi = zt;
function Ku(e) {
  let t;
  const n = rl((i) => {
    const r = oi.getChannel(i), a = {
      host: new Proxy({}, {
        get(l, o, u) {
          if (o !== "then") {
            if (typeof o != "string")
...
var tc = /{([^}]+)}/g;
function nc(e, t) {
  return Object.keys(t).length === 0 ? e : e.replace(tc, (n, i) => t[i] ?? n);
}
var Ss;
(function(e) {
  function t(n) {
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return R.objectLiteral(r) && J.is(r.targetRange) && R.string(r.targetUri) && J.is(r.targetSelectionRange) && (J.is(r.originSelectionRange) || R.undefined(r.originSelectionRange));
  }
  e.is = n;
})(Ls || (Ls = {}));
var ui;
...
(function(e) {
  ...
  function n(i) {
    const r = i;
    return R.objectLiteral(r) && J.is(r.range) && ui.is(r.color);
  }
  e.is = n;
})(Cs || (Cs = {}));
var Es;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return R.objectLiteral(r) && R.string(r.label) && (R.undefined(r.textEdit) || le.is(r)) && (R.undefined(r.additionalTextEdits) || R.typedArray(r.additionalTextEdits, le.is));
  }
  e.is = n;
})(Es || (Es = {}));
var dn;
...
(function(e) {
  function t(i, r, s, a, l, o) {
    ...
    return R.defined(s) && (u.startCharacter = s), R.defined(a) && (u.endCharacter = a), R.defined(l) && (u.kind = l), R.defined(o) && (u.collapsedText = o), u;
  }
  e.create = t;
  function n(i) {
    const r = i;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return R.defined(r) && hn.is(r.location) && R.string(r.message);
  }
  e.is = n;
})(ci || (ci = {}));
var Ds;
...
(function(e) {
  function t(i, r, s, a, l, o) {
    ...
    return R.defined(s) && (u.severity = s), R.defined(a) && (u.code = a), R.defined(l) && (u.source = l), R.defined(o) && (u.relatedInformation = o), u;
  }
  e.create = t;
  function n(i) {
    var r;
    let s = i;
    return R.defined(s) && J.is(s.range) && R.string(s.message) && (R.number(s.severity) || R.undefined(s.severity)) && (R.integer(s.code) || R.string(s.code) || R.undefined(s.code)) && (R.undefined(s.codeDescription) || R.string((r = s.codeDescription) === null || r === void 0 ? void 0 : r.href)) && (R.string(s.source) || R.undefined(s.source)) && (R.undefined(s.relatedInformation) || R.typedArray(s.relatedInformation, ci.is));
  }
  e.is = n;
})(mn || (mn = {}));
var Tt;
...
(function(e) {
  ...
  function r(s) {
    const a = s;
    return le.is(a) && (hi.is(a.annotationId) || xt.is(a.annotationId));
  }
  e.is = r;
})(Is || (Is = {}));
var di;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return R.defined(r) && bi.is(r.textDocument) && Array.isArray(r.edits);
  }
  e.is = n;
})(di || (di = {}));
var mi;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "create" && R.string(r.uri) && (r.options === void 0 || (r.options.overwrite === void 0 || R.boolean(r.options.overwrite)) && (r.options.ignoreIfExists === void 0 || R.boolean(r.options.ignoreIfExists))) && (r.annotationId === void 0 || xt.is(r.annotationId));
  }
  e.is = n;
})(mi || (mi = {}));
var fi;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "rename" && R.string(r.oldUri) && R.string(r.newUri) && (r.options === void 0 || (r.options.overwrite === void 0 || R.boolean(r.options.overwrite)) && (r.options.ignoreIfExists === void 0 || R.boolean(r.options.ignoreIfExists))) && (r.annotationId === void 0 || xt.is(r.annotationId));
  }
  e.is = n;
})(fi || (fi = {}));
var pi;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "delete" && R.string(r.uri) && (r.options === void 0 || (r.options.recursive === void 0 || R.boolean(r.options.recursive)) && (r.options.ignoreIfNotExists === void 0 || R.boolean(r.options.ignoreIfNotExists))) && (r.annotationId === void 0 || xt.is(r.annotationId));
  }
  e.is = n;
})(pi || (pi = {}));
var gi;
(function(e) {
  function t(n) {
    let i = n;
    return i && (i.changes !== void 0 || i.documentChanges !== void 0) && (i.documentChanges === void 0 || i.documentChanges.every((r) => R.string(r.kind) ? mi.is(r) || fi.is(r) || pi.is(r) : di.is(r)));
  }
  e.is = t;
})(gi || (gi = {}));
var zs;
...
(function(e) {
  function t(n) {
    const i = n;
    return R.objectLiteral(n) && Pe.is(i.kind) && R.string(i.value);
  }
  e.is = t;
})(Bt || (Bt = {}));
var fe;
...
(function(e) {
  function t(n) {
    let i = n;
    return !!i && R.objectLiteral(i) && (Bt.is(i.contents) || fn.is(i.contents) || R.typedArray(i.contents, fn.is)) && (n.range === void 0 || J.is(n.range));
  }
  e.is = t;
})(Vs || (Vs = {}));
var js;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && R.string(r.name) && R.number(r.kind) && J.is(r.range) && J.is(r.selectionRange) && (r.detail === void 0 || R.string(r.detail)) && (r.deprecated === void 0 || R.boolean(r.deprecated)) && (r.children === void 0 || Array.isArray(r.children)) && (r.tags === void 0 || Array.isArray(r.tags));
  }
  e.is = n;
})(vi || (vi = {}));
var Qs;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return R.defined(r) && R.typedArray(r.diagnostics, mn.is) && (r.only === void 0 || R.typedArray(r.only, R.string)) && (r.triggerKind === void 0 || r.triggerKind === gn.Invoked || r.triggerKind === gn.Automatic);
  }
  e.is = n;
})(Ys || (Ys = {}));
var Zs;
(function(e) {
  function t(i, r, s) {
    let a = { title: i }, l = !0;
    return typeof r == "string" ? (l = !1, a.kind = r) : Tt.is(r) ? a.command = r : a.edit = r, l && s !== void 0 && (a.kind = s), a;
  }
  e.create = t;
  function n(i) {
    let r = i;
    return r && R.string(r.title) && (r.diagnostics === void 0 || R.typedArray(r.diagnostics, mn.is)) && (r.kind === void 0 || R.string(r.kind)) && (r.edit !== void 0 || r.command !== void 0) && (r.command === void 0 || Tt.is(r.command)) && (r.isPreferred === void 0 || R.boolean(r.isPreferred)) && (r.edit === void 0 || gi.is(r.edit));
  }
  e.is = n;
})(Zs || (Zs = {}));
var Ks;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return R.defined(r) && J.is(r.range) && (R.undefined(r.command) || Tt.is(r.command));
  }
  e.is = n;
})(Ks || (Ks = {}));
var ea;
...
(function(e) {
  ...
  function n(i) {
    const r = i;
    return R.objectLiteral(r) && (r.tooltip === void 0 || R.string(r.tooltip) || Bt.is(r.tooltip)) && (r.location === void 0 || hn.is(r.location)) && (r.command === void 0 || Tt.is(r.command));
  }
  e.is = n;
})(Ti || (Ti = {}));
var ua;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return R.objectLiteral(r) && se.is(r.position) && (R.string(r.label) || R.typedArray(r.label, Ti.is)) && (r.kind === void 0 || yi.is(r.kind)) && r.textEdits === void 0 || R.typedArray(r.textEdits, le.is) && (r.tooltip === void 0 || R.string(r.tooltip) || Bt.is(r.tooltip)) && (r.paddingLeft === void 0 || R.boolean(r.paddingLeft)) && (r.paddingRight === void 0 || R.boolean(r.paddingRight));
  }
  e.is = n;
})(ua || (ua = {}));
var ca;
...
(function(e) {
  function t(n) {
    const i = n;
    return R.objectLiteral(i) && li.is(i.uri) && R.string(i.name);
  }
  e.is = t;
})(ga || (ga = {}));
var ba;
...
class qt {
  ...
  update(t, n) {
    for (let i of t)
      if (qt.isIncremental(i)) {
        const r = eo(i.range), s = this.offsetAt(r.start), a = this.offsetAt(r.end);
  ...
  getLineOffsets() {
    return this._lineOffsets === void 0 && (this._lineOffsets = wa(this._content, !0)), this._lineOffsets;
  }
  positionAt(t) {
    t = Math.max(Math.min(t, this._content.length), 0);
    let n = this.getLineOffsets(), i = 0, r = n.length;
...
(function(e) {
  ...
  e.update = n;
  function i(r, s) {
    let a = r.getText(), l = ki(s.map(rc), (c, d) => {
      let m = c.range.start.line - d.range.start.line;
      return m === 0 ? c.range.start.character - d.range.start.character : m;
    }), o = 0;
    const u = [];
...
class sc {
  ...
  skipWhitespace() {
    return this.advanceWhileChar((n) => n === dc || n === mc || n === uc || n === hc || n === cc) > 0;
  }
  advanceWhileChar(t) {
    const n = this.position;
    for (; this.position < this.len && t(this.source.charCodeAt(this.position)); )
      this.position++;
    return this.position - n;
  }
}
const va = 33, ut = 45, $t = 60, Re = 62, Nn = 47, ac = 61, oc = 34, lc = 39, uc = 10, cc = 13, hc = 12, dc = 32, mc = 9, fc = {
  "text/x-handlebars-template": !0,
  // Fix for https://github.com/microsoft/vscode/issues/77977
  "text/html": !0
};
function _e(e, t = 0, n = V.WithinContent, i = !1) {
  const r = new sc(e, t);
  ...
  function x() {
    const y = r.pos(), L = s, I = T();
    return I !== z.EOS && y === r.pos() && !(i && (I === z.StartTagClose || I === z.EndTagClose)) ? (console.warn("Scanner.scan has not advanced at offset " + y + ", state before: " + L + " after: " + s), r.advance(1), p(y, z.Unknown)) : I;
  }
  function T() {
    const y = r.pos();
    if (r.eos())
    ...
    switch (s) {
      case V.WithinComment:
        return r.advanceIfChars([ut, ut, Re]) ? (s = V.WithinContent, p(y, z.EndCommentTag)) : (r.advanceUntilChars([ut, ut, Re]), p(y, z.Comment));
      case V.WithinDoctype:
        return r.advanceIfChar(Re) ? (s = V.WithinContent, p(y, z.EndDoctypeTag)) : (r.advanceUntilChar(Re), p(y, z.Doctype));
      case V.WithinContent:
        if (r.advanceIfChar($t)) {
          if (!r.eos() && r.peekChar() === va) {
            if (r.advanceIfChars([va, ut, ut]))
          ...
          return r.advanceIfChar(Nn) ? (s = V.AfterOpeningEndTag, p(y, z.EndTagOpen)) : (s = V.AfterOpeningStartTag, p(y, z.StartTagOpen));
        }
        return r.advanceUntilChar($t), p(y, z.Content);
      case V.AfterOpeningEndTag:
        return f().length > 0 ? (s = V.WithinEndTag, p(y, z.EndTag)) : r.skipWhitespace() ? p(y, z.Whitespace, Ce("Tag name must directly follow the open bracket.")) : (s = V.WithinEndTag, r.advanceUntilChar(Re), y < r.pos() ? p(y, z.Unknown, Ce("End tag name expected.")) : T());
      case V.WithinEndTag:
        if (r.skipWhitespace())
          return p(y, z.Whitespace);
        if (r.advanceIfChar(Re))
          return s = V.WithinContent, p(y, z.EndTagClose);
        if (i && r.peekChar() === $t)
          return s = V.WithinContent, p(y, z.EndTagClose, Ce("Closing bracket missing."));
        L = Ce("Closing bracket expected.");
        break;
      case V.AfterOpeningStartTag:
        return c = f(), m = void 0, d = void 0, c.length > 0 ? (u = !1, s = V.WithinTag, p(y, z.StartTag)) : r.skipWhitespace() ? p(y, z.Whitespace, Ce("Tag name must directly follow the open bracket.")) : (s = V.WithinTag, r.advanceUntilChar(Re), y < r.pos() ? p(y, z.Unknown, Ce("Start tag name expected.")) : T());
      case V.WithinTag:
        return r.skipWhitespace() ? (u = !0, p(y, z.Whitespace)) : u && (d = w(), d.length > 0) ? (s = V.AfterAttributeName, u = !1, p(y, z.AttributeName)) : r.advanceIfChars([Nn, Re]) ? (s = V.WithinContent, p(y, z.StartTagSelfClose)) : r.advanceIfChar(Re) ? (c === "script" ? m && fc[m] ? s = V.WithinContent : s = V.WithinScriptContent : c === "style" ? s = V.WithinStyleContent : s = V.WithinContent, p(y, z.StartTagClose)) : i && r.peekChar() === $t ? (s = V.WithinContent, p(y, z.StartTagClose, Ce("Closing bracket missing."))) : (r.advance(1), p(y, z.Unknown, Ce("Unexpected character in tag.")));
      case V.AfterAttributeName:
        return r.skipWhitespace() ? (u = !0, p(y, z.Whitespace)) : r.advanceIfChar(ac) ? (s = V.BeforeAttributeValue, p(y, z.DelimiterAssign)) : (s = V.WithinTag, T());
      case V.BeforeAttributeValue:
        if (r.skipWhitespace())
          return p(y, z.Whitespace);
        let H = r.advanceIfRegExp(/^[^\s"'`=<>]+/);
        if (H.length > 0 && (r.peekChar() === Re && r.peekChar(-1) === Nn && (r.goBack(1), H = H.substring(0, H.length - 1)), d === "type" && (m = H), H.length > 0))
          return s = V.WithinTag, u = !1, p(y, z.AttributeValue);
        const P = r.peekChar();
        return P === lc || P === oc ? (r.advance(1), r.advanceUntilChar(P) && r.advance(1), d === "type" && (m = r.getSource().substring(y + 1, r.pos() - 1)), s = V.WithinTag, u = !1, p(y, z.AttributeValue)) : (s = V.WithinTag, u = !1, T());
      case V.WithinScriptContent:
        let b = 1;
        for (; !r.eos(); ) {
          const g = r.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
          if (g.length === 0)
            return r.goToEnd(), p(y, z.Script);
          if (g === "<!--")
            b === 1 && (b = 2);
          else if (g === "-->")
            b = 1;
...
class Ta {
  ...
  findNodeBefore(t) {
    const n = ya(this.children, (i) => t <= i.start) - 1;
    if (n >= 0) {
...
class gc {
  ...
  parse(t, n) {
    const i = _e(t, void 0, void 0, !0), r = new Ta(0, t.length, [], void 0);
    let s = r, a = -1, l, o = null, u = i.scan();
    for (; u !== z.EOS; ) {
      switch (u) {
        case z.StartTagOpen:
          const c = new Ta(i.getTokenOffset(), t.length, [], s);
        ...
        case z.StartTagClose:
          s.parent && (s.end = i.getTokenEnd(), i.getTokenLength() ? (s.startTagEnd = i.getTokenEnd(), s.tag && this.dataManager.isVoidElement(s.tag, n) && (s.closed = !0, s = s.parent)) : s = s.parent);
          break;
        ...
        case z.EndTagClose:
          let d = s;
          for (; !d.isSameTag(l) && d.parent; )
            d = d.parent;
          if (d.parent) {
            for (; s !== d; )
              s.end = a, s.closed = !1, s = s.parent;
        ...
        case z.AttributeValue: {
          const m = i.getTokenText(), f = s.attributes;
          f && o && (f[o] = m, o = null);
          break;
        }
      }
    ...
    for (; s.parent; )
      s.end = t.length, s.closed = !1, s = s.parent;
    return {
      roots: r.children,
...
const wc = 97, _c = 122, vc = 65, yc = 90, Tc = 48, xc = 57;
function Lt(e, t) {
  const n = e.charCodeAt(t);
  return wc <= n && n <= _c || vc <= n && n <= yc || Tc <= n && n <= xc;
}
function wn(e) {
  return typeof e < "u";
}
...
class to {
   ...
   */
  constructor(t, n) {
    this.id = t, this._tags = [], this._tagMap = {}, this._valueSetMap = {}, this._tags = n.tags || [], this._globalAttributes = n.globalAttributes || [], this._tags.forEach((i) => {
      this._tagMap[i.name.toLowerCase()] = i;
    }), n.valueSets && n.valueSets.forEach((i) => {
  ...
  provideValues(t, n) {
    ...
    const r = (a) => {
      a.forEach((l) => {
        l.name.toLowerCase() === n && (l.values && l.values.forEach((o) => {
          i.push(o);
        }), l.valueSet && this._valueSetMap[l.valueSet] && this._valueSetMap[l.valueSet].forEach((o) => {
          i.push(o);
        }));
      });
...
class Sc {
  ...
  async computeCompletions(t, n) {
    ...
    for (const r of this.atributeCompletions) {
      const s = Lc(t.getText(r.range));
      if (Cc(s))
        if (s === "." || s === "..")
          i.isIncomplete = !0;
        else {
          const a = Ec(r.value, s, r.range), l = await this.providePathSuggestions(r.value, a, t, n);
          for (const o of l)
            i.items.push(o);
        }
    }
  ...
  async providePathSuggestions(t, n, i, r) {
    ...
    if (a)
      try {
        const l = [], o = await this.readDirectory(a);
        for (const [u, c] of o)
          u.charCodeAt(0) !== Ac && l.push(Rc(u, c === Si.Directory, n));
        return l;
      } catch {
      }
    return [];
...
const Ac = 46;
function Lc(e) {
  return Ge(e, "'") || Ge(e, '"') ? e.slice(1, -1) : e;
}
function Cc(e) {
  return !(Ge(e, "http") || Ge(e, "https") || Ge(e, "//"));
}
function Ec(e, t, n) {
  let i;
  ...
  if (r === -1)
    ...
    const s = t.slice(r + 1), a = Nt(n.end, -1 - s.length), l = s.indexOf(" ");
    let o;
    l !== -1 ? o = Nt(a, l) : o = Nt(n.end, -1), i = J.create(a, o);
  }
  return i;
}
function Rc(e, t, n) {
...
function Dc(e, t, n) {
  const i = Nt(e.start, t), r = Nt(e.end, n);
  return J.create(i, r);
}
class Mc {
  constructor(t, n) {
  ...
  async doComplete2(t, n, i, r, s) {
    if (!this.lsOptions.fileSystemProvider || !this.lsOptions.fileSystemProvider.readDirectory)
      return this.doComplete(t, n, i, s);
    const a = new Sc(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory), l = this.completionParticipants;
  ...
  _doComplete(t, n, i, r) {
    const s = {
      isIncomplete: !1,
      items: []
    }, a = this.completionParticipants, l = this.dataManager.getDataProviders().filter((k) => k.isApplicable(t.languageId) && (!r || r[k.getId()] !== !1)), o = this.dataManager.getVoidElements(l), u = this.doesSupportMarkdown(), c = t.getText(), d = t.offsetAt(n), m = i.findNodeBefore(d);
    if (!m)
      return s;
    const f = _e(c, m.start);
    let w = "", p;
    function x(k, E = d) {
...
\r`.indexOf(M) >= 0)
    ...
    function L(k, E, M = d) {
      const W = x(k, M), F = ka(c, M, V.WithinEndTag, z.EndTagClose) ? "" : ">";
      let U = m;
      for (E && (U = U.parent); U; ) {
        const O = U.tag;
        if (O && (!U.closed || U.endTagStart && U.endTagStart > d)) {
          const Z = {
            ...
            insertTextFormat: Ae.PlainText
          }, Y = y(U.start), ve = y(k - 1);
          if (Y !== null && ve !== null && Y !== ve) {
            const ke = Y + "</" + O + F;
            Z.textEdit = le.replace(x(k - 1 - ve.length), ke), Z.filterText = ve + "</" + O;
          }
          return s.items.push(Z), s;
        }
        U = U.parent;
      }
      return E || l.forEach((O) => {
        O.provideTags().forEach((Z) => {
          s.items.push({
            label: "/" + Z.name,
            kind: fe.Property,
            documentation: Ke(Z, void 0, u),
            filterText: "/" + Z.name + F,
    ...
    function P() {
      ...
      return m.attributeNames.forEach((E) => {
        k[E] = !0;
      }), k;
    }
    function b(k, E = d) {
      ...
      for (; M < E && c[M] !== "<"; )
        M++;
      const W = c.substring(k, E), F = x(k, M);
      let U = "";
      if (!ka(c, E, V.AfterAttributeName, z.DelimiterAssign)) {
        const Z = (r == null ? void 0 : r.attributeDefaultValue) ?? "doublequotes";
        Z === "empty" ? U = "=$1" : Z === "singlequotes" ? U = "='$1'" : U = '="$1"';
      }
      const O = P();
      return O[W] = !1, l.forEach((Z) => {
        Z.provideAttributes(w).forEach((Y) => {
          if (O[Y.name])
            return;
          O[Y.name] = !0;
          let ve = Y.name, ke;
          Y.valueSet !== "v" && U.length && (ve = ve + U, (Y.valueSet || Y.name === "style") && (ke = {
            title: "Suggest",
            command: "editor.action.triggerSuggest"
          })), s.items.push({
            label: Y.name,
            kind: Y.valueSet === "handler" ? fe.Function : fe.Value,
            documentation: Ke(Y, void 0, u),
            textEdit: le.replace(F, ve),
            insertTextFormat: Ae.Snippet,
            command: ke
          });
        });
    ...
    function g(k, E) {
      ...
      function F(U) {
        U.attributeNames.forEach((O) => {
          Ge(O, M) && !W[O] && !E[O] && (W[O] = O + '="$1"');
        }), U.children.forEach((O) => F(O));
      }
      i && i.roots.forEach((U) => F(U)), Object.keys(W).forEach((U) => s.items.push({
        label: U,
        kind: fe.Value,
    ...
    function _(k, E = d) {
      ...
      if (d > k && d <= E && Nc(c[k])) {
        ...
        let O = E;
        E > k && c[E - 1] === c[k] && O--;
        const Z = Ic(c, d, U), Y = zc(c, d, O);
        M = x(Z, Y), F = d >= U && d <= O ? c.substring(U, d) : "", W = !1;
      } else
        M = x(k, E), F = c.substring(k, d), W = !0;
      if (a.length > 0) {
        const U = w.toLowerCase(), O = p.toLowerCase(), Z = x(k, E);
        for (const Y of a)
          Y.onHtmlAttributeValue && Y.onHtmlAttributeValue({ document: t, position: n, tag: U, attribute: O, value: F, range: Z });
      }
      return l.forEach((U) => {
    ...
    function A() {
      for (const k of a)
        k.onHtmlContent && k.onHtmlContent({ document: t, position: n });
      return v();
    }
    function v() {
      let k = d - 1, E = n.character;
      for (; k >= 0 && Lt(c, k); )
        k--, E--;
      if (k >= 0 && c[k] === "&") {
        ...
        for (const W in Mt)
          if (bc(W, ";")) {
            ...
            s.items.push({
              label: F,
              kind: fe.Keyword,
              documentation: Ce("Character entity representing '{0}'", Mt[W]),
    ...
    for (; D !== z.EOS && f.getTokenOffset() <= d; ) {
      switch (D) {
        ...
        case z.Whitespace:
          if (d <= f.getTokenEnd())
            switch (f.getScannerState()) {
              case V.AfterOpeningStartTag:
                const k = f.getTokenOffset(), E = N(z.StartTag);
                return H(k, E);
              case V.WithinTag:
              case V.AfterAttributeName:
        ...
        case z.EndTagOpen:
          if (d <= f.getTokenEnd()) {
            const k = f.getTokenOffset() + 1, E = N(z.EndTag);
            return L(k, !1, E);
          }
          break;
        case z.EndTag:
          ...
          break;
        case z.StartTagClose:
          if (d <= f.getTokenEnd() && w)
            return I(f.getTokenEnd(), w);
          break;
        case z.Content:
          if (d <= f.getTokenEnd())
            return A();
  ...
  doQuoteComplete(t, n, i, r) {
    ...
    if (a === "empty" || t.getText().charAt(s - 1) !== "=")
      return null;
    const o = a === "doublequotes" ? '"$1"' : "'$1'", u = i.findNodeBefore(s);
    if (u && u.attributes && u.start < s && (!u.endTagStart || u.endTagStart > s)) {
      const c = _e(t.getText(), u.start);
      let d = c.scan();
  ...
  doTagComplete(t, n, i) {
    ...
    if (s === ">") {
      const a = this.dataManager.getVoidElements(t.languageId), l = i.findNodeBefore(r);
      if (l && l.tag && !this.dataManager.isVoidElement(l.tag, a) && l.start < r && (!l.endTagStart || l.endTagStart > r)) {
        const o = _e(t.getText(), l.start);
        let u = o.scan();
        for (; u !== z.EOS && o.getTokenEnd() <= r; ) {
          if (u === z.StartTagClose && o.getTokenEnd() === r)
            return `$0</${l.tag}>`;
          u = o.scan();
        }
      }
      ...
      for (; a && a.closed && !(a.endTagStart && a.endTagStart > r); )
        a = a.parent;
      if (a && a.tag) {
        const l = _e(t.getText(), a.start);
        let o = l.scan();
        for (; o !== z.EOS && l.getTokenEnd() <= r; ) {
          if (o === z.EndTagOpen && l.getTokenEnd() === r)
            return t.getText().charAt(r) !== ">" ? `${a.tag}>` : a.tag;
          o = l.scan();
        }
      }
    }
  ...
  convertCompletionList(t) {
    return this.doesSupportMarkdown() || t.items.forEach((n) => {
  ...
  doesSupportMarkdown() {
    var t, n, i;
    if (!wn(this.supportsMarkdown)) {
      if (!wn(this.lsOptions.clientCapabilities))
        return this.supportsMarkdown = !0, this.supportsMarkdown;
      const r = (i = (n = (t = this.lsOptions.clientCapabilities.textDocument) == null ? void 0 : t.completion) == null ? void 0 : n.completionItem) == null ? void 0 : i.documentationFormat;
      this.supportsMarkdown = Array.isArray(r) && r.indexOf(Pe.Markdown) !== -1;
    }
...
class Hc {
  ...
  doHover(t, n, i, r) {
    const s = this.convertContents.bind(this), a = this.doesSupportMarkdown(), l = t.offsetAt(n), o = i.findNodeAt(l), u = t.getText();
    if (!o || !o.tag)
      return null;
    ...
    function m(b, g, _) {
      for (const N of c) {
        let A = null;
        if (N.provideAttributes(b).forEach((v) => {
          if (g === v.name && v.description) {
            const S = Ke(v, r, a);
            S ? A = { contents: S, range: _ } : A = null;
          }
        }), A)
          return A.contents = s(A.contents), A;
      }
    ...
    function f(b, g, _, N) {
      for (const A of c) {
        let v = null;
        if (A.provideValues(b, g).forEach((S) => {
    ...
    function w(b, g) {
      ...
      for (const N in Mt) {
        ...
        const v = "&" + N;
        if (_ === v) {
          let S = Mt[N].charCodeAt(0).toString(16).toUpperCase(), D = "U+";
          if (S.length < 4) {
            const E = 4 - S.length;
            let M = 0;
            for (; M < E; )
          ...
          D += S;
          const k = Ce("Character entity representing '{0}', unicode equivalent '{1}'", Mt[N], D);
    ...
    function x() {
      ...
      if (b >= 0 && u[b] === "&") {
        let A = null;
        return u[_] === ";" ? A = J.create(se.create(n.line, g), se.create(n.line, N + 1)) : A = J.create(se.create(n.line, g), se.create(n.line, N)), A;
      }
      return null;
    }
    function T(b) {
    ...
    if (I)
      return w(u, I);
    function H(b, g) {
      const _ = _e(t.getText(), b);
      let N = _.scan(), A;
      for (; N !== z.EOS && _.getTokenEnd() <= g; )
        N = _.scan(), N === z.AttributeName && (A = _.getTokenText());
      return A;
    }
    const P = p(z.AttributeValue, o.start);
    if (P) {
      const b = o.tag, g = Uc(t.getText(P)), _ = H(o.start, t.offsetAt(P.start));
      if (_)
        return f(b, _, g, P);
    }
    return null;
  ...
  convertContents(t) {
    if (!this.doesSupportMarkdown()) {
      ...
      if (Array.isArray(t))
        t.map((n) => typeof n == "string" ? n : n.value);
      else
        return t.value;
    }
    return t;
  ...
  doesSupportMarkdown() {
    ...
    if (!wn(this.supportsMarkdown)) {
      if (!wn(this.lsOptions.clientCapabilities))
        return this.supportsMarkdown = !0, this.supportsMarkdown;
      const r = (i = (n = (t = this.lsOptions.clientCapabilities) == null ? void 0 : t.textDocument) == null ? void 0 : n.hover) == null ? void 0 : i.contentFormat;
      this.supportsMarkdown = Array.isArray(r) && r.indexOf(Pe.Markdown) !== -1;
    }
    return this.supportsMarkdown;
  }
...
You passed in: '` + this.raw_options[o] + "'"
    ...
    function(r, s, a) {
      ...
      function y(L, I) {
        this._source_text = L || "", this._options = new l(I), this._ch = null, this._input = null, this.NESTED_AT_RULE = {
          page: !0,
          "font-face": !0,
          keyframes: !0,
...
` && (H === 0 || H < this._options.max_preserve_newlines) && (H++, this._output.add_new_line(!0));
        ...
        var L = this._source_text, I = this._options.eol;
        I === "auto" && (I = `
`, L && m.test(L || "") && (I = L.match(m)[0])), L = L.replace(f, `
`);
        var H = L.match(/^[\t ]*/)[0];
        this._output = new o(this._options, H), this._input = new u(L), this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
        for (var P = 0, b = !1, g = !1, _ = !1, N = !1, A = !1, v = this._ch, S = !1, D, k, E; D = this._input.read(p), k = D !== "", E = v, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), v = this._ch, this._ch; )
          if (this._ch === "/" && this._input.peek() === "*") {
            this._output.add_new_line(), this._input.back();
            var M = this._input.read(x), W = d.get_directives(M);
            W && W.ignore === "start" && (M += d.readIgnored(this._input)), this.print_string(M), this.eatWhitespace(!0), this._output.add_new_line();
            ...
            F.match(/[ :]$/) && (F = this.eatString(": ").replace(/\s+$/, ""), this.print_string(F), this._output.space_before_token = !0), P === 0 && F.indexOf(":") !== -1 && (g = !0, this.indent());
          } else if (this._ch === "@")
            ...
            (b || _) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !N && P === 0 ? (this.print_string(":"), g || (g = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent())) : (this._input.lookBack(" ") && (this._output.space_before_token = !0), this._input.peek() === ":" ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":"));
          } else if (this._ch === '"' || this._ch === "'") {
            var Z = E === '"' || E === "'";
            this.preserveSingleSpace(Z || k), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0);
          } else if (this._ch === ";")
            S = !1, P === 0 ? (g && (this.outdent(), g = !1), N = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0);
          else if (this._ch === "(")
            if (this._input.lookBack("url"))
              this.print_string(this._ch), this.eatWhitespace(), P++, this.indent(), this._ch = this._input.next(), this._ch === ")" || this._ch === '"' || this._ch === "'" ? this._input.back() : this._ch && (this.print_string(this._ch + this.eatString(")")), P && (P--, this.outdent()));
            else {
              var Y = !1;
              this._input.lookBack("with") && (Y = !0), this.preserveSingleSpace(k || Y), this.print_string(this._ch), g && E === "$" && this._options.selector_separator_newline ? (this._output.add_new_line(), A = !0) : (this.eatWhitespace(), P++, this.indent());
            }
          else if (this._ch === ")")
            P && (P--, this.outdent()), A && this._input.peek() === ";" && this._options.selector_separator_newline && (A = !1, this.outdent(), this._output.add_new_line()), this.print_string(this._ch);
          else if (this._ch === ",")
            this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && (!g || A) && P === 0 && !N ? this._output.add_new_line() : this._output.space_before_token = !0;
          else if ((this._ch === ">" || this._ch === "+" || this._ch === "~") && !g && P === 0)
            this._options.space_around_combinator ? (this._output.space_before_token = !0, this.print_string(this._ch), this._output.space_before_token = !0) : (this.print_string(this._ch), this.eatWhitespace(), this._ch && w.test(this._ch) && (this._ch = ""));
          else if (this._ch === "]")
            this.print_string(this._ch);
          else if (this._ch === "[")
            this.preserveSingleSpace(k), this.print_string(this._ch);
            ...
            var ve = E === '"' || E === "'";
            this.preserveSingleSpace(ve || k), this.print_string(this._ch), !this._output.just_added_newline() && this._input.peek() === `
` && S && this._output.add_new_line();
          }
        var ke = this._output.get_code(I);
        return ke;
...
You passed in: '` + this.raw_options[o] + "'"
    ...
    function(r, s, a) {
      var l = a(8).InputScanner, o = a(3).Token, u = a(10).TokenStream, c = a(11).WhitespacePattern, d = {
        ...
        this._input = new l(f), this._options = w || {}, this.__tokens = null, this._patterns = {}, this._patterns.whitespace = new c(this._input);
      };
      m.prototype.tokenize = function() {
        ...
        for (var f, w = new o(d.START, ""), p = null, x = [], T = new u(); w.type !== d.EOF; ) {
          ...
          T.isEmpty() || (f.comments_before = T, T = new u()), f.parent = p, this._is_opening(f) ? (x.push(p), p = f) : p && this._is_closing(f, p) && (f.opened = p, p.closed = f, p = x.pop(), f.parent = p), f.previous = w, w.next = f, this.__tokens.add(f), w = f;
        }
    ...
    function(r, s, a) {
      ...
      var w = function(b) {
        ...
        var _ = null, N = null;
        return g.closed ? (b === "script" ? _ = "text/javascript" : b === "style" && (_ = "text/css"), _ = w(g) || _, _.search("text/css") > -1 ? N = "css" : _.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? N = "javascript" : _.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? N = "html" : _.search(/test\/null/) > -1 && (N = "null"), N) : null;
      };
      function x(b, g) {
...
`);
        var _ = b.match(/^[\t ]*/)[0], N = {
          text: "",
          type: ""
        }, A = new I(), v = new f(this._options, _), S = new u(b, this._options).tokenize();
        this._tag_stack = new y(v);
        for (var D = null, k = S.next(); k.type !== c.EOF; )
          k.type === c.TAG_OPEN || k.type === c.COMMENT ? (D = this._handle_tag_open(v, k, A, N, S), A = D) : k.type === c.ATTRIBUTE || k.type === c.EQUALS || k.type === c.VALUE || k.type === c.TEXT && !A.tag_complete ? D = this._handle_inside_tag(v, k, A, N) : k.type === c.TAG_CLOSE ? D = this._handle_tag_close(v, k, A) : k.type === c.TEXT ? D = this._handle_text(v, k, A) : k.type === c.CONTROL_FLOW_OPEN ? D = this._handle_control_flow_open(v, k) : k.type === c.CONTROL_FLOW_CLOSE ? D = this._handle_control_flow_close(v, k) : v.add_raw_token(k), N = D, k = S.next();
        ...
        return b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0), g.newlines ? b.print_preserved_newlines(g) : b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0), b.print_token(g), b.indent(), _;
      }, L.prototype._handle_control_flow_close = function(b, g) {
        var _ = {
          text: g.text,
          type: g.type
        };
        return b.deindent(), g.newlines ? b.print_preserved_newlines(g) : b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0), b.print_token(g), _;
      }, L.prototype._handle_tag_close = function(b, g, _) {
        var N = {
          text: g.text,
          type: g.type
        };
        return b.alignment_size = 0, _.tag_complete = !0, b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0), _.is_unformatted ? b.add_raw_token(g) : (_.tag_start_char === "<" && (b.set_space_before_token(g.text[0] === "/", !0), this._is_wrap_attributes_force_expand_multiline && _.has_wrapped_attrs && b.print_newline(!1)), b.print_token(g)), _.indent_content && !(_.is_unformatted || _.is_content_unformatted) && (b.indent(), _.indent_content = !1), !_.is_inline_element && !(_.is_unformatted || _.is_content_unformatted) && b.set_wrap_point(), N;
      }, L.prototype._handle_inside_tag = function(b, g, _, N) {
        var A = _.has_wrapped_attrs, v = {
          text: g.text,
          type: g.type
        };
        return b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0), _.is_unformatted ? b.add_raw_token(g) : _.tag_start_char === "{" && g.type === c.TEXT ? b.print_preserved_newlines(g) ? (g.newlines = 0, b.add_raw_token(g)) : b.print_token(g) : (g.type === c.ATTRIBUTE ? b.set_space_before_token(!0) : (g.type === c.EQUALS || g.type === c.VALUE && g.previous.type === c.EQUALS) && b.set_space_before_token(!1), g.type === c.ATTRIBUTE && _.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (b.traverse_whitespace(g), A = A || g.newlines !== 0), this._is_wrap_attributes_force && _.attr_count >= this._options.wrap_attributes_min_attrs && (N.type !== c.TAG_OPEN || // ie. second attribute and beyond
        this._is_wrap_attributes_force_expand_multiline) && (b.print_newline(!1), A = !0)), b.print_token(g), A = A || b.previous_token_wrapped(), _.has_wrapped_attrs = A), v;
      }, L.prototype._handle_text = function(b, g, _) {
        var N = {
          text: g.text,
          type: "TK_CONTENT"
        };
        return _.custom_beautifier_name ? this._print_custom_beatifier_text(b, g, _) : _.is_unformatted || _.is_content_unformatted ? b.add_raw_token(g) : (b.traverse_whitespace(g), b.print_token(g)), N;
      }, L.prototype._print_custom_beatifier_text = function(b, g, _) {
        var N = this;
        if (g.text !== "") {
          var A = g.text, v, S = 1, D = "", k = "";
          _.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? v = this._js_beautify : _.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? v = this._css_beautify : _.custom_beautifier_name === "html" && (v = function(O, Z) {
          ...
          var E = b.get_full_indent(S);
          if (A = A.replace(/\n[ \t]*$/, ""), _.custom_beautifier_name !== "html" && A[0] === "<" && A.match(/^(<!--|<!\[CDATA\[)/)) {
            var M = /^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(A);
            if (!M) {
              b.add_raw_token(g);
              return;
...
`) !== -1) && (M = M[3].match(/[ \t]+$/), M && (g.whitespace_before = M[0]));
          }
          if (A)
            if (v) {
              var W = function() {
...
` + E);
          ...
          D && (A ? A = D + A + `
` + k : A = D + k), b.print_newline(!1), A && (g.text = A, g.whitespace_before = "", g.newlines = 0, b.add_raw_token(g), b.print_newline(!0));
        }
      }, L.prototype._handle_tag_open = function(b, g, _, N, A) {
        var v = this._get_tag_open_token(g);
        if ((_.is_unformatted || _.is_content_unformatted) && !_.is_empty_element && g.type === c.TAG_OPEN && !v.is_start_tag ? (b.add_raw_token(g), v.start_tag_token = this._tag_stack.try_pop(v.tag_name)) : (b.traverse_whitespace(g), this._set_tag_position(b, g, v, _, N), v.is_inline_element || b.set_wrap_point(), b.print_token(g)), v.is_start_tag && this._is_wrap_attributes_force) {
          var S = 0, D;
          do
            D = A.peek(S), D.type === c.ATTRIBUTE && (v.attr_count += 1), S += 1;
          while (D.type !== c.EOF && D.type !== c.TAG_CLOSE);
        }
        return (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) && (v.alignment_size = g.text.length + 1), !v.tag_complete && !v.is_unformatted && (b.alignment_size = v.alignment_size), v;
      };
      var I = function(b, g) {
      ...
      L.prototype._get_tag_open_token = function(b) {
        ...
        if (_.is_empty_element || (_.is_end_tag ? _.start_tag_token = this._tag_stack.try_pop(_.tag_name) : (this._do_optional_end_element(_) && (_.is_inline_element || b.print_newline(!1)), this._tag_stack.record_tag(_), (_.tag_name === "script" || _.tag_name === "style") && !(_.is_unformatted || _.is_content_unformatted) && (_.custom_beautifier_name = p(_.tag_check, g)))), x(_.tag_check, this._options.extra_liners) && (b.print_newline(!1), b._output.just_added_blankline() || b.print_newline(!0)), _.is_empty_element) {
          ...
          _.tag_name === "!--" && A.type === c.TAG_CLOSE && N.is_end_tag && _.text.indexOf(`
`) === -1 || (_.is_inline_element || _.is_unformatted || b.print_newline(!1), this._calcluate_parent_multiline(b, _));
        } else if (_.is_end_tag) {
          var S = !1;
          S = _.start_tag_token && _.start_tag_token.multiline_content, S = S || !_.is_inline_element && !(N.is_inline_element || N.is_unformatted) && !(A.type === c.TAG_CLOSE && _.start_tag_token === N) && A.type !== "TK_CONTENT", (_.is_content_unformatted || _.is_unformatted) && (S = !1), S && b.print_newline(!1);
        } else
          _.indent_content = !_.custom_beautifier_name, _.tag_start_char === "<" && (_.tag_name === "html" ? _.indent_content = this._options.indent_inner_html : _.tag_name === "head" ? _.indent_content = this._options.indent_head_inner_html : _.tag_name === "body" && (_.indent_content = this._options.indent_body_inner_html)), !(_.is_inline_element || _.is_unformatted) && (A.type !== "TK_CONTENT" || _.is_content_unformatted) && b.print_newline(!1), this._calcluate_parent_multiline(b, _);
      ...
      var H = ["address", "article", "aside", "blockquote", "details", "div", "dl", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hr", "main", "menu", "nav", "ol", "p", "pre", "section", "table", "ul"], P = ["a", "audio", "del", "ins", "map", "noscript", "video"];
    ...
    function(r, s, a) {
      var l = a(9).Tokenizer, o = a(9).TOKEN, u = a(13).Directives, c = a(14).TemplatablePattern, d = a(12).Pattern, m = {
        ...
        RAW: o.RAW,
        EOF: o.EOF
      }, f = new u(/<\!--/, /-->/), w = function(p, x) {
        l.call(this, p, x), this._current_tag_name = "";
        var T = new c(this._input).read_options(this._options), y = new d(this._input);
        if (this.__patterns = {
          word: T.until(/[\n\r\t <]/),
      ...
      w.prototype = new l(), w.prototype._is_comment = function(p) {
        return !1;
        ...
        return p.type === m.TAG_CLOSE && x && ((p.text === ">" || p.text === "/>") && x.text[0] === "<" || p.text === "}}" && x.text[0] === "{" && x.text[1] === "{") || p.type === m.CONTROL_FLOW_CLOSE && p.text === "}" && x.text.endsWith("{");
        ...
        if (p === "<") {
          var L = this._input.peek(1);
          (L === "!" || L === "?") && (T = this.__patterns.conditional_comment.read(), T = T || this.__patterns.processing.read()), T && (x = this._create_token(m.COMMENT, T), x.directives = y);
        }
        return x;
      }, w.prototype._read_open = function(p, x) {
        var T = null, y = null;
        return (!x || x.type === m.CONTROL_FLOW_OPEN) && p === "<" && (T = this._input.next(), this._input.peek() === "/" && (T += this._input.next()), T += this.__patterns.element_name.read(), y = this._create_token(m.TAG_OPEN, T)), y;
      }, w.prototype._read_open_handlebars = function(p, x) {
        var T = null, y = null;
        return (!x || x.type === m.CONTROL_FLOW_OPEN) && this._options.indent_handlebars && p === "{" && this._input.peek(1) === "{" && (this._input.peek(2) === "!" ? (T = this.__patterns.handlebars_comment.read(), T = T || this.__patterns.handlebars.read(), y = this._create_token(m.COMMENT, T)) : (T = this.__patterns.handlebars_open.read(), y = this._create_token(m.TAG_OPEN, T))), y;
      }, w.prototype._read_control_flows = function(p, x) {
        var T = "", y = null;
        if (!this._options.templating.includes("angular") || !this._options.indent_handlebars)
          return y;
        if (p === "@") {
          if (T = this.__patterns.angular_control_flow_start.read(), T === "")
            return y;
        ...
        } else p === "}" && x && x.type === m.CONTROL_FLOW_OPEN && (T = this._input.next(), y = this._create_token(m.CONTROL_FLOW_CLOSE, T));
        return y;
      }, w.prototype._read_close = function(p, x) {
        var T = null, y = null;
        return x && x.type === m.TAG_OPEN && (x.text[0] === "<" && (p === ">" || p === "/" && this._input.peek(1) === ">") ? (T = this._input.next(), p === "/" && (T += this._input.next()), y = this._create_token(m.TAG_CLOSE, T)) : x.text[0] === "{" && p === "}" && this._input.peek(1) === "}" && (this._input.next(), this._input.next(), y = this._create_token(m.TAG_CLOSE, "}}"))), y;
        ...
        if (T && T.text[0] === "<")
          if (p === "=")
            ...
            p === '"' ? I += this.__patterns.double_quote.read() : I += this.__patterns.single_quote.read(), y = this._create_token(m.VALUE, I);
          } else
            L = this.__patterns.attribute.read(), L && (x.type === m.EQUALS ? y = this._create_token(m.VALUE, L) : y = this._create_token(m.ATTRIBUTE, L));
        return y;
        ...
        var T = "";
        if (this._options.unformatted_content_delimiter && p === this._options.unformatted_content_delimiter[0] && (T = this.__patterns.unformatted_content_delimiter.read()), T || (T = x && x.type === m.CONTROL_FLOW_OPEN ? this.__patterns.word_control_flow_close_excluded.read() : this.__patterns.word.read()), T)
          return this._create_token(m.TEXT, T);
      }, r.exports.Tokenizer = w, r.exports.TOKEN = m;
    }
    /******/
  ], t = {};
  function n(r) {
...
function Bc(e, t, n) {
  ...
  if (t) {
    ...
    for (; m < i.length && Aa(i, m); )
      m++;
    (m === i.length || Sa(i, m)) && (d = m), t = J.create(e.positionAt(u), e.positionAt(d));
  ...
  const l = {
    ...
    unformatted: In(n, "unformatted", void 0),
    content_unformatted: In(n, "contentUnformatted", void 0),
    ...
    extra_liners: In(n, "extraLiners", void 0),
...
`,
  ...
  let o = Fc(qc(i), l);
  if (s > 0) {
    const u = n.insertSpaces ? xa(" ", a * s) : xa("	", s);
    o = o.split(`
`).join(`
...
(() => {
  var e = { 470: (r) => {
    ...
    var l = { resolve: function() {
      ...
      if (s(o), o.length === 0) return ".";
      for (var u = o.charCodeAt(0), c = u === 47, d = -1, m = !0, f = o.length - 1; f >= 1; --f) if ((u = o.charCodeAt(f)) === 47) {
        if (!m) {
          d = f;
          break;
        }
      ...
      m ? (u.root = "/", c = 1) : c = 0;
      for (var f = -1, w = 0, p = -1, x = !0, T = o.length - 1, y = 0; T >= c; --T) if ((d = o.charCodeAt(T)) !== 47) p === -1 && (x = !1, p = T + 1), d === 46 ? f === -1 ? f = T : y !== 1 && (y = 1) : f !== -1 && (y = -1);
      else if (!x) {
        w = T + 1;
        break;
      }
      return f === -1 || p === -1 || y === 0 || y === 1 && f === p - 1 && f === w + 1 ? p !== -1 && (u.base = u.name = w === 0 && m ? o.slice(1, p) : o.slice(w, p)) : (w === 0 && m ? (u.name = o.slice(1, f), u.base = o.slice(1, p)) : (u.name = o.slice(w, f), u.base = o.slice(w, p)), u.ext = o.slice(f, p)), w > 0 ? u.dir = o.slice(0, w - 1) : m && (u.dir = "/"), u;
  ...
  (() => {
    let r;
    n.r(i), n.d(i, { URI: () => m, Utils: () => N }), typeof process == "object" ? r = process.platform === "win32" : typeof navigator == "object" && (r = navigator.userAgent.indexOf("Windows") >= 0);
    const s = /^\w[\w\d+.-]*$/, a = /^\//, l = /^\/\//;
    function o(A, v) {
      if (!A.scheme && v) throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${A.authority}", path: "${A.path}", query: "${A.query}", fragment: "${A.fragment}"}`);
      if (A.scheme && !s.test(A.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
      if (A.path) {
        if (A.authority) {
          if (!a.test(A.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
        } else if (l.test(A.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")');
      }
    }
    const u = "", c = "/", d = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
    class m {
      constructor(v, S, D, k, E, M = !1) {
        qe(this, "scheme");
        qe(this, "authority");
        qe(this, "path");
        qe(this, "query");
        qe(this, "fragment");
        typeof v == "object" ? (this.scheme = v.scheme || u, this.authority = v.authority || u, this.path = v.path || u, this.query = v.query || u, this.fragment = v.fragment || u) : (this.scheme = /* @__PURE__ */ function(W, F) {
          return W || F ? W : "file";
        }(v, M), this.authority = S || u, this.path = function(W, F) {
          switch (W) {
            case "https":
            case "http":
            case "file":
          ...
          return F;
        }(this.scheme, D || u), this.query = k || u, this.fragment = E || u, o(this, M));
      }
      static isUri(v) {
      ...
      with(v) {
        if (!v) return this;
        let { scheme: S, authority: D, path: k, query: E, fragment: M } = v;
        return S === void 0 ? S = this.scheme : S === null && (S = u), D === void 0 ? D = this.authority : D === null && (D = u), k === void 0 ? k = this.path : k === null && (k = u), E === void 0 ? E = this.query : E === null && (E = u), M === void 0 ? M = this.fragment : M === null && (M = u), S === this.scheme && D === this.authority && k === this.path && E === this.query && M === this.fragment ? this : new w(S, D, k, E, M);
      }
      static parse(v, S = !1) {
        const D = d.exec(v);
        return D ? new w(D[2] || u, P(D[4] || u), P(D[5] || u), P(D[7] || u), P(D[9] || u), S) : new w(u, u, u, u, u);
      }
      static file(v) {
        let S = u;
        if (r && (v = v.replace(/\\/g, c)), v[0] === c && v[1] === c) {
          const D = v.indexOf(c, 2);
          D === -1 ? (S = v.substring(2), v = c) : (S = v.substring(2, D), v = v.substring(D) || c);
        }
        return new w("file", S, v, u, u);
      }
      static from(v) {
        const S = new w(v.scheme, v.authority, v.path, v.query, v.fragment);
        return o(S, !0), S;
      }
      toString(v = !1) {
        return L(this, v);
      ...
      static revive(v) {
        if (v) {
          ...
          {
            const S = new w(v);
            return S._formatted = v.external, S._fsPath = v._sep === f ? v.fsPath : null, S;
          }
        }
        return v;
      }
    ...
    class w extends m {
      ...
      toString(S = !1) {
        return S ? L(this, !0) : (this._formatted || (this._formatted = L(this, !1)), this._formatted);
      }
      toJSON() {
        const S = { $mid: 1 };
    ...
    function x(A, v, S) {
      ...
      for (let E = 0; E < A.length; E++) {
        const M = A.charCodeAt(E);
        if (M >= 97 && M <= 122 || M >= 65 && M <= 90 || M >= 48 && M <= 57 || M === 45 || M === 46 || M === 95 || M === 126 || v && M === 47 || S && M === 91 || S && M === 93 || S && M === 58) k !== -1 && (D += encodeURIComponent(A.substring(k, E)), k = -1), D !== void 0 && (D += A.charAt(E));
        else {
          D === void 0 && (D = A.substr(0, E));
          const W = p[M];
          W !== void 0 ? (k !== -1 && (D += encodeURIComponent(A.substring(k, E)), k = -1), D += W) : k === -1 && (k = E);
        }
      }
      return k !== -1 && (D += encodeURIComponent(A.substring(k))), D !== void 0 ? D : A;
    }
    function T(A) {
      let v;
      for (let S = 0; S < A.length; S++) {
        const D = A.charCodeAt(S);
        D === 35 || D === 63 ? (v === void 0 && (v = A.substr(0, S)), v += p[D]) : v !== void 0 && (v += A[S]);
      }
      return v !== void 0 ? v : A;
    }
    function y(A, v) {
      let S;
      return S = A.authority && A.path.length > 1 && A.scheme === "file" ? `//${A.authority}${A.path}` : A.path.charCodeAt(0) === 47 && (A.path.charCodeAt(1) >= 65 && A.path.charCodeAt(1) <= 90 || A.path.charCodeAt(1) >= 97 && A.path.charCodeAt(1) <= 122) && A.path.charCodeAt(2) === 58 ? A.path[1].toLowerCase() + A.path.substr(2) : A.path, r && (S = S.replace(/\//g, "\\")), S;
    }
    function L(A, v) {
      const S = v ? T : x;
      let D = "", { scheme: k, authority: E, path: M, query: W, fragment: F } = A;
      if (k && (D += k, D += ":"), (E || k === "file") && (D += c, D += c), E) {
        let U = E.indexOf("@");
        if (U !== -1) {
          const O = E.substr(0, U);
          E = E.substr(U + 1), U = O.lastIndexOf(":"), U === -1 ? D += S(O, !1, !1) : (D += S(O.substr(0, U), !1, !1), D += ":", D += S(O.substr(U + 1), !1, !0)), D += "@";
        }
        E = E.toLowerCase(), U = E.lastIndexOf(":"), U === -1 ? D += S(E, !1, !0) : (D += S(E.substr(0, U), !1, !0), D += E.substr(U));
      }
      if (M) {
      ...
      return W && (D += "?", D += S(W, !1, !1)), F && (D += "#", D += v ? F : x(F, !1, !1)), D;
    }
    function I(A) {
      try {
    ...
    function P(A) {
      return A.match(H) ? A.replace(H, (v) => I(v)) : A;
    }
    var b = n(470);
    const g = b.posix || b, _ = "/";
    var N;
    (function(A) {
      A.joinPath = function(v, ...S) {
        return v.with({ path: g.join(v.path, ...S) });
      }, A.resolvePath = function(v, ...S) {
        let D = v.path, k = !1;
        D[0] !== _ && (D = _ + D, k = !0);
        let E = g.resolve(D, ...S);
        return k && E[0] === _ && !v.authority && (E = E.substring(1)), v.with({ path: E });
      }, A.dirname = function(v) {
        if (v.path.length === 0 || v.path === _) return v;
        let S = g.dirname(v.path);
        return S.length === 1 && S.charCodeAt(0) === 46 && (S = ""), v.with({ path: S });
      }, A.basename = function(v) {
        return g.basename(v.path);
      }, A.extname = function(v) {
        return g.extname(v.path);
      };
    })(N || (N = {}));
  })(), ro = i;
})();
const { URI: jc, Utils: bh } = ro;
function Ai(e) {
...
function Gc(e, t, n, i) {
  ...
  return /^\#/i.test(t) ? e + t : /^\/\//i.test(t) ? (Ge(e, "https://") ? "https" : "http") + ":" + t.replace(/^\s*/g, "") : n ? n.resolveReference(t, i || e) : t;
}
function Xc(e, t, n, i, r, s) {
  const a = Ai(n);
  if (!$c(a, e.languageId))
    return;
  a.length < n.length && (i++, r--);
  const l = Gc(e.uri, a, t, s);
  if (!l)
    return;
  const o = Qc(l, e);
  return {
...
function Qc(e, t) {
  try {
    ...
    return n.scheme === "file" && n.query && (n = n.with({ query: null }), e = n.toString(
      /* skipEncodig*/
      !0
    )), n.scheme === "file" && n.fragment && !(e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === Jc) ? n.with({ fragment: null }).toString(
      /* skipEncodig*/
      !0
    ) : e;
  } catch {
...
class Yc {
  ...
  findDocumentLinks(t, n) {
    const i = [], r = _e(t.getText(), 0);
    let s = r.scan(), a, l, o = !1, u;
    const c = {};
    for (; s !== z.EOS; ) {
      switch (s) {
        case z.StartTag:
        ...
        case z.AttributeValue:
          if (l && a && this.dataManager.isPathAttribute(l, a)) {
            ...
            if (!o) {
              const m = Xc(t, n, d, r.getTokenOffset(), r.getTokenEnd(), u);
              m && i.push(m);
            }
            o && typeof u > "u" && (u = Ai(d), u && n && (u = n.resolveReference(u, t.uri))), o = !1, a = void 0;
          } else if (a === "id") {
            const d = Ai(r.getTokenText());
    ...
    for (const d of i) {
      ...
      if (d.target && Ge(d.target, m)) {
        const f = d.target.substring(m.length), w = c[f];
        if (w !== void 0) {
...
function Zc(e, t, n) {
  ...
  if (!r.tag)
    return [];
  const s = [], a = Ea(z.StartTag, e, r.start), l = typeof r.endTagStart == "number" && Ea(z.EndTag, e, r.endTagStart);
  return (a && Ca(a, t) || l && Ca(l, t)) && (a && s.push({ kind: pn.Read, range: a }), l && s.push({ kind: pn.Read, range: l })), s;
}
function La(e, t) {
...
function Kc(e, t) {
  ...
  return n;
  function r(s, a) {
    const l = _i.create(s.name, s.kind, s.range, e.uri, a == null ? void 0 : a.name);
...
function ao(e, t, n) {
  const i = eh(t), r = J.create(e.positionAt(t.start), e.positionAt(t.end)), s = vi.create(i, void 0, wi.Field, r, r);
  n.push(s), t.children.forEach((a) => {
    s.children ?? (s.children = []), ao(e, a, s.children);
  });
}
function eh(e) {
  let t = e.tag;
...
class rh {
  ...
  limitRanges(t, n) {
    ...
    for (let d = 0; d < t.length; d++) {
      ...
      if (!i)
        ...
        if (m.endLine <= i.endLine)
          r.push(i), i = m, l(d, r.length);
  ...
  getFoldingRanges(t, n) {
    const i = this.dataManager.getVoidElements(t.languageId), r = _e(t.getText());
    let s = r.scan();
    const a = [], l = [];
    let o = null, u = -1;
    function c(m) {
    ...
    for (; s !== z.EOS; ) {
      switch (s) {
        case z.StartTag: {
          const m = r.getTokenText(), f = t.positionAt(r.getTokenOffset()).line;
        ...
        case z.StartTagClose:
          if (!o || !this.dataManager.isVoidElement(o, i))
            break;
        case z.EndTagClose:
        case z.StartTagSelfClose: {
          let m = l.length - 1;
          for (; m >= 0 && l[m].tagName !== o; )
            m--;
          if (m >= 0) {
            const f = l[m];
            l.length = m;
            const w = t.positionAt(r.getTokenOffset()).line, p = f.startLine, x = w - 1;
        ...
        case z.Comment: {
          ...
          if (w)
            if (w[1])
              l.push({ startLine: m, tagName: "" });
            else {
              let p = l.length - 1;
              for (; p >= 0 && l[p].tagName.length; )
                p--;
              if (p >= 0) {
                const x = l[p];
                l.length = p;
                const T = m;
                m = x.startLine, T > m && u !== m && c({ startLine: m, endLine: T, kind: dn.Region });
              }
            }
          else {
            const p = t.positionAt(r.getTokenOffset() + r.getTokenLength()).line;
            m < p && c({ startLine: m, endLine: p, kind: dn.Comment });
          }
          break;
        }
      }
...
class sh {
  ...
  getSelectionRange(t, n, i) {
    ...
    for (let l = r.length - 1; l >= 0; l--) {
      const o = r[l];
      (!s || o[0] !== s[0] || o[1] !== s[1]) && (a = bn.create(J.create(n.positionAt(r[l][0]), n.positionAt(r[l][1])), a)), s = o;
    }
    return a || (a = bn.create(J.create(t, t))), a;
  }
  getApplicableRanges(t, n, i) {
    const r = t.offsetAt(n), s = i.findNodeAt(r);
    let a = this.getAllParentTagRanges(s);
    if (s.startTagEnd && !s.endTagStart) {
      if (s.startTagEnd !== s.end)
        return [[s.start, s.end]];
      const l = J.create(t.positionAt(s.startTagEnd - 2), t.positionAt(s.startTagEnd));
      return t.getText(l) === "/>" ? a.unshift([s.start + 1, s.startTagEnd - 2]) : a.unshift([s.start + 1, s.startTagEnd - 1]), a = this.getAttributeLevelRanges(t, s, r).concat(a), a;
    }
    return !s.startTagEnd || !s.endTagStart ? a : (a.unshift([s.start, s.end]), s.start < r && r < s.startTagEnd ? (a.unshift([s.start + 1, s.startTagEnd - 1]), a = this.getAttributeLevelRanges(t, s, r).concat(a), a) : s.startTagEnd <= r && r <= s.endTagStart ? (a.unshift([s.startTagEnd, s.endTagStart]), a) : (r >= s.endTagStart + 2 && a.unshift([s.endTagStart + 2, s.end - 1]), a));
  }
  getAllParentTagRanges(t) {
    let n = t;
    const i = [];
    for (; n.parent; )
      n = n.parent, this.getNodeRanges(n).forEach((r) => i.push(r));
    return i;
  }
  getNodeRanges(t) {
  ...
  getAttributeLevelRanges(t, n, i) {
    const r = J.create(t.positionAt(n.start), t.positionAt(n.end)), s = t.getText(r), a = i - n.start, l = _e(s);
    let o = l.scan();
    const u = n.start, c = [];
    let d = !1, m = -1;
    for (; o !== z.EOS; ) {
      switch (o) {
        ...
        case z.AttributeValue: {
          ...
          a >= l.getTokenOffset() && a <= l.getTokenEnd() && (c.unshift([l.getTokenOffset(), l.getTokenEnd()]), (f[0] === '"' && f[f.length - 1] === '"' || f[0] === "'" && f[f.length - 1] === "'") && a >= l.getTokenOffset() + 1 && a <= l.getTokenEnd() - 1 && c.unshift([l.getTokenOffset() + 1, l.getTokenEnd() - 1]), c.push([m, l.getTokenEnd()]));
          break;
        }
      }
      o = l.scan();
...
class oh {
  ...
  setDataProviders(t, n) {
    this.dataProviders = [], t && this.dataProviders.push(new to("html5", ah)), this.dataProviders.push(...n);
  }
  getDataProviders() {
    return this.dataProviders;
  }
  isVoidElement(t, n) {
    return !!t && pc(n, t.toLowerCase(), (i, r) => i.localeCompare(r)) >= 0;
  }
  getVoidElements(t) {
    const n = Array.isArray(t) ? t : this.getDataProviders().filter((r) => r.isApplicable(t)), i = [];
    return n.forEach((r) => {
      r.provideTags().filter((s) => s.void).forEach((s) => i.push(s.name));
    }), i.sort();
  }
  isPathAttribute(t, n) {
    if (n === "src" || n === "href")
...
function ch(e = uh) {
  const t = new oh(e), n = new Hc(e, t), i = new Mc(e, t), r = new gc(t), s = new sh(r), a = new rh(t), l = new Yc(t);
  return {
    ...
    format: Bc,
    findDocumentHighlights: Zc,
    findDocumentLinks: l.findDocumentLinks.bind(l),
    findDocumentSymbols: Kc,
    findDocumentSymbols2: so,
    ...
    doRename: th,
    findMatchingTagPosition: ih,
    findOnTypeRenameRanges: Ra,
    findLinkedEditingRanges: Ra
  };
}
function hh(e, t) {
  return new to(e, t);
...
class dh {
  constructor(t, n) {
    ...
    const i = this._languageSettings.data, r = i == null ? void 0 : i.useDefaultDataProvider, s = [];
    if (i != null && i.dataProviders)
      for (const a in i.dataProviders)
        s.push(hh(a, i.dataProviders[a]));
    this._languageService = ch({
      useDefaultDataProvider: r,
      customDataProviders: s
    });
  }
  ...
  async format(t, n, i) {
    ...
    if (!r)
      return [];
    let s = { ...this._languageSettings.format, ...i }, a = this._languageService.format(r, n, s);
  ...
  async doHover(t, n) {
    ...
    if (!i)
      return null;
    let r = this._languageService.parseHTMLDocument(i), s = this._languageService.doHover(i, n, r);
  ...
  async findDocumentHighlights(t, n) {
    ...
    if (!i)
      return [];
    let r = this._languageService.parseHTMLDocument(i), s = this._languageService.findDocumentHighlights(i, n, r);
    return Promise.resolve(s);
  }
  async findDocumentLinks(t) {
    ...
    if (!n)
      return [];
    let i = this._languageService.findDocumentLinks(
      n,
      null
      /*TODO@aeschli*/
    );
  ...
  async findDocumentSymbols(t) {
    ...
    if (!n)
      return [];
    let i = this._languageService.parseHTMLDocument(n), r = this._languageService.findDocumentSymbols(n, i);
  ...
  async doRename(t, n, i) {
    ...
    if (!r)
      return null;
    let s = this._languageService.parseHTMLDocument(r), a = this._languageService.doRename(r, n, i, s);
    return Promise.resolve(a);
  }
  _getTextDocument(t) {
