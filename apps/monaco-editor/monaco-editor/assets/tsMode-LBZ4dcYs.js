import { c as M, e as w, U as F, a as P, M as v, l as f, t as K, R as O } from "./main-39xG571D.js";
class E {
  constructor(e, t) {
  ...
  _getClient() {
    return this._client || (this._client = (async () => (this._worker = M({
      ...
      createWorker: () => new Worker(new URL(
        /* @vite-ignore */
        "" + new URL("ts.worker-e_Z46U6z.js", import.meta.url).href,
        import.meta.url
      ), { type: "module" }),
      label: this._modeId,
      keepIdleModels: !0,
