import { c as z, l as _, e as B } from "./main-39xG571D.js";
import { f as P, g as J, C as Q, H as Y, b as G, d as X, F as Z, S as $, e as K } from "./lspLanguageFeatures-CHW-g27O.js";
import { a as Ae, D as Oe, h as Ie, R as Le, c as Ne, i as Ee, j as Ue, t as De, k as Be } from "./lspLanguageFeatures-CHW-g27O.js";
const x = 2 * 60 * 1e3;
class C {
  constructor(i) {
  ...
  _getClient() {
    return this._lastUsedTime = Date.now(), this._client || (this._worker = z({
      ...
      createWorker: () => new Worker(new URL(
        /* @vite-ignore */
        "" + new URL("json.worker-Cqy7y-6d.js", import.meta.url).href,
        import.meta.url
      ), { type: "module" }),
...
function be(e) {
  ...
  function u() {
    ...
    q(t), o.documentFormattingEdits && t.push(
...
export {
  ...
  P as DocumentFormattingEditProvider,
