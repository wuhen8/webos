...
const Qt = "Canceled";
function Xs(e) {
  return e instanceof Ss ? !0 : e instanceof Error && e.name === Qt && e.message === Qt;
}
...
class Z extends Error {
  constructor(t) {
    super(t || "An unexpected bug occurred."), Object.setPrototypeOf(this, Z.prototype);
  }
}
function Qs(e, t = "Unreachable") {
  throw new Error(t);
}
function Js(e, t = "unexpected state") {
  if (!e)
    throw typeof t == "string" ? new Z(`Assertion Failed: ${t}`) : t;
}
function At(e) {
  if (!e()) {
    debugger;
    e(), Lt(new Z("Assertion Failed"));
  }
}
function As(e, t) {
  let n = 0;
...
(function(e) {
  ...
  e.length = N;
  function* v(x, p, R = x.length) {
    for (p < -x.length && (p = 0), p < 0 && (p += x.length), R < 0 ? R += x.length : R > x.length && (R = x.length); p < R; p++)
      yield x[p];
  }
  e.slice = v;
  function C(x, p = Number.POSITIVE_INFINITY) {
    const R = [];
    if (p === 0)
      return [R, x];
    const D = x[Symbol.iterator]();
    for (let I = 0; I < p; I++) {
      const _ = D.next();
      if (_.done)
        return [R, e.empty()];
...
const Dt = class Dt {
  ...
  add(t) {
    ...
    return this._isDisposed ? Dt.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t;
  }
  /**
...
yn.None = Object.freeze({ dispose() {
} });
let De = yn;
const ze = class ze {
  constructor(t) {
    this.element = t, this.next = ze.Undefined, this.prev = ze.Undefined;
  }
};
...
const ni = globalThis.performance.now.bind(globalThis.performance);
class Ut {
  static create(t) {
    return new Ut(t);
  }
  constructor(t) {
    this._now = t === !1 ? Date.now : ni, this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(_) {
    return (A, k = null, y) => {
      ...
      return q = _((W) => {
        if (!F)
          return q ? q.dispose() : F = !0, A.call(k, W);
      }, null, y), F && q.dispose(), q;
    };
  }
  e.once = n;
  function r(_, A) {
    return e.once(e.filter(_, A));
  }
  e.onceIf = r;
  function s(_, A, k) {
    return h((y, F = null, q) => _((W) => y.call(F, A(W)), null, q), k);
  }
  e.map = s;
  function i(_, A, k) {
    return h((y, F = null, q) => _((W) => {
      A(W), y.call(F, W);
    }, null, q), k);
  }
  e.forEach = i;
  function l(_, A, k) {
    return h((y, F = null, q) => _((W) => A(W) && y.call(F, W), null, q), k);
  }
  e.filter = l;
  function o(_) {
    return _;
  ...
  function u(..._) {
    return (A, k = null, y) => {
      const F = Ks(..._.map((q) => q((W) => A.call(k, W))));
      return f(F, y);
    };
  }
  e.any = u;
  ...
  function d(_, A, k = 100, y = !1, F = !1, q, W) {
    let Q, K, ye, bt = 0, Ce;
    const Ws = {
      leakWarningThreshold: q,
      onWillAddFirstListener() {
        Q = _((zs) => {
          bt++, K = A(K, zs), y && !ye && (wt.fire(K), K = void 0), Ce = () => {
            const Gs = K;
            K = void 0, ye = void 0, (!y || bt > 1) && wt.fire(Gs), bt = 0;
          }, typeof k == "number" ? (ye && clearTimeout(ye), ye = setTimeout(Ce, k)) : ye === void 0 && (ye = null, queueMicrotask(Ce));
        });
      },
    ...
    return W == null || W.add(wt), wt.event;
  }
  e.debounce = d;
  function w(_, A = 0, k) {
    return e.debounce(_, (y, F) => y ? (y.push(F), y) : [F], A, void 0, !0, void 0, k);
  }
  e.accumulate = w;
  function g(_, A = (y, F) => y === F, k) {
    let y = !0, F;
    return l(_, (q) => {
      const W = y || !A(q, F);
      return y = !1, F = q, W;
  ...
  e.split = m;
  function L(_, A = !1, k = [], y) {
    let F = k.slice(), q = _((K) => {
      F ? F.push(K) : Q.fire(K);
    });
    y && y.add(q);
    const W = () => {
      F == null || F.forEach((K) => Q.fire(K)), F = null;
    }, Q = new me({
      onWillAddFirstListener() {
        q || (q = _((K) => Q.fire(K)), y && y.add(q));
      },
  ...
  class v {
    ...
    filter(A) {
      return this.steps.push((k) => A(k) ? k : N), this;
    }
    reduce(A, k) {
      let y = k;
      return this.steps.push((F) => (y = A(y, F), y)), this;
    }
    latch(A = (k, y) => k === y) {
      let k = !0, y;
      return this.steps.push((F) => {
        const q = k || !A(F, y);
        return k = !1, y = F, q ? F : N;
      }), this;
    }
    evaluate(A) {
  ...
  function C(_, A, k = (y) => y) {
    const y = (...Q) => W.fire(k(...Q)), F = () => _.on(A, y), q = () => _.removeListener(A, y), W = new me({ onWillAddFirstListener: F, onDidRemoveLastListener: q });
    return W.event;
  }
  e.fromNodeEventEmitter = C;
  function P(_, A, k = (y) => y) {
    const y = (...Q) => W.fire(k(...Q)), F = () => _.addEventListener(A, y), q = () => _.removeEventListener(A, y), W = new me({ onWillAddFirstListener: F, onDidRemoveLastListener: q });
    return W.event;
  }
  e.fromDOMEventEmitter = P;
  function V(_, A) {
    let k;
    const y = new Promise((F, q) => {
      const W = n(_)(F, null, A);
      k = () => W.dispose();
    });
    return y.cancel = k, y;
  }
  ...
  class R {
    constructor(A, k) {
      ...
      this.emitter = new me(y), k && k.add(this.emitter);
    }
    beginUpdate(A) {
      this._counter++;
    }
  ...
  function D(_, A) {
    return new R(_, A).emitter.event;
  }
  e.fromObservable = D;
  function I(_) {
    return (A, k, y) => {
      ...
      const W = {
        ...
        endUpdate() {
          F--, F === 0 && (_.reportChanges(), q && (q = !1, A.call(k)));
        },
      ...
      return y instanceof ht ? y.add(Q) : Array.isArray(y) && y.push(Q), Q;
    };
  }
...
const Ge = class Ge {
  constructor(t) {
    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${Ge._idPool++}`, Ge.all.add(this);
  }
  start(t) {
    this._stopWatch = new Ut(), this.listenerCount = t;
  }
  stop() {
    if (this._stopWatch) {
...
Ge.all = /* @__PURE__ */ new Set(), Ge._idPool = 0;
let Yt = Ge, ri = -1;
const Vt = class Vt {
  constructor(t, n, r = (Vt._idPool++).toString(16).padStart(3, "0")) {
...
class me {
  constructor(t) {
    var n, r, s, i;
    this._size = 0, this._options = t, this._leakageMon = (n = this._options) != null && n.leakWarningThreshold ? new Zt((t == null ? void 0 : t.onListenerError) ?? Lt, ((r = this._options) == null ? void 0 : r.leakWarningThreshold) ?? ri) : void 0, this._perfMon = (s = this._options) != null && s._profName ? new Yt(this._options._profName) : void 0, this._deliveryQueue = (i = this._options) == null ? void 0 : i.deliveryQueue;
  }
  dispose() {
    var t, n, r, s;
    this._disposed || (this._disposed = !0, ((t = this._deliveryQueue) == null ? void 0 : t.current) === this && this._deliveryQueue.reset(), this._listeners && (this._listeners = void 0, this._size = 0), (r = (n = this._options) == null ? void 0 : n.onDidRemoveLastListener) == null || r.call(n), (s = this._leakageMon) == null || s.dispose());
  }
  /**
  ...
  get event() {
    return this._event ?? (this._event = (t, n, r) => {
      ...
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(g);
        const m = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], L = new ii(`${g}. HINT: Stack shows most frequent listener (${m[1]}-times)`, m[0]);
        return (((o = this._options) == null ? void 0 : o.onListenerError) || Lt)(L), De.None;
      }
      if (this._disposed)
        return De.None;
      n && (t = t.bind(n));
      const s = new $t(t);
      let i;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (s.stack = vn.create(), i = this._leakageMon.check(s.stack, this._size + 1)), this._listeners ? this._listeners instanceof $t ? (this._deliveryQueue ?? (this._deliveryQueue = new li()), this._listeners = [this._listeners, s]) : this._listeners.push(s) : ((c = (u = this._options) == null ? void 0 : u.onWillAddFirstListener) == null || c.call(u, this), this._listeners = s, (f = (h = this._options) == null ? void 0 : h.onDidAddFirstListener) == null || f.call(h, this)), (w = (d = this._options) == null ? void 0 : d.onDidAddListener) == null || w.call(d, this), this._size++;
      const l = yt(() => {
  ...
  _removeListener(t) {
    ...
    if (this._size * ai <= n.length) {
      let c = 0;
      for (let h = 0; h < n.length; h++)
        n[h] ? n[c++] = n[h] : s && c < this._deliveryQueue.end && (this._deliveryQueue.end--, c < this._deliveryQueue.i && this._deliveryQueue.i--);
      n.length = c;
    }
  }
  _deliver(t, n) {
    ...
    if (!t)
      return;
    const r = ((s = this._options) == null ? void 0 : s.onListenerError) || Lt;
    if (!r) {
      t.value(n);
      return;
    }
  ...
  fire(t) {
    var n, r, s, i;
    if ((n = this._deliveryQueue) != null && n.current && (this._deliverQueue(this._deliveryQueue), (r = this._perfMon) == null || r.stop()), (s = this._perfMon) == null || s.start(this._size), this._listeners) if (this._listeners instanceof $t)
...
const ui = ys() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function En(e, t) {
  let n;
  ...
  }), ui && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function T(e, t, ...n) {
  return En(typeof e == "number" ? ci(e, t) : t, n);
}
function ci(e, t) {
  var r;
  const n = (r = oi()) == null ? void 0 : r[e];
  if (typeof n != "string") {
    if (typeof t == "string")
      return t;
...
const He = "en";
let Kt = !1, en = !1, Ht = !1, xt, Wt = He, kn = He, hi, ce;
const Pe = globalThis;
let Y;
var _s;
typeof Pe.vscode < "u" && typeof Pe.vscode.process < "u" ? Y = Pe.vscode.process : typeof process < "u" && typeof ((_s = process == null ? void 0 : process.versions) == null ? void 0 : _s.node) == "string" && (Y = process);
var Ls;
const fi = typeof ((Ls = Y == null ? void 0 : Y.versions) == null ? void 0 : Ls.electron) == "string", di = fi && (Y == null ? void 0 : Y.type) === "renderer";
var vs;
if (typeof Y == "object") {
  Kt = Y.platform === "win32", en = Y.platform === "darwin", Ht = Y.platform === "linux", Ht && Y.env.SNAP && Y.env.SNAP_REVISION, Y.env.CI || Y.env.BUILD_ARTIFACTSTAGINGDIRECTORY || Y.env.GITHUB_WORKSPACE, xt = He, Wt = He;
  const e = Y.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      xt = t.userLocale, kn = t.osLocale, Wt = t.resolvedLanguage || He, hi = (vs = t.languagePack) == null ? void 0 : vs.translationsConfigFile;
    } catch {
    }
} else typeof navigator == "object" && !di ? (ce = navigator.userAgent, Kt = ce.indexOf("Windows") >= 0, en = ce.indexOf("Macintosh") >= 0, (ce.indexOf("Macintosh") >= 0 || ce.indexOf("iPad") >= 0 || ce.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Ht = ce.indexOf("Linux") >= 0, (ce == null ? void 0 : ce.indexOf("Mobi")) >= 0, Wt = ys() || He, xt = navigator.language.toLowerCase(), kn = xt) : console.error("Unable to resolve platform.");
const ft = Kt, mi = en, be = ce, gi = typeof Pe.postMessage == "function" && !Pe.importScripts;
(() => {
  if (gi) {
    const e = [];
    ...
    return (n) => {
      ...
      e.push({
        id: r,
        callback: n
      }), Pe.postMessage({ vscodeScheduleAsyncWork: r }, "*");
    };
  }
  return (e) => setTimeout(e);
})();
const bi = !!(be && be.indexOf("Chrome") >= 0);
be && be.indexOf("Firefox") >= 0;
!bi && be && be.indexOf("Safari") >= 0;
be && be.indexOf("Edg/") >= 0;
...
class xi {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = wi) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
class tn {
  constructor(t) {
    this.executor = t, this._state = Ee.Uninitialized;
  }
  /**
...
de.ambiguousCharacterData = new tn(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,1523,96,8242,96,1370,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,118002,50,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,118003,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,118004,52,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,118005,53,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,118006,54,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,118007,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,118008,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,118009,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,117974,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,117975,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71913,67,71922,67,65315,67,8557,67,8450,67,8493,67,117976,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,117977,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,117978,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,117979,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,117980,71,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,117981,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,117983,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,117984,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,118001,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,117982,108,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,117985,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,117986,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,117987,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,118000,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,117988,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,117989,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,117990,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,117991,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,117992,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,117993,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,117994,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,117995,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71910,87,71919,87,117996,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,117997,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,117998,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,71909,90,66293,90,65338,90,8484,90,8488,90,117999,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65283,35,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"cs":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"es":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"fr":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"it":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ja":[8211,45,8218,44,65281,33,8216,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65292,44,65297,49,65307,59],"ko":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pt-BR":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ru":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"zh-hans":[160,32,65374,126,8218,44,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65297,49],"zh-hant":[8211,45,65374,126,8218,44,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89]}')), de.cache = new xi({ getCacheKey: JSON.stringify }, (t) => {
  ...
  const i = de.ambiguousCharacterData.value;
  let l = t.filter((h) => !h.startsWith("_") && Object.hasOwn(i, h));
  ...
  return new de(c);
}), de._locales = new tn(() => Object.keys(de.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
let dt = de;
const je = class je {
  static getRawData() {
  ...
  static getData() {
    return this._data || (this._data = new Set([...Object.values(je.getRawData())].flat())), this._data;
  }
...
je._data = void 0;
let it = je;
const zt = "default", Mi = "$initialize";
class Pi {
...
class Vi {
  ...
  async sendMessage(t, n, r) {
    ...
    return new Promise((i, l) => {
      this._pendingReplies[s] = {
        resolve: i,
        reject: l
      }, this._send(new Pi(this._workerId, s, t, n, r));
    });
  }
  listen(t, n, r) {
    let s = null;
    const i = new me({
      onWillAddFirstListener: () => {
        s = String(++this._lastSentReq), this._pendingEmitters.set(s, i), this._send(new Fi(this._workerId, s, t, n, r));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(s), this._send(new Di(this._workerId, s)), s = null;
      }
    });
    return i.event;
  }
  ...
  createProxyToRemoteChannel(t, n) {
    const r = {
      get: (s, i) => (typeof i == "string" && !s[i] && (ks(i) ? s[i] = (l) => this.listen(t, i, l) : Es(i) ? s[i] = this.listen(t, i, void 0) : i.charCodeAt(0) === 36 && (s[i] = async (...l) => (await (n == null ? void 0 : n()), this.sendMessage(t, i, l)))), s[i])
    };
  ...
  _handleReplyMessage(t) {
    ...
    if (delete this._pendingReplies[t.seq], t.err) {
      ...
      if (t.err.$isError) {
        const s = new Error();
        s.name = t.err.name, s.message = t.err.message, s.stack = t.err.stack, r = s;
      }
      n.reject(r);
      return;
    }
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((s) => {
      this._send(new Mn(this._workerId, n, s, void 0));
    }, (s) => {
      s.detail instanceof Error && (s.detail = Xt(s.detail)), this._send(new Mn(this._workerId, n, void 0, Xt(s)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, r = this._handler.handleEvent(t.channel, t.eventName, t.arg)((s) => {
      this._send(new Ti(this._workerId, n, s));
    });
...
function Es(e) {
  return e[0] === "o" && e[1] === "n" && Cs(e.charCodeAt(2));
}
function ks(e) {
  return /^onDynamic/.test(e) && Cs(e.charCodeAt(9));
}
class Ii {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new Vi({
      sendMessage: (r, s) => {
        t(r, s);
      },
  ...
  _handleMessage(t, n, r) {
    ...
    const s = t === zt ? this.requestHandler : this._localChannels.get(t);
    if (!s)
...
function Bi(e) {
  ...
  Pn = !0;
  const t = new Ii((n) => globalThis.postMessage(n), (n) => e(n));
...
function Ui(e, t, n) {
  return new Se(new Tn(e), new Tn(t)).ComputeDiff(n).changes;
}
class Ve {
  static Assert(t, n) {
    if (!t)
...
class Se {
  ...
  constructor(t, n, r = null) {
    ...
    const [s, i, l] = Se._getElements(t), [o, u, c] = Se._getElements(n);
  ...
  ComputeDiffRecursive(t, n, r, s, i) {
    ...
    if (t > n || r > s) {
      let f;
      return r <= s ? (Ve.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), f = [
        new ve(t, 0, r, s - r + 1)
      ]) : t <= n ? (Ve.Assert(r === s + 1, "modifiedStart should only be one more than modifiedEnd"), f = [
        new ve(t, n - t + 1, r, 0)
      ]) : (Ve.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), Ve.Assert(r === s + 1, "modifiedStart should only be one more than modifiedEnd"), f = []), f;
    }
    ...
    if (!i[0]) {
      ...
      let d = [];
      return i[0] ? d = [
        new ve(c + 1, n - (c + 1) + 1, h + 1, s - (h + 1) + 1)
      ] : d = this.ComputeDiffRecursive(c + 1, n, h + 1, s, i), this.ConcatenateChanges(f, d);
    }
    return [
      new ve(t, n - t + 1, r, s - r + 1)
    ];
  }
  WALKTRACE(t, n, r, s, i, l, o, u, c, h, f, d, w, g, m, L, S, N) {
    let v = null, C = null, P = new Dn(), V = n, x = r, p = w[0] - L[0] - s, R = -1073741824, D = this.m_forwardHistory.length - 1;
    do {
      const I = p + t;
      I === V || I < x && c[I - 1] < c[I + 1] ? (f = c[I + 1], g = f - p - s, f < R && P.MarkNextChange(), R = f, P.AddModifiedElement(f + 1, g), p = I + 1 - t) : (f = c[I - 1] + 1, g = f - p - s, f < R && P.MarkNextChange(), R = f - 1, P.AddOriginalElement(f, g + 1), p = I - 1 - t), D >= 0 && (c = this.m_forwardHistory[D], t = c[0], V = 1, x = c.length - 1);
    } while (--D >= -1);
    if (v = P.getReverseChanges(), N[0]) {
      let I = w[0] + 1, _ = L[0] + 1;
      if (v !== null && v.length > 0) {
        const A = v[v.length - 1];
        I = Math.max(I, A.getOriginalEnd()), _ = Math.max(_, A.getModifiedEnd());
      }
      C = [
        new ve(I, d - I + 1, _, m - _ + 1)
      ];
    } else {
      P = new Dn(), V = l, x = o, p = w[0] - L[0] - u, R = 1073741824, D = S ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const I = p + i;
        I === V || I < x && h[I - 1] >= h[I + 1] ? (f = h[I + 1] - 1, g = f - p - u, f > R && P.MarkNextChange(), R = f + 1, P.AddOriginalElement(f + 1, g + 1), p = I + 1 - i) : (f = h[I - 1], g = f - p - u, f > R && P.MarkNextChange(), R = f, P.AddModifiedElement(f + 1, g + 1), p = I - 1 - i), D >= 0 && (h = this.m_reverseHistory[D], i = h[0], V = 1, x = h.length - 1);
      } while (--D >= -1);
      C = P.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, r, s, i, l, o) {
    let u = 0, c = 0, h = 0, f = 0, d = 0, w = 0;
    t--, r--, i[0] = 0, l[0] = 0, this.m_forwardHistory = [], this.m_reverseHistory = [];
    const g = n - t + (s - r), m = g + 1, L = new Int32Array(m), S = new Int32Array(m), N = s - r, v = n - t, C = t - r, P = n - s, x = (v - N) % 2 === 0;
    L[N] = t, S[v] = n, o[0] = !1;
    for (let p = 1; p <= g / 2 + 1; p++) {
      let R = 0, D = 0;
      h = this.ClipDiagonalBound(N - p, p, N, m), f = this.ClipDiagonalBound(N + p, p, N, m);
      for (let _ = h; _ <= f; _ += 2) {
        _ === h || _ < f && L[_ - 1] < L[_ + 1] ? u = L[_ + 1] : u = L[_ - 1] + 1, c = u - (_ - N) - C;
        const A = u;
        for (; u < n && c < s && this.ElementsAreEqual(u + 1, c + 1); )
          u++, c++;
        if (L[_] = u, u + c > R + D && (R = u, D = c), !x && Math.abs(_ - v) <= p - 1 && u >= S[_])
          return i[0] = u, l[0] = c, A <= S[_] && p <= 1448 ? this.WALKTRACE(N, h, f, C, v, d, w, P, L, S, u, n, i, c, s, l, x, o) : null;
      }
      const I = (R - t + (D - r) - p) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(R, I))
        return o[0] = !0, i[0] = R, l[0] = D, I > 0 && p <= 1448 ? this.WALKTRACE(N, h, f, C, v, d, w, P, L, S, u, n, i, c, s, l, x, o) : (t++, r++, [
          new ve(t, n - t + 1, r, s - r + 1)
        ]);
      d = this.ClipDiagonalBound(v - p, p, v, m), w = this.ClipDiagonalBound(v + p, p, v, m);
      for (let _ = d; _ <= w; _ += 2) {
        _ === d || _ < w && S[_ - 1] >= S[_ + 1] ? u = S[_ + 1] - 1 : u = S[_ - 1], c = u - (_ - v) - P;
        const A = u;
        for (; u > t && c > r && this.ElementsAreEqual(u, c); )
          u--, c--;
        if (S[_] = u, x && Math.abs(_ - N) <= p && u <= L[_])
          return i[0] = u, l[0] = c, A >= L[_] && p <= 1448 ? this.WALKTRACE(N, h, f, C, v, d, w, P, L, S, u, n, i, c, s, l, x, o) : null;
      }
      if (p <= 1447) {
        let _ = new Int32Array(f - h + 2);
        _[0] = N - h + 1, Ie.Copy2(L, h, _, 1, f - h + 1), this.m_forwardHistory.push(_), _ = new Int32Array(w - d + 2), _[0] = v - d + 1, Ie.Copy2(S, d, _, 1, w - d + 1), this.m_reverseHistory.push(_);
      }
    }
    return this.WALKTRACE(N, h, f, C, v, d, w, P, L, S, u, n, i, c, s, l, x, o);
  }
  /**
  ...
  PrettifyChanges(t) {
    ...
    for (let n = t.length - 1; n >= 0; n--) {
      ...
      for (let f = 1; ; f++) {
        const d = r.originalStart - f, w = r.modifiedStart - f;
        if (d < s || w < i || l && !this.OriginalElementsAreEqual(d, d + r.originalLength) || o && !this.ModifiedElementsAreEqual(w, w + r.modifiedLength))
          break;
        const m = (d === s && w === i ? 5 : 0) + this._boundaryScore(d, r.originalLength, w, r.modifiedLength);
        m > c && (c = m, u = f);
      }
    ...
    if (this._hasStrings)
      for (let n = 1, r = t.length; n < r; n++) {
        const s = t[n - 1], i = t[n], l = i.originalStart - s.originalStart - s.originalLength, o = s.originalStart, u = i.originalStart + i.originalLength, c = u - o, h = s.modifiedStart, f = i.modifiedStart + i.modifiedLength, d = f - h;
        if (l < 5 && c < 20 && d < 20) {
          const w = this._findBetterContiguousSequence(o, c, h, d, l);
          if (w) {
            const [g, m] = w;
            (g !== s.originalStart + s.originalLength || m !== s.modifiedStart + s.modifiedLength) && (s.originalLength = g - s.originalStart, s.modifiedLength = m - s.modifiedStart, i.originalStart = g + l, i.modifiedStart = m + l, i.originalLength = u - i.originalStart, i.modifiedLength = f - i.modifiedStart);
          }
        }
      }
    return t;
  ...
  _findBetterContiguousSequence(t, n, r, s, i) {
    ...
    for (let f = t; f < l; f++)
      for (let d = r; d < o; d++) {
        const w = this._contiguousSequenceScore(f, d, i);
        w > 0 && w > u && (u = w, c = f, h = d);
      }
    return u > 0 ? [c, h] : null;
  }
  ...
  ConcatenateChanges(t, n) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
      ...
      return Ie.Copy(t, 0, s, 0, t.length - 1), s[t.length - 1] = r[0], Ie.Copy(n, 1, s, t.length, n.length - 1), s;
    } else {
      const s = new Array(t.length + n.length);
      return Ie.Copy(t, 0, s, 0, t.length), Ie.Copy(n, 0, s, t.length, n.length), s;
    }
  }
  /**
  ...
  ChangesOverlap(t, n, r) {
    if (Ve.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), Ve.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (i = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (o = n.modifiedStart + n.modifiedLength - t.modifiedStart), r[0] = new ve(s, i, l, o), !0;
    } else
      return r[0] = null, !1;
  }
  /**
...
class E {
  ...
  static intersectRanges(t, n) {
    ...
    return r < o ? (r = o, s = u) : r === o && (s = Math.max(s, u)), i > c ? (i = c, l = h) : i === c && (l = Math.min(l, h)), r > i || r === i && s > l ? null : new E(r, s, i, l);
  }
  /**
...
class Ct {
  ...
  static computeLinks(t, n = Wi()) {
    ...
    for (let i = 1, l = t.getLineCount(); i <= l; i++) {
      ...
      let c = 0, h = 0, f = 0, d = 1, w = !1, g = !1, m = !1, L = !1;
      for (; c < u; ) {
        let S = !1;
        ...
        if (d === 13) {
          ...
          v === 1 && (s.push(Ct._createLink(r, o, i, h, c)), S = !0);
        } else if (d === 12) {
          let v;
          N === 91 ? (g = !0, v = 0) : v = r.get(N), v === 1 ? S = !0 : d = 13;
        } else
          d = n.nextState(d, N), d === 0 && (S = !0);
        S && (d = 1, w = !1, g = !1, L = !1, h = c + 1, f = N), c++;
      }
      d === 13 && s.push(Ct._createLink(r, o, i, h, u));
    }
    return s;
  }
}
function Gi(e) {
  return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : Ct.computeLinks(e);
}
const It = class It {
  constructor() {
...
class vt {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? Ms : (this._emitter || (this._emitter = new me()), this._emitter.event);
  }
  dispose() {
...
class ji {
  ...
  cancel() {
    this._token ? this._token instanceof vt && this._token.cancel() : this._token = Et.Cancelled;
  }
  dispose(t = !1) {
    var n;
    t && this.cancel(), (n = this._parentListener) == null || n.dispose(), this._token ? this._token instanceof vt && this._token.dispose() : this._token = Et.None;
  }
}
class Sn {
  constructor() {
...
const Nt = new Sn(), sn = new Sn(), an = new Sn(), Oi = new Array(230), Xi = /* @__PURE__ */ Object.create(null), Qi = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const s of t) {
    const [i, l, o, u, c, h, f, d, w] = s;
    if (r[l] || (r[l] = !0, Xi[o] = l, Qi[o.toLowerCase()] = l), !n[u]) {
      if (n[u] = !0, !c)
        throw new Error(`String representation missing for key code ${u} around scan code ${o}`);
      Nt.define(u, c), sn.define(u, d || c), an.define(u, w || d || c);
    }
    h && (Oi[h] = u);
  }
})();
...
(function(e) {
  function t(o) {
    return Nt.keyCodeToStr(o);
  }
  e.toString = t;
  function n(o) {
    return Nt.strToKeyCode(o);
  }
  e.fromString = n;
  function r(o) {
...
if (typeof jt < "u" && typeof jt.process < "u") {
...
} else typeof process < "u" && typeof ((Ns = process == null ? void 0 : process.versions) == null ? void 0 : Ns.node) == "string" ? Qe = {
  get platform() {
  ...
  // Supported
  get platform() {
    return ft ? "win32" : mi ? "darwin" : "linux";
  },
  get arch() {
  },
  // Unsupported
...
const kt = Qe.cwd, Yi = Qe.env, Zi = Qe.platform, Ki = 65, ea = 97, ta = 90, na = 122, Fe = 46, J = 47, te = 92, we = 58, ra = 63;
...
function Fs(e, t) {
  sa(t, "pathObject");
  const n = t.dir || t.root, r = t.base || `${t.name || ""}${ia(t.ext)}`;
...
const ee = {
  ...
  resolve(...e) {
    ...
    for (let s = e.length - 1; s >= -1; s--) {
      let i;
      if (s >= 0) {
        if (i = e[s], X(i, `paths[${s}]`), i.length === 0)
          continue;
      } else t.length === 0 ? i = kt() : (i = Yi[`=${t}`] || kt(), (i === void 0 || i.slice(0, 2).toLowerCase() !== t.toLowerCase() && i.charCodeAt(2) === te) && (i = `${t}\\`));
      const l = i.length;
      let o = 0, u = "", c = !1;
      ...
      if (l === 1)
        ...
        if (c = !0, B(i.charCodeAt(1))) {
          let f = 2, d = f;
          for (; f < l && !B(i.charCodeAt(f)); )
            f++;
          if (f < l && f !== d) {
            const w = i.slice(d, f);
            for (d = f; f < l && B(i.charCodeAt(f)); )
              f++;
            if (f < l && f !== d) {
              for (d = f; f < l && !B(i.charCodeAt(f)); )
                f++;
              (f === l || f !== d) && (u = `\\\\${w}\\${i.slice(d, f)}`, o = f);
            }
          }
        } else
          o = 1;
      else xe(h) && i.charCodeAt(1) === we && (u = i.slice(0, 2), o = 2, l > 2 && B(i.charCodeAt(2)) && (c = !0, o = 3));
      if (u.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (B(i))
      if (s = !0, B(e.charCodeAt(1))) {
        let o = 2, u = o;
        for (; o < t && !B(e.charCodeAt(o)); )
          o++;
        if (o < t && o !== u) {
          const c = e.slice(u, o);
          for (u = o; o < t && B(e.charCodeAt(o)); )
            o++;
          if (o < t && o !== u) {
            for (u = o; o < t && !B(e.charCodeAt(o)); )
              o++;
        ...
        n = 1;
    else xe(i) && e.charCodeAt(1) === we && (r = e.slice(0, 2), n = 2, t > 2 && B(e.charCodeAt(2)) && (s = !0, n = 3));
    let l = n < t ? Mt(e.slice(n), !s, "\\", B) : "";
    if (l.length === 0 && !s && (l = "."), l.length > 0 && B(e.charCodeAt(t - 1)) && (l += "\\"), !s && r === void 0 && e.includes(":")) {
      if (l.length >= 2 && xe(l.charCodeAt(0)) && l.charCodeAt(1) === we)
        return `.\\${l}`;
      let o = e.indexOf(":");
      do
        if (o === t - 1 || B(e.charCodeAt(o + 1)))
          return `.\\${l}`;
  ...
  isAbsolute(e) {
    ...
    t > 2 && xe(n) && e.charCodeAt(1) === we && B(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let i = 0; i < e.length; ++i) {
      const l = e[i];
      X(l, "path"), l.length > 0 && (t === void 0 ? t = n = l : t += `\\${l}`);
    }
    if (t === void 0)
      return ".";
    let r = !0, s = 0;
    ...
    if (r) {
      for (; s < t.length && B(t.charCodeAt(s)); )
        s++;
      s >= 2 && (t = `\\${t.slice(s)}`);
    }
  ...
  relative(e, t) {
    if (X(e, "from"), X(t, "to"), e === t)
      return "";
    const n = ee.resolve(e), r = ee.resolve(t);
    if (n === r || (e = n.toLowerCase(), t = r.toLowerCase(), e === t))
      return "";
    if (n.length !== e.length || r.length !== t.length) {
      const g = n.split("\\"), m = r.split("\\");
      g[g.length - 1] === "" && g.pop(), m[m.length - 1] === "" && m.pop();
      const L = g.length, S = m.length, N = L < S ? L : S;
      let v;
      for (v = 0; v < N && g[v].toLowerCase() === m[v].toLowerCase(); v++)
        ;
      return v === 0 ? r : v === N ? S > N ? m.slice(v).join("\\") : L > N ? "..\\".repeat(L - 1 - v) + ".." : "" : "..\\".repeat(L - v) + m.slice(v).join("\\");
    }
    let s = 0;
    ...
    const l = i - s;
    let o = 0;
    for (; o < t.length && t.charCodeAt(o) === te; )
      o++;
    let u = t.length;
    for (; u - 1 > o && t.charCodeAt(u - 1) === te; )
      u--;
    ...
    if (d !== h) {
      ...
      if (c > h) {
        if (t.charCodeAt(o + d) === te)
          return r.slice(o + d + 1);
        if (d === 2)
          return r.slice(o + d);
      }
      l > h && (e.charCodeAt(s + d) === te ? f = d : d === 2 && (f = 3)), f === -1 && (f = 0);
    }
    let w = "";
    for (d = s + f + 1; d <= i; ++d)
      (d === i || e.charCodeAt(d) === te) && (w += w.length === 0 ? ".." : "\\..");
    return o += f, w.length > 0 ? `${w}${r.slice(o, u)}` : (r.charCodeAt(o) === te && ++o, r.slice(o, u));
  },
  toNamespacedPath(e) {
    ...
    } else if (xe(t.charCodeAt(0)) && t.charCodeAt(1) === we && t.charCodeAt(2) === te)
      return `\\\\?\\${t}`;
    return t;
  },
  dirname(e) {
    ...
    } else xe(s) && e.charCodeAt(1) === we && (n = t > 2 && B(e.charCodeAt(2)) ? 3 : 2, r = n);
    let i = -1, l = !0;
    for (let o = t - 1; o >= r; --o)
      if (B(e.charCodeAt(o))) {
        if (!l) {
  ...
  basename(e, t) {
    t !== void 0 && X(t, "suffix"), X(e, "path");
    let n = 0, r = -1, s = !0, i;
    if (e.length >= 2 && xe(e.charCodeAt(0)) && e.charCodeAt(1) === we && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === we && xe(e.charCodeAt(0)) && (t = r = 2);
    for (let o = e.length - 1; o >= t; --o) {
      ...
      s === -1 && (i = !1, s = o + 1), u === Fe ? n === -1 ? n = o : l !== 1 && (l = 1) : n !== -1 && (l = -1);
    }
  ...
  parse(e) {
    ...
    if (n === 1)
      return B(s) ? (t.root = t.dir = e, t) : (t.base = t.name = e, t);
    if (B(s)) {
      if (r = 1, B(e.charCodeAt(1))) {
        let f = 2, d = f;
        for (; f < n && !B(e.charCodeAt(f)); )
          f++;
        if (f < n && f !== d) {
          for (d = f; f < n && B(e.charCodeAt(f)); )
            f++;
          if (f < n && f !== d) {
            for (d = f; f < n && !B(e.charCodeAt(f)); )
              f++;
    ...
    } else if (xe(s) && e.charCodeAt(1) === we) {
      if (n <= 2)
    ...
    for (; c >= r; --c) {
      ...
      o === -1 && (u = !1, o = c + 1), s === Fe ? i === -1 ? i = c : h !== 1 && (h = 1) : i !== -1 && (h = -1);
    }
  ...
  resolve(...e) {
    ...
    for (let r = e.length - 1; r >= 0 && !n; r--) {
      const s = e[r];
      X(s, `paths[${r}]`), s.length !== 0 && (t = `${s}/${t}`, n = s.charCodeAt(0) === J);
    }
    if (!n) {
      const r = aa();
      t = `${r}/${t}`, n = r.charCodeAt(0) === J;
    }
    return t = Mt(t, !n, "/", ln), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (X(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === J, n = e.charCodeAt(e.length - 1) === J;
    return e = Mt(e, !t, "/", ln), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
    return X(e, "path"), e.length > 0 && e.charCodeAt(0) === J;
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let n = 0; n < e.length; ++n) {
      const r = e[n];
      X(r, "path"), r.length > 0 && t.push(r);
    }
    return t.length === 0 ? "." : re.normalize(t.join("/"));
  },
  relative(e, t) {
    if (X(e, "from"), X(t, "to"), e === t || (e = re.resolve(e), t = re.resolve(t), e === t))
      return "";
    ...
    if (c === o)
      if (l > o) {
        ...
        if (c === 0)
          return t.slice(i + c);
      } else s > o && (e.charCodeAt(n + c) === J ? u = c : c === 0 && (u = 0));
    let h = "";
    for (c = n + u + 1; c <= r; ++c)
      (c === r || e.charCodeAt(c) === J) && (h += h.length === 0 ? ".." : "/..");
  ...
  extname(e) {
    ...
    for (let l = e.length - 1; l >= 0; --l) {
      ...
      r === -1 && (s = !1, r = l + 1), o === "." ? t === -1 ? t = l : i !== 1 && (i = 1) : t !== -1 && (i = -1);
    }
  ...
  parse(e) {
    ...
    for (; u >= r; --u) {
      ...
      l === -1 && (o = !1, l = u + 1), h === Fe ? s === -1 ? s = u : c !== 1 && (c = 1) : s !== -1 && (c = -1);
    }
    if (l !== -1) {
      const h = i === 0 && n ? 1 : i;
...
Re ? ee.normalize : re.normalize;
Re ? ee.resolve : re.resolve;
Re ? ee.relative : re.relative;
Re ? ee.dirname : re.dirname;
Re ? ee.basename : re.basename;
Re ? ee.extname : re.extname;
Re ? ee.sep : re.sep;
const la = /^\w[\w\d+.-]*$/, oa = /^\//, ua = /^\/\//;
function ca(e, t) {
  if (!e.scheme && t)
    throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`);
  if (e.scheme && !la.test(e.scheme))
    throw new Error("[UriError]: Scheme contains illegal characters.");
  if (e.path) {
    if (e.authority) {
      if (!oa.test(e.path))
        throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
    } else if (ua.test(e.path))
...
class Te {
  static isUri(t) {
    return t instanceof Te ? !0 : !t || typeof t != "object" ? !1 : typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function";
  }
  /**
   * @internal
   */
  constructor(t, n, r, s, i, l = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || G, this.authority = t.authority || G, this.path = t.path || G, this.query = t.query || G, this.fragment = t.fragment || G) : (this.scheme = ha(t, l), this.authority = n || G, this.path = fa(this.scheme, r || G), this.query = s || G, this.fragment = i || G, ca(this, l));
  }
  // ---- filesystem path -----------------------
  /**
  ...
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = G), r === void 0 ? r = this.authority : r === null && (r = G), s === void 0 ? s = this.path : s === null && (s = G), i === void 0 ? i = this.query : i === null && (i = G), l === void 0 ? l = this.fragment : l === null && (l = G), n === this.scheme && r === this.authority && s === this.path && i === this.query && l === this.fragment ? this : new qe(n, r, s, i, l);
  }
  // ---- parse & validate ------------------------
  /**
  ...
  static parse(t, n = !1) {
    const r = da.exec(t);
    return r ? new qe(r[2] || G, pt(r[4] || G), pt(r[5] || G), pt(r[7] || G), pt(r[9] || G), n) : new qe(G, G, G, G, G);
  }
  /**
  ...
  static file(t) {
    let n = G;
    if (ft && (t = t.replace(/\\/g, fe)), t[0] === fe && t[1] === fe) {
      const r = t.indexOf(fe, 2);
      r === -1 ? (n = t.substring(2), t = fe) : (n = t.substring(2, r), t = t.substring(r) || fe);
    }
    return new qe("file", n, t, G, G);
  }
  /**
  ...
  static joinPath(t, ...n) {
    ...
    let r;
    return ft && t.scheme === "file" ? r = Te.file(ee.join(on(t, !0), ...n)).path : r = re.join(t.path, ...n), t.with({ path: r });
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new qe(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === Ts ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
}
const Ts = ft ? 1 : void 0;
class qe extends Te {
  constructor() {
  ...
  toString(t = !1) {
    return t ? un(this, !0) : (this._formatted || (this._formatted = un(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: 1
    ...
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = Ts), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const Ds = {
  58: "%3A",
...
function ma(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const r = e.charCodeAt(n);
    r === 35 || r === 63 ? (t === void 0 && (t = e.substr(0, n)), t += Ds[r]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function on(e, t) {
...
function un(e, t) {
  ...
  if (s && (r += s, r += ":"), (i || s === "file") && (r += fe, r += fe), i) {
    let c = i.indexOf("@");
    if (c !== -1) {
  ...
  return o && (r += "?", r += n(o, !1, !1)), u && (r += "#", r += t ? u : Bn(u, !1, !1)), r;
}
function Vs(e) {
  try {
...
function pt(e) {
  return e.match(qn) ? e.replace(qn, (t) => Vs(t)) : e;
}
class se extends E {
  constructor(t, n, r, s) {
...
class wa {
  ...
  register(t, n) {
    return this._tokenizationSupports.set(t, n), this.handleChange([t]), yt(() => {
  ...
  registerFactory(t, n) {
    ...
    const r = new xa(this, t, n);
    return this._factories.set(t, r), yt(() => {
...
T(757, "array"), T(758, "boolean"), T(759, "class"), T(760, "constant"), T(761, "constructor"), T(762, "enumeration"), T(763, "enumeration member"), T(764, "event"), T(765, "field"), T(766, "file"), T(767, "function"), T(768, "interface"), T(769, "key"), T(770, "method"), T(771, "module"), T(772, "namespace"), T(773, "null"), T(774, "number"), T(775, "object"), T(776, "operator"), T(777, "package"), T(778, "property"), T(779, "string"), T(780, "struct"), T(781, "type parameter"), T(782, "variable");
var Qn;
(function(e) {
  const t = /* @__PURE__ */ new Map();
...
function Ca(e, t, n, r, s) {
  return Ra(e, t, n, r, s) && ya(e, t, n, r, s);
}
class Ea {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (s === this._prevMatchStartIndex && i === this._prevMatchLength) {
        if (i === 0) {
          Ci(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = s, this._prevMatchLength = i, !this._wordSeparators || Ca(this._wordSeparators, t, n, s, i))
        return r;
    } while (r);
    return null;
  }
...
function An(e, t, n, r, s) {
  if (t = Bs(t), s || (s = Rt.first(qs)), n.length > s.maxLen) {
    let c = e - s.maxLen / 2;
...
class Fa {
  static computeUnicodeHighlights(t, n, r) {
    const s = r ? r.startLineNumber : 1, i = r ? r.endLineNumber : t.getLineCount(), l = new Jr(n), o = l.getCandidateCodePoints();
    let u;
    o === "allNonBasicAscii" ? u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : u = new RegExp(`${Ta(Array.from(o))}`, "g");
    const c = new Ea(null, u), h = [];
    let f = !1, d, w = 0, g = 0, m = 0;
    e: for (let L = s, S = i; L <= S; L++) {
      const N = t.getLineContent(L), v = N.length;
      c.reset(0);
      do
        if (d = c.next(N), d) {
          let C = d.index, P = d.index + d[0].length;
          if (C > 0) {
            const R = N.charCodeAt(C - 1);
            nn(R) && C--;
          }
          if (P + 1 < v) {
            const R = N.charCodeAt(P - 1);
            nn(R) && P++;
          }
          const V = N.substring(C, P);
          let x = An(C + 1, Is, N, 0);
          x && x.endColumn <= C + 1 && (x = null);
          const p = l.shouldHighlightNonBasicASCII(V, x ? x.word : null);
          if (p !== 0) {
            if (p === 3 ? w++ : p === 2 ? g++ : p === 1 ? m++ : Qs(), h.length >= 1e3) {
              f = !0;
              break e;
            }
            h.push(new E(L, C + 1, L, P + 1));
          }
        }
      while (d);
    }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (r.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 3: {
        const i = t.codePointAt(0), l = r.ambiguousCharacters.getPrimaryConfusable(i), o = dt.getLocales().filter((u) => !dt.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, u])).isAmbiguous(i));
...
function Ta(e, t) {
  return `[${pi(e.map((r) => String.fromCodePoint(r)).join(""))}]`;
}
class Jr {
  constructor(t) {
    this.options = t, this.allowedCodePoints = new Set(t.allowedCodePoints), this.ambiguousCharacters = dt.getInstance(new Set(t.allowedLocales));
  }
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const l of n) {
        const o = l.codePointAt(0), u = ki(l);
    ...
    return (
      ...
      i ? 0 : this.options.invisibleCharacters && !Yr(t) && it.isInvisibleCharacter(r) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(r) ? 3 : 0
    );
  }
}
function Yr(e) {
...
const Xe = class Xe {
  ...
  filter(t) {
    return new Xe((n) => this.iterate((r) => t(r) ? n(r) : !0));
  }
  map(t) {
    return new Xe((n) => this.iterate((r) => n(t(r))));
  }
  findLast(t) {
    let n;
  ...
  findLastMaxBy(t) {
    let n, r = !0;
    return this.iterate((s) => ((r || gn.isGreaterThan(t(s, n))) && (r = !1, n = s), !0)), n;
  }
};
Xe.empty = new Xe((t) => {
});
...
class U {
  ...
  deltaStart(t) {
    return new U(this.start + t, this.endExclusive);
  }
  deltaEnd(t) {
    return new U(this.start, this.endExclusive + t);
  }
  get length() {
  ...
  clip(t) {
    if (this.isEmpty)
      throw new Z(`Invalid clipping range: ${this.toString()}`);
  ...
  */
  joinRightTouching(t) {
    if (this.endExclusive !== t.start)
      throw new Z(`Invalid join: ${this.toString()} and ${t.toString()}`);
    return new U(this.start, t.endExclusive);
  }
}
function Ke(e, t) {
  const n = et(e, t);
...
function et(e, t, n = 0, r = e.length) {
  let s = n, i = r;
  for (; s < i; ) {
...
const ie = class ie {
  ...
  static fromRange(t) {
    return new ie(t.startLineNumber, t.endLineNumber);
  }
  static fromRangeInclusive(t) {
    return new ie(t.startLineNumber, t.endLineNumber + 1);
  }
  /**
  ...
  static joinMany(t) {
    ...
    for (let r = 1; r < t.length; r++)
      n = n.getUnion(new ge(t[r].slice()));
    return n.ranges;
  }
  static join(t) {
    if (t.length === 0)
      throw new Z("lineRanges cannot be empty");
  ...
  static deserialize(t) {
    return new ie(t[0], t[1]);
  }
  constructor(t, n) {
    if (t > n)
      throw new Z(`startLineNumber ${t} cannot be after endLineNumberExclusive ${n}`);
   ...
   */
  delta(t) {
    return new ie(this.startLineNumber + t, this.endLineNumberExclusive + t);
  }
  deltaLength(t) {
    return new ie(this.startLineNumber, this.endLineNumberExclusive + t);
  }
  /**
   ...
   */
  join(t) {
    return new ie(Math.min(this.startLineNumber, t.startLineNumber), Math.max(this.endLineNumberExclusive, t.endLineNumberExclusive));
  }
  toString() {
    return `[${this.startLineNumber},${this.endLineNumberExclusive})`;
  }
  ...
  */
  ...
  addMargin(t, n) {
    return new ie(this.startLineNumber - t, this.endLineNumberExclusive + n);
  }
};
ie.compareByStart = at((t) => t.startLineNumber, lt);
let $ = ie;
class ge {
  constructor(t = []) {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = bn(this._normalizedRanges, (s) => s.endLineNumberExclusive >= t.startLineNumber), r = et(this._normalizedRanges, (s) => s.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === r)
  ...
  contains(t) {
    const n = Ke(this._normalizedRanges, (r) => r.startLineNumber <= t);
    return !!n && n.endLineNumberExclusive > t;
  }
  intersects(t) {
    const n = Ke(this._normalizedRanges, (r) => r.startLineNumber < t.endLineNumberExclusive);
   ...
   */
  subtractFrom(t) {
    const n = bn(this._normalizedRanges, (l) => l.endLineNumberExclusive >= t.startLineNumber), r = et(this._normalizedRanges, (l) => l.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === r)
      return new ge([t]);
    const s = [];
    ...
    return i < t.endLineNumberExclusive && s.push(new $(i, t.endLineNumberExclusive)), new ge(s);
  }
  toString() {
...
class Wa {
  getOffsetRange(t) {
    return new U(this.getOffset(t.getStartPosition()), this.getOffset(t.getEndPosition()));
  }
  getRange(t) {
    return E.fromPositions(this.getPosition(t.start), this.getPosition(t.endExclusive));
  }
  getStringReplacement(t) {
    return new Je.deps.StringReplacement(this.getOffsetRange(t.range), t.text);
  }
  getTextReplacement(t) {
    return new Je.deps.TextReplacement(this.getRange(t.replaceRange), t.newText);
  }
  getTextEdit(t) {
    const n = t.replacements.map((r) => this.getTextReplacement(r));
    return new Je.deps.TextEdit(n);
  }
}
const Cn = class Cn {
  static get deps() {
...
` && (this.lineStartOffsetByLineIdx.push(n + 1), n > 0 && t.charAt(n - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(n - 1) : this.lineEndOffsetByLineIdx.push(n));
  ...
  _validatePosition(t) {
    ...
    if (t.column < 1)
      return new H(t.lineNumber, 1);
    const r = this.getLineLength(t.lineNumber);
    return t.column - 1 > r ? new H(t.lineNumber, r + 1) : t;
  }
  getPosition(t) {
    const n = et(this.lineStartOffsetByLineIdx, (i) => i <= t), r = n + 1, s = t - this.lineStartOffsetByLineIdx[n] + 1;
    return new H(r, s);
  }
  get textLength() {
    const t = this.lineStartOffsetByLineIdx.length - 1;
    return new Je.deps.TextLength(t, this.text.length - this.lineStartOffsetByLineIdx[t]);
  }
  getLineLength(t) {
...
class Ga {
  ...
  getLineLength(t) {
    return this.getValueOfRange(new E(t, 1, t, Number.MAX_SAFE_INTEGER)).length;
  }
  getTransformer() {
    return this._transformer || (this._transformer = new za(this.getValue())), this._transformer;
  }
  getLineAt(t) {
    return this.getValueOfRange(new E(t, 1, t, Number.MAX_SAFE_INTEGER));
  }
}
class ja extends Ga {
  constructor(t, n) {
    Js(n >= 1), super(), this._getLineContent = t, this._lineCount = n;
  }
  getValueOfRange(t) {
...
class Ne {
  static joinReplacements(t, n) {
    ...
    for (let l = 0; l < t.length; l++) {
      const o = t[l];
      if (i += o.text, l < t.length - 1) {
        const u = t[l + 1], c = E.fromPositions(o.range.getEndPosition(), u.range.getStartPosition()), h = n.getValueOfRange(c);
        i += h;
      }
    }
    return new Ne(E.fromPositions(r, s), i);
  }
  static fromStringReplacement(t, n) {
    return new Ne(n.getTransformer().getRange(t.replaceRange), t.newText);
  }
  static delete(t) {
    return new Ne(t, "");
  }
...
`, `
`), s = Si(n, r), i = mt.ofText(n.substring(0, s)).addToPosition(this.range.getStartPosition()), l = r.substring(s), o = E.fromPositions(i, this.range.getEndPosition());
    return new Ne(o, l);
  }
...
`), r = this.text.replaceAll(`\r
`, `
`), s = Ai(n, r), i = mt.ofText(n.substring(0, n.length - s)).addToPosition(this.range.getStartPosition()), l = r.substring(0, r.length - s), o = E.fromPositions(this.range.getStartPosition(), i);
    return new Ne(o, l);
  }
  toString() {
...
class ue {
  ...
  */
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new le(new E(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new E(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new le(new E(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new E(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
  }
  /**
   * This method assumes that the LineRangeMapping describes a valid diff!
   * I.e. if one range is empty, the other range cannot be the entire document.
  ...
  */
  toRangeMapping2(t, n) {
    if (Kr(this.original.endLineNumberExclusive, t) && Kr(this.modified.endLineNumberExclusive, n))
      return new le(new E(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new E(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new le(E.fromPositions(new H(this.original.startLineNumber, 1), Ue(new H(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), E.fromPositions(new H(this.modified.startLineNumber, 1), Ue(new H(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new le(E.fromPositions(Ue(new H(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), Ue(new H(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), E.fromPositions(Ue(new H(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), Ue(new H(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new Z();
  }
}
function Ue(e, t) {
...
class _e extends ue {
  static fromRangeMappings(t) {
    const n = $.join(t.map((s) => $.fromRangeInclusive(s.originalRange))), r = $.join(t.map((s) => $.fromRangeInclusive(s.modifiedRange)));
    return new _e(n, r, t);
  }
  constructor(t, n, r) {
...
class le {
  static fromEdit(t) {
    ...
    return t.replacements.map((s, i) => new le(s.range, n[i]));
  }
  ...
  */
  toTextEdit(t) {
    ...
    return new Ne(this.originalRange, n);
  }
}
function es(e, t, n, r = !1) {
  const s = [];
  for (const i of Ia(e.map((l) => Oa(l, t, n)), (l, o) => l.original.intersectsOrTouches(o.original) || l.modified.intersectsOrTouches(o.modified))) {
    const l = i[0], o = i[i.length - 1];
    s.push(new _e(l.original.join(o.original), l.modified.join(o.modified), i.map((u) => u.innerChanges[0])));
  }
  return At(() => !r && s.length > 0 && (s[0].modified.startLineNumber !== s[0].original.startLineNumber || n.length.lineCount - s[s.length - 1].modified.endLineNumberExclusive !== t.length.lineCount - s[s.length - 1].original.endLineNumberExclusive) ? !1 : As(s, (i, l) => l.original.startLineNumber - i.original.endLineNumberExclusive === l.modified.startLineNumber - i.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
...
function Oa(e, t, n) {
  ...
  const i = new $(e.originalRange.startLineNumber + r, e.originalRange.endLineNumber + 1 + s), l = new $(e.modifiedRange.startLineNumber + r, e.modifiedRange.endLineNumber + 1 + s);
  return new _e(i, l, [e]);
}
const Xa = 3;
class Qa {
  computeDiff(t, n, r) {
    ...
    for (const c of i.changes) {
      let h;
      c.originalEndLineNumber === 0 ? h = new $(c.originalStartLineNumber + 1, c.originalStartLineNumber + 1) : h = new $(c.originalStartLineNumber, c.originalEndLineNumber + 1);
      let f;
      c.modifiedEndLineNumber === 0 ? f = new $(c.modifiedStartLineNumber + 1, c.modifiedStartLineNumber + 1) : f = new $(c.modifiedStartLineNumber, c.modifiedEndLineNumber + 1);
      let d = new _e(h, f, (u = c.charChanges) == null ? void 0 : u.map((w) => new le(new E(w.originalStartLineNumber, w.originalStartColumn, w.originalEndLineNumber, w.originalEndColumn), new E(w.modifiedStartLineNumber, w.modifiedStartColumn, w.modifiedEndLineNumber, w.modifiedEndColumn))));
      o && (o.modified.endLineNumberExclusive === d.modified.startLineNumber || o.original.endLineNumberExclusive === d.original.startLineNumber) && (d = new _e(o.original.join(d.original), o.modified.join(d.modified), o.innerChanges && d.innerChanges ? o.innerChanges.concat(d.innerChanges) : void 0), l.pop()), l.push(d), o = d;
    }
    return At(() => As(l, (c, h) => h.original.startLineNumber - c.original.endLineNumberExclusive === h.modified.startLineNumber - c.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    c.original.endLineNumberExclusive < h.original.startLineNumber && c.modified.endLineNumberExclusive < h.modified.startLineNumber)), new St(l, [], i.quitEarly);
  }
}
function Us(e, t, n, r) {
...
function Ya(e) {
  ...
  for (let r = 1, s = e.length; r < s; r++) {
    ...
    Math.min(l, o) < Xa ? (n.originalLength = i.originalStart + i.originalLength - n.originalStart, n.modifiedLength = i.modifiedStart + i.modifiedLength - n.modifiedStart) : (t.push(i), n = i);
  }
  return t;
}
class ot {
  ...
  static createFromDiffResult(t, n, r, s, i, l, o) {
    ...
    if (n.originalLength === 0 ? (u = r.getStartLineNumber(n.originalStart) - 1, c = 0) : (u = r.getStartLineNumber(n.originalStart), c = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (h = s.getStartLineNumber(n.modifiedStart) - 1, f = 0) : (h = s.getStartLineNumber(n.modifiedStart), f = s.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), l && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && i()) {
      const w = r.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1), g = s.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1);
      if (w.getElements().length > 0 && g.getElements().length > 0) {
        let m = Us(w, g, i, !0).changes;
        o && (m = Ya(m)), d = [];
        for (let L = 0, S = m.length; L < S; L++)
          d.push(Ye.createFromDiffChange(m[L], w, g));
      }
    }
    return new ot(u, c, h, f, d);
  }
}
class Za {
  constructor(t, n, r) {
  ...
  computeDiff() {
    ...
    const t = Us(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, r = t.quitEarly;
    ...
    for (let o = -1, u = n.length; o < u; o++) {
      ...
      for (; i < h && l < f; ) {
        const d = this.originalLines[i], w = this.modifiedLines[l];
        if (d !== w) {
          {
            let g = wn(d, 1), m = wn(w, 1);
            for (; g > 1 && m > 1; ) {
              const L = d.charCodeAt(g - 2), S = w.charCodeAt(m - 2);
              if (L !== S)
                break;
              g--, m--;
            }
            (g > 1 || m > 1) && this._pushTrimWhitespaceCharChange(s, i + 1, 1, g, l + 1, 1, m);
          }
          {
            let g = xn(d, 1), m = xn(w, 1);
            const L = d.length + 1, S = w.length + 1;
            for (; g < L && m < S; ) {
              const N = d.charCodeAt(g - 1), v = d.charCodeAt(m - 1);
              if (N !== v)
                break;
              g++, m++;
            }
            (g < L || m < S) && this._pushTrimWhitespaceCharChange(s, i + 1, g, L, l + 1, m, S);
          }
        }
        i++, l++;
      }
  ...
  _pushTrimWhitespaceCharChange(t, n, r, s, i, l, o) {
    if (this._mergeTrimWhitespaceCharChange(t, n, r, s, i, l, o))
      return;
    let u;
    this.shouldComputeCharChanges && (u = [new Ye(n, r, n, s, i, l, i, o)]), t.push(new ot(n, n, i, i, u));
  }
...
class Le {
  static trivial(t, n) {
    return new Le([new O(U.ofLength(t.length), U.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new Le([new O(U.ofLength(t.length), U.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class O {
  static invert(t, n) {
    const r = [];
    return Ba(t, (s, i) => {
      r.push(O.fromOffsetPairs(s ? s.getEndExclusives() : pe.zero, i ? i.getStarts() : new pe(n, (s ? s.seq2Range.endExclusive - s.seq1Range.endExclusive : 0) + n)));
    }), r;
  }
  static fromOffsetPairs(t, n) {
    return new O(new U(t.offset1, n.offset1), new U(t.offset2, n.offset2));
  }
  static assertSorted(t) {
    let n;
    for (const r of t) {
  ...
  compute(t, n, r = gt.instance, s) {
    ...
    for (let g = 0; g < t.length; g++)
      for (let m = 0; m < n.length; m++) {
        ...
        const L = g === 0 ? 0 : i.get(g - 1, m), S = m === 0 ? 0 : i.get(g, m - 1);
        let N;
        t.getElement(g) === n.getElement(m) ? (g === 0 || m === 0 ? N = 0 : N = i.get(g - 1, m - 1), g > 0 && m > 0 && l.get(g - 1, m - 1) === 3 && (N += o.get(g - 1, m - 1)), N += s ? s(g, m) : 1) : N = -1;
        const v = Math.max(L, S, N);
        if (v === N) {
          const C = g > 0 && m > 0 ? o.get(g - 1, m - 1) : 0;
          o.set(g, m, C + 1), l.set(g, m, 3);
        } else v === L ? (o.set(g, m, 0), l.set(g, m, 1)) : v === S && (o.set(g, m, 0), l.set(g, m, 2));
        i.set(g, m, v);
      }
    const u = [];
    let c = t.length, h = n.length;
    function f(g, m) {
      (g + 1 !== c || m + 1 !== h) && u.push(new O(new U(g + 1, c), new U(m + 1, h))), c = g, h = m;
    }
    let d = t.length - 1, w = n.length - 1;
    for (; d >= 0 && w >= 0; )
      l.get(d, w) === 3 ? (f(d, w), d--, w--) : l.get(d, w) === 1 ? d-- : w--;
    return f(-1, -1), u.reverse(), new Le(u, !1);
  }
}
class $s {
  compute(t, n, r = gt.instance) {
    ...
    const s = t, i = n;
    function l(m, L) {
      for (; m < s.length && L < i.length && s.getElement(m) === i.getElement(L); )
        m++, L++;
      return m;
    }
    let o = 0;
    ...
    e: for (; ; ) {
      if (o++, !r.isValid())
        return Le.trivialTimedOut(s, i);
      const m = -Math.min(o, i.length + o % 2), L = Math.min(o, s.length + o % 2);
      for (h = m; h <= L; h += 2) {
        const S = h === L ? -1 : u.get(h + 1), N = h === m ? -1 : u.get(h - 1) + 1, v = Math.min(Math.max(S, N), s.length), C = v - h;
        if (v > s.length || C > i.length)
          continue;
        const P = l(v, C);
        u.set(h, P);
        const V = v === S ? c.get(h + 1) : c.get(h - 1);
        if (c.set(h, P !== v ? new rs(V, v, C, P - v) : V), u.get(h) === s.length && u.get(h) - h === i.length)
          break e;
      }
    }
    let f = c.get(h);
    const d = [];
    let w = s.length, g = i.length;
    for (; ; ) {
      const m = f ? f.x + f.length : 0, L = f ? f.y + f.length : 0;
      if ((m !== w || L !== g) && d.push(new O(new U(m, w), new U(L, g))), !f)
        break;
      w = f.x, g = f.y, f = f.prev;
    }
    return d.reverse(), new Le(d, !1);
  }
}
class rs {
  constructor(t, n, r, s) {
...
class Tt {
  ...
  getBoundaryScore(t) {
    const n = as(t > 0 ? this.elements[t - 1] : -1), r = as(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && r === 8)
      return 0;
    if (n === 8)
      return 150;
  ...
  translateOffset(t, n = "right") {
    const r = et(this.firstElementOffsetByLineIdx, (i) => i <= t), s = t - this.firstElementOffsetByLineIdx[r];
  ...
  findWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !$e(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && $e(this.elements[n - 1]); )
      n--;
    let r = t;
    for (; r < this.elements.length && $e(this.elements[r]); )
      r++;
    return new U(n, r);
  }
  ...
  findSubWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !$e(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && $e(this.elements[n - 1]) && !ss(this.elements[n]); )
      n--;
    let r = t;
    for (; r < this.elements.length && $e(this.elements[r]) && !ss(this.elements[r]); )
      r++;
    return new U(n, r);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = Ke(this.firstElementOffsetByLineIdx, (s) => s <= t.start) ?? 0, r = Ha(this.firstElementOffsetByLineIdx, (s) => t.endExclusive <= s) ?? this.elements.length;
    return new U(n, r);
  }
}
function $e(e) {
...
function s1(e, t, n, r, s, i) {
  let { moves: l, excludedChanges: o } = a1(e, t, n, i);
  if (!i.isValid())
    return [];
  const u = e.filter((h) => !o.has(h)), c = l1(u, r, s, t, n, i);
  return Ua(l, c), l = o1(l), l = l.filter((h) => {
    const f = h.original.toOffsetRange().slice(t).map((w) => w.trim());
    return f.join(`
`).length >= 15 && i1(f, (w) => w.length >= 2) >= 2;
  }), l = u1(e, l), l;
}
function i1(e, t) {
  let n = 0;
...
function a1(e, t, n, r) {
  const s = [], i = e.filter((u) => u.modified.isEmpty && u.original.length >= 3).map((u) => new Ft(u.original, t, u)), l = new Set(e.filter((u) => u.original.isEmpty && u.modified.length >= 3).map((u) => new Ft(u.modified, n, u))), o = /* @__PURE__ */ new Set();
  for (const u of i) {
    let c = -1, h;
    for (const f of l) {
...
function l1(e, t, n, r, s, i) {
  const l = [], o = new Sa();
  for (const d of e)
    for (let w = d.original.startLineNumber; w < d.original.endLineNumberExclusive - 2; w++) {
      const g = `${t[w - 1]}:${t[w + 1 - 1]}:${t[w + 2 - 1]}`;
      o.add(g, { range: new $(w, w + 3) });
    }
  const u = [];
  ...
  for (const d of e) {
    ...
    for (let g = d.modified.startLineNumber; g < d.modified.endLineNumberExclusive - 2; g++) {
      const m = `${n[g - 1]}:${n[g + 1 - 1]}:${n[g + 2 - 1]}`, L = new $(g, g + 3), S = [];
      o.forEach(m, ({ range: N }) => {
        for (const C of w)
          if (C.originalLineRange.endLineNumberExclusive + 1 === N.endLineNumberExclusive && C.modifiedLineRange.endLineNumberExclusive + 1 === L.endLineNumberExclusive) {
            C.originalLineRange = new $(C.originalLineRange.startLineNumber, N.endLineNumberExclusive), C.modifiedLineRange = new $(C.modifiedLineRange.startLineNumber, L.endLineNumberExclusive), S.push(C);
            return;
          }
        const v = {
          modifiedLineRange: L,
  ...
  u.sort($a(at((d) => d.modifiedLineRange.length, lt)));
  const c = new ge(), h = new ge();
  for (const d of u) {
    const w = d.modifiedLineRange.startLineNumber - d.originalLineRange.startLineNumber, g = c.subtractFrom(d.modifiedLineRange), m = h.subtractFrom(d.originalLineRange).getWithDelta(w), L = g.getIntersection(m);
    for (const S of L.ranges) {
      if (S.length < 3)
        continue;
      const N = S, v = S.delta(-w);
      l.push(new ue(v, N)), c.addRange(N), h.addRange(v);
    }
  }
  l.sort(at((d) => d.original.startLineNumber, lt));
  const f = new Pt(e);
  for (let d = 0; d < l.length; d++) {
    const w = l[d], g = f.findLastMonotonous((V) => V.original.startLineNumber <= w.original.startLineNumber), m = Ke(e, (V) => V.modified.startLineNumber <= w.modified.startLineNumber), L = Math.max(w.original.startLineNumber - g.original.startLineNumber, w.modified.startLineNumber - m.modified.startLineNumber), S = f.findLastMonotonous((V) => V.original.startLineNumber < w.original.endLineNumberExclusive), N = Ke(e, (V) => V.modified.startLineNumber < w.modified.endLineNumberExclusive), v = Math.max(S.original.endLineNumberExclusive - w.original.endLineNumberExclusive, N.modified.endLineNumberExclusive - w.modified.endLineNumberExclusive);
    let C;
    for (C = 0; C < L; C++) {
      const V = w.original.startLineNumber - C - 1, x = w.modified.startLineNumber - C - 1;
      if (V > r.length || x > s.length || c.contains(x) || h.contains(V) || !ls(r[V - 1], s[x - 1], i))
        break;
    }
    C > 0 && (h.addRange(new $(w.original.startLineNumber - C, w.original.startLineNumber)), c.addRange(new $(w.modified.startLineNumber - C, w.modified.startLineNumber)));
    let P;
    for (P = 0; P < v; P++) {
      const V = w.original.endLineNumberExclusive + P, x = w.modified.endLineNumberExclusive + P;
      if (V > r.length || x > s.length || c.contains(x) || h.contains(V) || !ls(r[V - 1], s[x - 1], i))
        break;
    }
    P > 0 && (h.addRange(new $(w.original.endLineNumberExclusive, w.original.endLineNumberExclusive + P)), c.addRange(new $(w.modified.endLineNumberExclusive, w.modified.endLineNumberExclusive + P))), (C > 0 || P > 0) && (l[d] = new ue(new $(w.original.startLineNumber - C, w.original.endLineNumberExclusive + P), new $(w.modified.startLineNumber - C, w.modified.endLineNumberExclusive + P)));
  }
  return l;
}
function ls(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const s = new $s().compute(new Tt([e], new E(1, 1, 1, e.length), !1), new Tt([t], new E(1, 1, 1, t.length), !1), n);
  let i = 0;
...
function u1(e, t) {
  const n = new Pt(e);
  return t = t.filter((r) => {
    const s = n.findLastMonotonous((o) => o.original.startLineNumber < r.original.endLineNumberExclusive) || new ue(new $(1, 1), new $(1, 1)), i = Ke(e, (o) => o.modified.startLineNumber < r.modified.endLineNumberExclusive);
    return s !== i;
  }), t;
}
function os(e, t, n) {
  let r = n;
  return r = us(e, t, r), r = us(e, t, r), r = c1(e, t, r), r;
}
function us(e, t, n) {
  if (n.length === 0)
    return n;
...
function c1(e, t, n) {
  ...
  for (let r = 0; r < n.length; r++) {
    const s = r > 0 ? n[r - 1] : void 0, i = n[r], l = r + 1 < n.length ? n[r + 1] : void 0, o = new U(s ? s.seq1Range.endExclusive + 1 : 0, l ? l.seq1Range.start - 1 : e.length), u = new U(s ? s.seq2Range.endExclusive + 1 : 0, l ? l.seq2Range.start - 1 : t.length);
    i.seq1Range.isEmpty ? n[r] = cs(i, e, t, o, u) : i.seq2Range.isEmpty && (n[r] = cs(i.swap(), t, e, u, o).swap());
  }
  return n;
}
function cs(e, t, n, r, s) {
  ...
  let u = 0, c = -1;
  for (let h = -l; h <= o; h++) {
    const f = e.seq2Range.start + h, d = e.seq2Range.endExclusive + h, w = e.seq1Range.start + h, g = t.getBoundaryScore(w) + n.getBoundaryScore(f) + n.getBoundaryScore(d);
    g > c && (c = g, u = h);
  }
  return e.delta(u);
}
...
function hs(e, t, n, r, s = !1) {
  const i = O.invert(n, e.length), l = [];
  let o = new pe(0, 0);
  function u(h, f) {
    if (h.offset1 < o.offset1 || h.offset2 < o.offset2)
      return;
    const d = r(e, h.offset1), w = r(t, h.offset2);
    if (!d || !w)
      return;
    let g = new O(d, w);
    const m = g.intersect(f);
    let L = m.seq1Range.length, S = m.seq2Range.length;
    for (; i.length > 0; ) {
      const N = i[0];
      if (!(N.seq1Range.intersects(g.seq1Range) || N.seq2Range.intersects(g.seq2Range)))
        break;
      const C = r(e, N.seq1Range.start), P = r(t, N.seq2Range.start), V = new O(C, P), x = V.intersect(N);
      if (L += x.seq1Range.length, S += x.seq2Range.length, g = g.join(V), g.seq1Range.endExclusive >= N.seq1Range.endExclusive)
        i.shift();
      else
        break;
    }
    (s && L + S < g.seq1Range.length + g.seq2Range.length || L + S < (g.seq1Range.length + g.seq2Range.length) * 2 / 3) && l.push(g), o = g.getEndExclusives();
  }
  for (; i.length > 0; ) {
    const h = i.shift();
...
function d1(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < r.length; u++) {
      let f = function(w, g) {
        const m = new U(h.seq1Range.endExclusive, c.seq1Range.start);
        return e.getText(m).replace(/\s/g, "").length <= 4 && (w.seq1Range.length + w.seq2Range.length > 5 || g.seq1Range.length + g.seq2Range.length > 5);
      };
      var l = f;
...
function m1(e, t, n) {
  ...
  do {
    ...
    for (let c = 1; c < r.length; c++) {
      let d = function(g, m) {
        const L = new U(f.seq1Range.endExclusive, h.seq1Range.start);
        if (e.countLinesIn(L) > 5 || L.length > 500)
          return !1;
        const N = e.getText(L).trim();
        if (N.length > 20 || N.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const v = e.countLinesIn(g.seq1Range), C = g.seq1Range.length, P = t.countLinesIn(g.seq2Range), V = g.seq2Range.length, x = e.countLinesIn(m.seq1Range), p = m.seq1Range.length, R = t.countLinesIn(m.seq2Range), D = m.seq2Range.length, I = 2 * 40 + 50;
        function _(A) {
          return Math.min(A, I);
        }
        return Math.pow(Math.pow(_(v * 40 + C), 1.5) + Math.pow(_(P * 40 + V), 1.5), 1.5) + Math.pow(Math.pow(_(x * 40 + p), 1.5) + Math.pow(_(R * 40 + D), 1.5), 1.5) > (I ** 1.5) ** 1.5 * 1.3;
      };
      var o = d;
      const h = r[c], f = u[u.length - 1];
      d(f, h) ? (i = !0, u[u.length - 1] = u[u.length - 1].join(h)) : u.push(h);
    }
    r = u;
  } while (s++ < 10 && i);
  const l = [];
  return qa(r, (u, c, h) => {
    ...
    const w = e.extendToFullLines(c.seq1Range), g = e.getText(new U(w.start, c.seq1Range.start));
    d(g) && (f = f.deltaStart(-g.length));
    const m = e.getText(new U(c.seq1Range.endExclusive, w.endExclusive));
    d(m) && (f = f.deltaEnd(m.length));
    const L = O.fromOffsetPairs(u ? u.getEndExclusives() : pe.zero, h ? h.getStarts() : pe.max), S = f.intersect(L);
    l.length > 0 && S.getStarts().equals(l[l.length - 1].getEndExclusives()) ? l[l.length - 1] = l[l.length - 1].join(S) : l.push(S);
  }), l;
}
class fs {
  constructor(t, n) {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : ds(this.lines[t - 1]), r = t === this.lines.length ? 0 : ds(this.lines[t]);
    return 1e3 - (n + r);
  }
  getText(t) {
...
class g1 {
  constructor() {
    this.dynamicProgrammingDiffing = new e1(), this.myersDiffingAlgorithm = new $s();
  }
  computeDiff(t, n, r) {
    if (t.length <= 1 && Va(t, n, (x, p) => x === p))
      return new St([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new St([
        new _e(new $(1, t.length + 1), new $(1, n.length + 1), [
          new le(new E(1, 1, t.length, t[t.length - 1].length + 1), new E(1, 1, n.length, n[n.length - 1].length + 1))
        ])
      ], [], !1);
    const s = r.maxComputationTimeMs === 0 ? gt.instance : new Ka(r.maxComputationTimeMs), i = !r.ignoreTrimWhitespace, l = /* @__PURE__ */ new Map();
    function o(x) {
      let p = l.get(x);
      return p === void 0 && (p = l.size, l.set(x, p)), p;
    }
    const u = t.map((x) => o(x.trim())), c = n.map((x) => o(x.trim())), h = new fs(u, t), f = new fs(c, n), d = h.length + f.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, f, s, (x, p) => t[x] === n[p] ? n[p].length === 0 ? 0.1 : 1 + Math.log(1 + n[p].length) : 0.99) : this.myersDiffingAlgorithm.compute(h, f, s);
    let w = d.diffs, g = d.hitTimeout;
    w = os(h, f, w), w = d1(h, f, w);
    const m = [], L = (x) => {
      if (i)
        for (let p = 0; p < x; p++) {
          const R = S + p, D = N + p;
          if (t[R] !== n[D]) {
            const I = this.refineDiff(t, n, new O(new U(R, R + 1), new U(D, D + 1)), s, i, r);
            for (const _ of I.mappings)
              m.push(_);
            I.hitTimeout && (g = !0);
          }
        }
    ...
    let S = 0, N = 0;
    for (const x of w) {
      At(() => x.seq1Range.start - S === x.seq2Range.start - N);
      const p = x.seq1Range.start - S;
      L(p), S = x.seq1Range.endExclusive, N = x.seq2Range.endExclusive;
      const R = this.refineDiff(t, n, x, s, i, r);
      R.hitTimeout && (g = !0);
      for (const D of R.mappings)
        m.push(D);
    }
    L(t.length - S);
    const v = new _t(t), C = new _t(n), P = es(m, v, C);
    let V = [];
    return r.computeMoves && (V = this.computeMoves(P, t, n, u, c, s, i, r)), At(() => {
      function x(R, D) {
        if (R.lineNumber < 1 || R.lineNumber > D.length)
          return !1;
        const I = D[R.lineNumber - 1];
        return !(R.column < 1 || R.column > I.length + 1);
      }
      function p(R, D) {
        return !(R.startLineNumber < 1 || R.startLineNumber > D.length + 1 || R.endLineNumberExclusive < 1 || R.endLineNumberExclusive > D.length + 1);
      }
      for (const R of P) {
        if (!R.innerChanges)
          return !1;
        for (const D of R.innerChanges)
          if (!(x(D.modifiedRange.getStartPosition(), n) && x(D.modifiedRange.getEndPosition(), n) && x(D.originalRange.getStartPosition(), t) && x(D.originalRange.getEndPosition(), t)))
            return !1;
        if (!p(R.modified, n) || !p(R.original, t))
          return !1;
      }
      return !0;
    }), new St(P, V, g);
  }
  computeMoves(t, n, r, s, i, l, o, u) {
    return s1(t, n, r, s, i, l).map((f) => {
      const d = this.refineDiff(n, r, new O(f.original.toOffsetRange(), f.modified.toOffsetRange()), l, o, u), w = es(d.mappings, new _t(n), new _t(r), !0);
      return new Da(f, w);
    });
  }
  refineDiff(t, n, r, s, i, l) {
    const u = b1(r).toRangeMapping2(t, n), c = new Tt(t, u.originalRange, i), h = new Tt(n, u.modifiedRange, i), f = c.length + h.length < 500 ? this.dynamicProgrammingDiffing.compute(c, h, s) : this.myersDiffingAlgorithm.compute(c, h, s);
    let d = f.diffs;
    return d = os(c, h, d), d = hs(c, h, d, (g, m) => g.findWordContaining(m)), l.extendToSubwords && (d = hs(c, h, d, (g, m) => g.findSubWordContaining(m), !0)), d = h1(c, h, d), d = m1(c, h, d), {
      mappings: d.map((g) => new le(c.translateRange(g.seq1Range), h.translateRange(g.seq2Range))),
      hitTimeout: f.hitTimeout
    };
  }
}
function b1(e) {
  return new ue(new $(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new $(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
}
const ms = {
  getLegacy: () => new Qa(),
  getDefault: () => new g1()
...
class b {
  constructor(t, n, r, s = 1) {
    this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, t)) | 0, this.g = Math.min(255, Math.max(0, n)) | 0, this.b = Math.min(255, Math.max(0, r)) | 0, this.a = Ae(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(t, n) {
...
class oe {
  constructor(t, n, r, s) {
    this._hslaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = Ae(Math.max(Math.min(1, n), 0), 3), this.l = Ae(Math.max(Math.min(1, r), 0), 3), this.a = Ae(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(t, n) {
...
class We {
  constructor(t, n, r, s) {
    this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = Ae(Math.max(Math.min(1, n), 0), 3), this.v = Ae(Math.max(Math.min(1, r), 0), 3), this.a = Ae(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(t, n) {
  ...
  static fromRGBA(t) {
    ...
    let c;
    return o === 0 ? c = 0 : i === n ? c = ((r - s) / o % 6 + 6) % 6 : i === r ? c = (s - n) / o + 2 : c = (n - r) / o + 4, new We(Math.round(c * 60), u, i, t.a);
  }
  // from http://www.rapidtables.com/convert/color/hsv-to-rgb.htm
  static toRGBA(t) {
    const { h: n, s: r, v: s, a: i } = t, l = s * r, o = l * (1 - Math.abs(n / 60 % 2 - 1)), u = s - l;
    let [c, h, f] = [0, 0, 0];
    return n < 60 ? (c = l, h = o) : n < 120 ? (c = o, h = l) : n < 180 ? (h = l, f = o) : n < 240 ? (h = o, f = l) : n < 300 ? (c = o, f = l) : n <= 360 && (c = l, f = o), c = Math.round((c + u) * 255), h = Math.round((h + u) * 255), f = Math.round((f + u) * 255), new b(c, h, f, i);
  }
}
const z = class z {
  static fromHex(t) {
  ...
  get hsva() {
    return this._hsva ? this._hsva : We.fromRGBA(this.rgba);
  }
  constructor(t) {
    if (t)
      if (t instanceof b)
        ...
        this._hsva = t, this.rgba = We.toRGBA(t);
      else
        throw new Error("Invalid color ctor argument");
    else throw new Error("Color needs a value");
  }
  equals(t) {
    return !!t && b.equals(this.rgba, t.rgba) && oe.equals(this.hsla, t.hsla) && We.equals(this.hsva, t.hsva);
  }
  /**
  ...
  getRelativeLuminance() {
    const t = z._relativeLuminanceForComponent(this.rgba.r), n = z._relativeLuminanceForComponent(this.rgba.g), r = z._relativeLuminanceForComponent(this.rgba.b), s = 0.2126 * t + 0.7152 * n + 0.0722 * r;
    return Ae(s, 4);
  }
  ...
  lighten(t) {
    return new z(new oe(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
  }
  darken(t) {
    return new z(new oe(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
  }
   ...
   */
  mix(t, n = 0.5) {
    const r = Math.min(Math.max(n, 0), 1), s = this.rgba, i = t.rgba, l = s.r + (i.r - s.r) * r, o = s.g + (i.g - s.g) * r, u = s.b + (i.b - s.b) * r, c = s.a + (i.a - s.a) * r;
  ...
  makeOpaque(t) {
    if (this.isOpaque() || t.rgba.a !== 1)
      return this;
    const { r: n, g: r, b: s, a: i } = this.rgba;
    return new z(new b(t.rgba.r - i * (t.rgba.r - n), t.rgba.g - i * (t.rgba.g - r), t.rgba.b - i * (t.rgba.b - s), 1));
  }
  toString() {
...
(function(e) {
  (function(t) {
    (function(n) {
      ...
      n.formatRGBA = s;
      function i(m) {
        return m.hsla.a === 1 ? `hsl(${m.hsla.h}, ${Math.round(m.hsla.s * 100)}%, ${Math.round(m.hsla.l * 100)}%)` : e.Format.CSS.formatHSLA(m);
      }
      n.formatHSL = i;
      function l(m) {
        return `hsla(${m.hsla.h}, ${Math.round(m.hsla.s * 100)}%, ${Math.round(m.hsla.l * 100)}%, ${m.hsla.a.toFixed(2)})`;
      }
      n.formatHSLA = l;
      function o(m) {
        const L = m.toString(16);
      ...
      n.formatHex = u;
      function c(m, L = !1) {
        return L && m.rgba.a === 1 ? e.Format.CSS.formatHex(m) : `#${o(m.rgba.r)}${o(m.rgba.g)}${o(m.rgba.b)}${o(Math.round(m.rgba.a * 255))}`;
      }
      n.formatHexA = c;
      function h(m) {
      ...
      function f(m) {
        ...
        if (m.startsWith("rgba(")) {
          const x = m.match(/rgba\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+), *(?<a>(?:\+|-)?\d+(\.\d+)?)\)/);
          if (!x)
            throw new Error("Invalid color format " + m);
          const p = parseInt(((L = x.groups) == null ? void 0 : L.r) ?? "0"), R = parseInt(((S = x.groups) == null ? void 0 : S.g) ?? "0"), D = parseInt(((N = x.groups) == null ? void 0 : N.b) ?? "0"), I = parseFloat(((v = x.groups) == null ? void 0 : v.a) ?? "0");
          return new e(new b(p, R, D, I));
        }
        if (m.startsWith("rgb(")) {
          const x = m.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
          if (!x)
            throw new Error("Invalid color format " + m);
          const p = parseInt(((C = x.groups) == null ? void 0 : C.r) ?? "0"), R = parseInt(((P = x.groups) == null ? void 0 : P.g) ?? "0"), D = parseInt(((V = x.groups) == null ? void 0 : V.b) ?? "0");
          return new e(new b(p, R, D));
        }
        return d(m);
      }
      n.parse = f;
      ...
      function w(m) {
        const L = m.length;
        if (L === 0 || m.charCodeAt(0) !== 35)
          return null;
        if (L === 7) {
          const S = 16 * g(m.charCodeAt(1)) + g(m.charCodeAt(2)), N = 16 * g(m.charCodeAt(3)) + g(m.charCodeAt(4)), v = 16 * g(m.charCodeAt(5)) + g(m.charCodeAt(6));
          return new e(new b(S, N, v, 1));
        }
        if (L === 9) {
          const S = 16 * g(m.charCodeAt(1)) + g(m.charCodeAt(2)), N = 16 * g(m.charCodeAt(3)) + g(m.charCodeAt(4)), v = 16 * g(m.charCodeAt(5)) + g(m.charCodeAt(6)), C = 16 * g(m.charCodeAt(7)) + g(m.charCodeAt(8));
          return new e(new b(S, N, v, C / 255));
        }
        if (L === 4) {
          const S = g(m.charCodeAt(1)), N = g(m.charCodeAt(2)), v = g(m.charCodeAt(3));
          return new e(new b(16 * S + S, 16 * N + N, 16 * v + v));
        }
        if (L === 5) {
          const S = g(m.charCodeAt(1)), N = g(m.charCodeAt(2)), v = g(m.charCodeAt(3)), C = g(m.charCodeAt(4));
          return new e(new b(16 * S + S, 16 * N + N, 16 * v + v, (16 * C + C) / 255));
        }
        return null;
      }
      n.parseHex = w;
...
function w1(e, t) {
  ...
  if (n)
    return {
      range: e,
      color: Rn(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
    };
}
function gs(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const s = t[0].values(), i = Hs(s);
  return {
    range: e,
    color: Rn(i[0], i[1], i[2], n ? i[3] : 1)
  };
}
function bs(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const s = t[0].values(), i = Hs(s), l = new tt(new oe(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1));
  return {
    range: e,
    color: Rn(l.rgba.r, l.rgba.g, l.rgba.b, l.rgba.a)
  };
}
function st(e, t) {
...
function x1(e) {
  const t = [], n = new RegExp(`\\b(rgb|rgba|hsl|hsla)(\\([0-9\\s,.\\%]*\\))|^(#)([A-Fa-f0-9]{3})\\b|^(#)([A-Fa-f0-9]{4})\\b|^(#)([A-Fa-f0-9]{6})\\b|^(#)([A-Fa-f0-9]{8})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{3})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{4})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{6})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{8})\\b`, "gm"), r = st(e, n);
  if (r.length > 0)
    for (const s of r) {
      ...
      if (l === "rgb") {
        ...
        u = bs(rt(e, s), st(o, c), !0);
      } else l === "#" && (u = w1(rt(e, s), l + o));
      u && t.push(u);
    }
  return t;
}
function p1(e) {
  return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : x1(e);
}
const _1 = /^-+|-+$/g, ws = 100, L1 = 5;
function v1(e, t) {
  var r;
  let n = [];
...
function S1(e, t) {
  ...
  if (!t.markSectionHeaderRegex || t.markSectionHeaderRegex.trim() === "")
    return n;
  const s = Aa(t.markSectionHeaderRegex), i = new RegExp(t.markSectionHeaderRegex, `gdm${s ? "s" : ""}`);
  if (_i(i))
    return n;
  for (let l = 1; l <= r; l += ws - L1) {
    const o = Math.min(l + ws - 1, r), u = [];
    for (let f = l; f <= o; f++)
...
`);
    ...
    let h;
    for (; (h = i.exec(c)) !== null; ) {
      const f = c.substring(0, h.index), d = (f.match(/\n/g) || []).length, w = l + d, g = h[0].split(`
`), m = g.length, L = w + m - 1, S = f.lastIndexOf(`
`) + 1, N = h.index - S + 1, v = g[g.length - 1], C = m === 1 ? N + h[0].length : v.length + 1, P = {
        startLineNumber: w,
        startColumn: N,
        endLineNumber: L,
        endColumn: C
      }, V = (h.groups ?? {}).label ?? "", x = ((h.groups ?? {}).separator ?? "") !== "", p = {
        range: P,
        text: V,
        hasSeparatorLine: x,
        shouldBeInComments: !0
      };
      (p.text || p.hasSeparatorLine) && (n.length === 0 || n[n.length - 1].range.endLineNumber < p.range.startLineNumber) && n.push(p), i.lastIndex = h.index + h[0].length;
    }
  }
  return n;
}
function A1(e) {
  ...
  return e = e.replace(_1, ""), { text: e, hasSeparatorLine: t };
}
class R1 {
  get isRejected() {
    var t;
...
const ne = class ne {
  constructor(t, n) {
    this._onReturn = n, this._producerConsumer = new y1(), this._iterator = {
...
class M1 {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new P1(Te.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class P1 extends k1 {
  ...
  findMatches(t) {
    ...
    for (let r = 0; r < this._lines.length; r++) {
      const s = this._lines[r], i = this.offsetAt(new H(r + 1, 1)), l = s.matchAll(t);
      for (const o of l)
...
const Me = class Me {
  constructor(t = null) {
    this._foreignModule = t, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new M1();
  }
  dispose() {
  }
  async $ping() {
  ...
  async $computeUnicodeHighlights(t, n, r) {
    ...
    return s ? Fa.computeUnicodeHighlights(s, n, r) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  static computeDiff(t, n, r, s) {
    const i = s === "advanced" ? ms.getDefault() : ms.getLegacy(), l = t.getLinesContent(), o = n.getLinesContent(), u = i.computeDiff(l, o, r), c = u.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function h(f) {
      return f.map((d) => {
        var w;
        return [d.original.startLineNumber, d.original.endLineNumberExclusive, d.modified.startLineNumber, d.modified.endLineNumberExclusive, (w = d.innerChanges) == null ? void 0 : w.map((g) => [
  ...
  async $computeMoreMinimalEdits(t, n, r) {
    ...
    for (let u = 1; u < n.length; u++)
      E.getEndPosition(n[o].range).equals(E.getStartPosition(n[u].range)) ? (n[o].range = E.fromPositions(E.getStartPosition(n[o].range), E.getEndPosition(n[u].range)), n[o].text += n[u].text) : (o++, n[o] = n[u]);
    n.length = o + 1;
    for (let { range: u, text: c, eol: h } of n) {
      if (typeof h == "number" && (l = h), E.isEmpty(u) && !c)
        continue;
      const f = s.getValueInRange(u);
      if (c = c.replace(/\r\n|\n|\r/g, s.eol), f === c)
        continue;
      if (Math.max(c.length, f.length) > Me._diffLimit) {
        i.push({ range: u, text: c });
        continue;
      }
      const d = Ui(f, c, r), w = s.offsetAt(E.lift(u).getStartPosition());
      for (const g of d) {
        const m = s.positionAt(w + g.originalStart), L = s.positionAt(w + g.originalStart + g.originalLength), S = {
          text: c.substr(g.modifiedStart, g.modifiedLength),
          range: { startLineNumber: m.lineNumber, startColumn: m.column, endLineNumber: L.lineNumber, endColumn: L.column }
        };
...
let _n = Me;
typeof importScripts == "function" && (globalThis.monaco = _a());
const ct = class ct {
  static getChannel(t) {
    return t.getChannel(ct.CHANNEL_NAME);
  }
  static setChannel(t, n) {
    t.setChannel(ct.CHANNEL_NAME, n);
  }
};
